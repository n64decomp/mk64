...
void func_80044924(s8 *image, s32 width, s32 arg2) {
    ...
    gDPLoadBlock(gDisplayListHead++, G_TX_RENDERTILE, 0, 0, a, ((width / 16) + 0x7FF) / (width / 16));
    gDPPipeSync(gDisplayListHead++);
...
// unused
GLOBAL_ASM("asm/non_matchings/code_800431B0/func_80049E08.s")
...
// unused
GLOBAL_ASM("asm/non_matchings/code_800431B0/func_8004A12C.s")
