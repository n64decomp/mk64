...
#ifdef MIPS_TO_C
//generated by m2c commit b7eac665cffd02361f73cec283ef16d0a35a0e5b
? func_80045738(s8 *, s32, s32, s32);               /* extern */
...
void func_80046030(s8 *arg0, s32 arg1, Vtx *arg2, s32 width, s32 arg4, s32 height) {
    ...
    temp_v0->words.w1 = (u32) D_0D008138;
    var_s0 = 0;
    temp_lo = arg4 / height;
    var_s1 = arg0;
    var_s2 = arg1;
    ...
    if (temp_lo > 0) {
        ...
        do {
            ...
            var_s2 += temp_lo_2;
            var_s0 += 4;
        } while (var_s3 != temp_lo);
    }
    temp_v0_2 = gDisplayListHead;
    gDisplayListHead = temp_v0_2 + 8;
    temp_v0_2->words.w0 = 0xBB000000;
    temp_v0_2->words.w1 = 0x00010001;
    temp_v0_3 = gDisplayListHead;
    gDisplayListHead = temp_v0_3 + 8;
    temp_v0_3->words.w0 = 0x06000000;
    temp_v0_3->words.w1 = (u32) D_0D008120;
}
#else
...
#ifdef MIPS_TO_C
//generated by m2c commit b7eac665cffd02361f73cec283ef16d0a35a0e5b
? func_80044924(s8 *, s32, s32);                    /* extern */
...
void func_8004961C(s8 *arg0, Vtx *arg1, s32 arg2, s32 arg3, s32 width, s32 height) {
    ...
    var_v0 = 0;
    if (temp_lo > 0) {
        temp_lo_2 = arg2 / width;
        do {
            var_s0 = 0;
            if (temp_lo_2 > 0) {
                sp5C = var_v0;
                do {
                    // gSPVertex(gDisplayListHead++, &arg2[var_s1], 4, 0);
                    // gSPDisplayList(gDisplayListHead++, D_0D006940);
                    func_80044924(var_s3, width, height);
                    temp_v0 = gDisplayListHead;
                    gDisplayListHead = temp_v0 + 8;
                    temp_v0->words.w0 = 0x0400103F;
                    var_s0 += 1;
                    temp_v0->words.w1 = (u32) &arg1[var_s2];
                    temp_v0_2 = gDisplayListHead;
                    var_s3 = &var_s3[(s32) (width * height) / 2];
                    gDisplayListHead = temp_v0_2 + 8;
                    var_s2 += 4;
                    temp_v0_2->words.w1 = (u32) D_0D006940;
                    temp_v0_2->words.w0 = 0x06000000;
                } while (var_s0 != temp_lo_2);
                var_v0 = sp5C;
            }
            var_v0 += 1;
        } while (var_v0 != sp40);
    ...
    temp_v0_3 = gDisplayListHead;
    gDisplayListHead = temp_v0_3 + 8;
    temp_v0_3->words.w0 = 0xBB000000;
    temp_v0_3->words.w1 = 0x00010001;
}
#else
...
#ifdef MIPS_TO_C
//generated by m2c commit b7eac665cffd02361f73cec283ef16d0a35a0e5b
? func_80044DA0(s8 *, s32, s32);                    /* extern */
...
#ifdef MIPS_TO_C
//generated by m2c commit b7eac665cffd02361f73cec283ef16d0a35a0e5b
Gfx *func_8004B97C(s32, s32, s32, s32, s32);        /* extern */

Gfx *func_8004CD48(s32 arg0, s32 arg1, s32 arg2, s32 width, s32 arg4, s32 height) {
    s8 *sp40;
    Gfx *temp_v1;
    Gfx *var_v0;
    s32 temp_lo;
    ...
    temp_v1->words.w1 = (u32) D_0D007FE0;
    var_v0 = temp_v1;
    if (temp_lo > 0) {
        var_s4 = sp40;
        do {
            func_800441E0(var_s4, width, height);
            var_v0 = func_8004B97C(arg0 - (width / 2), var_s0, width, height, 1);
            var_s1 += 1;
            var_s4 += width * height * 2;
            var_s0 += height;
        } while (var_s1 != temp_lo);
        sp40 = var_s4;
    }
    return var_v0;
}
...
void func_8004CE8C(s32 arg0, s32 arg1, s8 *arg2, s32 width, s32 arg4, s32 height) {
    s32 temp_lo;
    s32 var_s0;
    s32 var_s2;
    s8 *var_s1;
...
void func_8004D210(s32 arg0, s32 arg1, s8 *arg2, s32 arg3, s32 arg4, s32 arg5, s32 arg6, s32 width, s32 arg8, s32 arg9, s32 height) {
    ...
    if (temp_lo > 0) {
        do {
            ...
            var_s0 += 1;
            var_s4 = &var_s4[(s32) (width * height) / 2];
            var_s3 += height;
...
#ifdef MIPS_TO_C
//generated by m2c commit b7eac665cffd02361f73cec283ef16d0a35a0e5b
? func_800450C8(s8 *, s32, s32);                    /* extern */
...
void func_8004D654(s32 arg0, s32 arg1, s8 *arg2, f32 arg3, s32 arg4, s32 arg5, s32 arg6, s32 arg7, s32 width, s32 arg9, s32 argA, s32 height) {
    Gfx *temp_v1;
    s32 temp_lo;
    s32 var_s0;
    s8 *var_s2;
    ...
    gDisplayListHead = temp_v1 + 8;
    temp_v1->words.w0 = 0x06000000;
    temp_v1->words.w1 = (u32) D_0D008000;
    var_s2 = arg2;
    ...
    if (temp_lo > 0) {
        do {
            ...
            var_s0 += 1;
            var_s2 = &var_s2[(s32) (width * height) / 2];
        } while (var_s0 != temp_lo);
    }
}
#else
...
void func_8004D7B4(s32 arg0, s32 arg1, s8 *arg2, s32 arg3, s32 arg4) {
    ...
    if (arg4 > 0) {
        ...
        do {
            ...
            temp_s5 = (s32) ((sins(temp_s0 & 0xFFFF) * temp_f20) + (f32) (arg0 - (arg3 / 2)));
            sins(temp_s0 & 0xFFFF);
...
void func_8004D93C(s32 arg0, s32 arg1, s8 *arg2, s32 arg3, s32 arg4) {
    ...
    if (arg4 > 0) {
        do {
            temp_s0 = var_s1 & 0xFFFF;
            temp_s6 = (s32) ((sins(temp_s0 & 0xFFFF) * temp_f20) + (f32) (arg0 - (arg3 / 2)));
            sins(temp_s0 & 0xFFFF);
...
void func_8004E06C(s32 arg0, s32 arg1, s8 *arg2, s32 arg3, s32 arg4) {
    ...
    if (arg4 > 0) {
        do {
            temp_s0 = var_s1 & 0xFFFF;
            temp_s6 = (u32) ((sins(temp_s0 & 0xFFFF) * temp_f20) + (f32) (arg0 - (arg3 / 2)));
            sins(temp_s0 & 0xFFFF);
...
#ifdef MIPS_TO_C
//generated by m2c commit b7eac665cffd02361f73cec283ef16d0a35a0e5b
static s32 D_800E4570[3] = { (s32) D_0D00B158, (s32) D_0D00B558, (s32) D_0D00B958 };
...
#ifdef MIPS_TO_C
//generated by m2c commit b7eac665cffd02361f73cec283ef16d0a35a0e5b
s32 func_80050644(s32 arg0, s32 *arg1, s32 *arg2) {
    s32 temp_a3;
    s32 temp_t6;
    s32 var_v0;
...
void func_800517C8(void) {
    ...
    temp_v1_2 = gDisplayListHead;
    gDisplayListHead = temp_v1_2 + 8;
    temp_v1_2->words.w1 = -0x00000C07U;
    temp_v1_2->words.w0 = 0xFC627EC4;
    func_80044F34(D_0D0293D8, 0x10, 0x10);
    var_s0 = &D_8018C1B0;
    do {
        temp_a0 = *var_s0;
        if (D_80165C18[temp_a0].unk_0A6 >= 2) {
            func_80043104(temp_a0);
            temp_v1_3 = gDisplayListHead;
            gDisplayListHead = temp_v1_3 + 8;
            temp_v1_3->words.w1 = (u32) D_0D006980;
            temp_v1_3->words.w0 = 0x06000000;
        }
        var_s0 += 4;
    } while (var_s0 != &D_8018C278);
    temp_v1_4 = gDisplayListHead;
    gDisplayListHead = temp_v1_4 + 8;
    temp_v1_4->words.w0 = 0xBB000000;
    temp_v1_4->words.w1 = 0x00010001;
}
#else
...
void func_80051F9C(void) {
    ...
    func_80051ABC(var_a0, D_8018D1F0);
}
#else
...
void func_800523B8(s32 arg0, s32 arg1, u32 arg2) {
    ...
    sp3C = temp_v1;
    temp_v0 = func_800418AC(temp_v1->unk_004[0], temp_v1->unk_004[2], camera1[arg1].pos);
    temp_a0 = temp_v1->unk_004;
    sp38 = temp_a0;
    temp_v1->unk_0B4 = (u16) temp_v0;
    func_800484BC((s32) temp_a0, (s32) &temp_v1->unk_0B2, temp_v1->unk_000, (s32) temp_v1->unk_0A0, (s32) temp_v1->unk_060, (s32) temp_v1->unk_064, (Vtx *) temp_v1->unk_074, 0x00000030, 0x00000028, 0x00000030, 0x00000028);
    if ((func_8007223C(arg0, 0x00000020) != 0) && (arg2 < 0x15F91U)) {
        func_8004A630(&D_8018C830, sp38, 0.4f);
    }
}
#else
...
#ifdef MIPS_TO_C
//generated by m2c commit b7eac665cffd02361f73cec283ef16d0a35a0e5b
? func_800523B8(s32, s32, u32);                     /* extern */
extern ? D_8018BFD0;
...
void func_800524B4(s32 arg0) {
    ...
    do {
        ...
        if (D_80165C18[temp_s0].unk_0A6 >= 2) {
            temp_s2 = func_8008A364(temp_s0, arg0, 0x4000U, 0x00000320);
            if (func_8007223C(temp_s0, 0x00040000) != 0) {
                func_800523B8(temp_s0, arg0, temp_s2);
            }
        }
        var_s1 += 4;
    } while (var_s1 != &D_8018BFD0);
}
#else
...
void func_8005285C(s32 playerId) {
    Player *temp_v0;

    temp_v0 = &gPlayerOne[playerId];
    D_80183E40.unk0 = temp_v0->pos[0];
...
void func_80052D70(s32 playerId) {
    ...
    sp20 = temp_v1;
    if (func_80072320(*(&D_80183DB8 + (playerId * 4)), 8) != 0) {
        D_80183E40.unk0 = temp_v1->pos[0];
        D_80183E40.unk4 = (f32) ((f64) temp_v1->unk_074 - 6.5);
        D_80183E40.unk8 = (f32) temp_v1->pos[2];
        func_800435A0(&D_80183E40, &D_80183E80, 0.02f, &D_06007218, 0x000000FF);
    }
}
#else
    ...
    do {
        ...
        if (temp_s0 != -1) {
            ...
            if (temp_s1->unk_0A6 > 0) {
                func_8008A364(temp_s0, cameraId, 0x2AABU, 0x000001F4);
                if (func_8007223C(temp_s0, 0x00040000) != 0) {
    ...
    do {
        ...
        if (temp_s0->unk_0A6 >= 2) {
            ...
            if (func_8007223C(temp_s1, 0x00040000) != 0) {
                D_80183E80.unk0 = (u16) temp_s0->unk_0B2;
                D_80183E80.unk2 = func_800418AC(temp_s0->unk_004[0], temp_s0->unk_004[2], temp_fp->pos);
                D_80183E80.unk4 = (u16) temp_s0->unk_0B6;
                if (func_8007223C(temp_s1, 0x00000010) != 0) {
                    func_800480B4((s32) temp_s0->unk_004, (s32) &D_80183E80, temp_s0->unk_000, (s32) temp_s0->unk_060, (s32) temp_s0->unk_064, temp_s0->unk_074, 0x00000040, 0x00000040, 0x00000040, 0x00000020);
                }
                temp_s0_2 = &D_80165C18[*(var_s4 + D_80183F28)];
                D_80183E80.unk0 = (u16) temp_s0_2->unk_0B2;
                D_80183E80.unk4 = (u16) temp_s0_2->unk_0B6;
                func_800480B4((s32) temp_s0_2->unk_004, (s32) &D_80183E80, temp_s0_2->unk_000, (s32) temp_s0_2->unk_060, (s32) temp_s0_2->unk_064, temp_s0_2->unk_074, 0x00000040, 0x00000040, 0x00000040, 0x00000020);
            }
        }
        var_s3 += 4;
        var_s4 += 4;
    } while (var_s3 != &D_80183EEC);
}
#else
...
void func_800540CC(s32 objectIndex, s32 cameraId) {
    ...
    sp2C = &camera1[cameraId];
    if (objectIndex != -1) {
        temp_v1 = &D_80165C18[objectIndex];
        if ((temp_v1->unk_0A6 >= 2) && (temp_v1->unk_0D5 == 1) && (D_8018D120 < 0x2EF)) {
            temp_a0 = temp_v1->unk_0A4;
            sp28 = temp_v1;
            func_8004B1C8((s32) temp_a0, (s32) temp_a0, (s32) temp_a0, 0, 0, 0, (s32) temp_v1->unk_0A0);
            D_80183E80.unk2 = func_800418AC(temp_v1->unk_004[0], temp_v1->unk_004[2], sp2C->pos);
            func_800431B0(temp_v1->unk_004, &D_80183E80, temp_v1->unk_000, &D_0D005AE0);
        }
    }
}
#else
...
void func_80054324(s32 objectIndex, s32 cameraId) {
    ...
    if (objectIndex != -1) {
        temp_v1 = &D_80165C18[objectIndex];
        if ((temp_v1->unk_0A6 >= 2) && (temp_v1->unk_0D5 == 6) && (D_8018D120 < 0x2EF)) {
            temp_a0 = temp_v1->unk_0A4;
            temp_a3 = temp_v1->unk_0A2;
            sp28 = temp_v1;
            func_8004B1C8((s32) temp_a0, (s32) temp_a0, (s32) temp_a0, (s32) temp_a3, (s32) temp_a3, (s32) temp_a3, (s32) temp_v1->unk_0A0);
            D_80183E80.unk2 = func_800418AC(temp_v1->unk_004[0], temp_v1->unk_004[2], sp2C->pos);
            func_800431B0(temp_v1->unk_004, &D_80183E80, temp_v1->unk_000, &D_0D005AE0);
        }
    }
...
void func_8005457C(s32 objectIndex, s32 cameraId) {
    ...
    if (D_8018D120 < 0x2EF) {
        ...
        D_80183E80.unk2 = func_800418AC(temp_s0->unk_004[0], temp_s0->unk_004[2], sp34->pos);
...
#ifdef MIPS_TO_C
//generated by m2c commit b7eac665cffd02361f73cec283ef16d0a35a0e5b
? func_8005477C(s32, u8, Camera *);                 /* extern */
extern ? D_0D007AE0;
extern ? D_0D02BC58;
extern s32 D_80165598;
extern ? D_80183E80;
    ...
    do {
        ...
        if (temp_s0 != -1) {
            ...
            if (temp_s1->unk_0A6 >= 2) {
                ...
                if (func_8007223C(temp_s0, 0x00040000) != 0) {
                    func_8005477C(temp_s0, (u8) temp_s1->unk_0D8, sp54);
                }
            }
        }
        var_s2 += 4;
...
void func_80054AFC(s32 objectIndex, Vec3f arg1) {
    ...
    temp_s0 = &D_80165C18[objectIndex];
    D_80183E80.unk0 = func_800418E8(temp_s0->unk_004[2], temp_s0->unk_004[1], arg1);
    D_80183E80.unk2 = func_800418AC(temp_s0->unk_004[0], temp_s0->unk_004[2], arg1);
    D_80183E80.unk4 = (u16) temp_s0->unk_0B6;
    func_8004B138((s32) temp_s0->unk_084[0], (s32) temp_s0->unk_084[1], (s32) temp_s0->unk_084[2], (s32) temp_s0->unk_0A0);
    func_80042E00(temp_s0->unk_004, &D_80183E80, temp_s0->unk_000);
    temp_v0 = gDisplayListHead;
    gDisplayListHead = temp_v0 + 8;
    temp_v0->words.w0 = 0x0400103F;
    temp_v0->words.w1 = (u32) &D_0D005AE0;
    temp_v0_2 = gDisplayListHead;
    gDisplayListHead = temp_v0_2 + 8;
    temp_v0_2->words.w0 = 0x06000000;
    temp_v0_2->words.w1 = (u32) D_0D006940;
...
#ifdef MIPS_TO_C
//generated by m2c commit b7eac665cffd02361f73cec283ef16d0a35a0e5b
? func_80054AFC(s32, Camera *);                     /* extern */
extern ? D_0D007AE0;
extern s16 D_80183E80;
extern s32 D_8018C630;
extern ? D_8018C830;
...
void func_80054D00(s32 objectIndex, s32 cameraId) {
    Camera *sp3C;
    struct_80165C18_entry *sp38;
    struct_80165C18_entry *temp_v1;

    temp_v1 = &D_80165C18[objectIndex];
    sp3C = &camera1[cameraId];
    if (temp_v1->unk_0A6 >= 3) {
        sp38 = temp_v1;
        func_8008A364(objectIndex, cameraId, 0x2AABU, 0x0000012C);
        if (func_8007223C(objectIndex, 0x00040000) != 0) {
            sp38 = temp_v1;
            D_80183E80.unk0 = (u16) temp_v1->unk_0B2;
            D_80183E80.unk2 = func_800418AC(temp_v1->unk_004[0], temp_v1->unk_004[2], sp3C->pos);
            D_80183E80.unk4 = (u16) temp_v1->unk_0B6;
            func_80048130((s32) temp_v1->unk_004, (s32) &D_80183E80, temp_v1->unk_000, (s32) temp_v1->unk_060, (s32) temp_v1->unk_064, (s32) &D_0D0062B0, 0x00000020, 0x00000040, 0x00000020, 0x00000040, 5);
        }
    }
}
#else
...
void func_80054E10(s32 objectIndex) {
    ...
    if (temp_v1->unk_0A6 > 0) {
        ...
        if (func_8007223C(objectIndex, 0x00800000) != 0) {
            D_80183E50.unk0 = (f32) temp_v1->unk_004[0];
            D_80183E50.unk4 = (f32) ((f64) temp_v1->unk_044 + 0.8);
            D_80183E50.unk8 = (f32) temp_v1->unk_004[2];
            D_80183E70.unk0 = (f32) temp_v1->unk_038[0];
            D_80183E70.unk4 = (f32) temp_v1->unk_038[1];
            D_80183E70.unk8 = (f32) temp_v1->unk_038[2];
            func_8004A9B8(temp_v1->unk_000);
        }
    }
}
#else
...
void func_80054F04(s32 cameraId) {
    ...
    do {
        ...
        temp_s1 = &D_80165C18[temp_s0];
        if (temp_s1->unk_0A6 > 0) {
            func_8008A364(temp_s0, cameraId, 0x2AABU, 0x000000C8);
            if ((func_8007223C(temp_s0, 0x00040000) != 0) && (D_8018D120 < 0x2EF)) {
                temp_s1->unk_0B4 = func_800418AC(temp_s1->unk_004[0], temp_s1->unk_004[2], sp44->pos);
                func_80043104(temp_s0);
                temp_v1_2 = gDisplayListHead;
                gDisplayListHead = temp_v1_2 + 8;
                temp_v1_2->words.w1 = (u32) &D_0D006980;
...
void func_800550A4(s32 arg0) {
    ...
    var_s0 = D_80183EA0;
    do {
        func_80054D00(*var_s0, arg0);
        var_s0 += 4;
    } while ((u32) var_s0 < (u32) &D_80183EC0);
    var_s0_2 = D_80183F28;
    do {
        func_80054D00(*var_s0_2, arg0);
        var_s0_2 += 4;
    } while ((u32) var_s0_2 < (u32) &D_80183F54);
    var_s0_3 = D_8018BFA8;
    do {
        func_80054D00(*var_s0_3, arg0);
        var_s0_3 += 4;
    } while (var_s0_3 != &D_8018BFD8);
    func_80054EB8(arg0);
    func_80054F04(arg0);
}
#else
...
void func_80055380(s32 arg0) {
    ...
    do {
        temp_s0 = *var_s1;
        if (func_8008A364(temp_s0, arg0, 0x5555U, 0x000005DC) < 0x9C401) {
            D_80165908 = 1;
...
void func_80056188(s32 cameraId) {
    ...
    var_s2 = D_80183EA0;
    temp_s3 = &camera1[cameraId];
    do {
        temp_s1 = *var_s2;
        if (*(cameraId + &D_8018E838) == 0) {
            temp_s0 = &D_80165C18[temp_s1];
            if ((temp_s0->unk_0A6 >= 2) && (func_80072270(temp_s1, 0x00080000) != 0) && (func_8008A140(temp_s1, temp_s3, 0x2AABU) != 0)) {
                temp_s0->unk_0B4 = func_800872D8(temp_s1, temp_s3);
                func_800480B4(temp_s0->unk_004, &temp_s0->unk_0B2, temp_s0->unk_000, (s32) temp_s0->unk_060, (s32) temp_s0->unk_064, D_0D0060B0, 0x00000040, 0x00000040, 0x00000040, 0x00000020);
            }
        }
        var_s2 += 4;
    } while (var_s2 != &D_80183EC8);
}
#else
...
void func_8005669C(s32 objectIndex, s32 arg1, s32 arg2) {
    ...
    gDisplayListHead = temp_v1 + 8;
    temp_v1->words.w0 = 0x06000000;
    temp_v1->words.w1 = (u32) D_0D0079E8;
    func_8004B310(arg2);
    func_80043D50(D_0D02AA58, 0x00000010, 0x00000010);
    temp_s1 = &D_80165C18[objectIndex];
    D_80183E40.unk4 = (f32) ((f64) temp_s1->unk_004[1] - 2.0);
    D_80183E40.unk0 = (f32) ((f64) temp_s1->unk_004[0] + 2.0);
    D_80183E40.unk8 = (f32) ((f64) temp_s1->unk_004[2] + 2.0);
...
void func_80056FCC(s32 arg0) {
    ...
    D_80183E50.unk4 = (f32) ((f64) temp_v0->unk50 + 1.0);
    D_80183E50.unk8 = (f32) temp_v0->unk8;
    func_80042A20((f32 (*)[4]) &sp30[0], (arg0 << 6) + 0x30 + &D_80164038, &D_80183E50, 0U, 0.5f);
...
#ifdef MIPS_TO_C
//generated by m2c commit b7eac665cffd02361f73cec283ef16d0a35a0e5b
static ? D_800E5628;                                /* unable to generate initializer */
