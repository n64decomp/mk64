...
s32  distance_object_player_2d(s32, Player*);
s32  distance_object_player_3d(s32, Player*);
u32  distance_object_camera_2d(s32, Camera*);
s32  distance_object_camera_3d(s32, Camera*);
s32  is_closer_of_player_2d(s32, Player*, f32);
s32  are_between_distance_2d(s32, Player*, f32, f32);
s32  is_closer_of_player_3d(s32, Player*, f32);
s32  is_closer_of_camera_2d(s32, Camera*, f32);
s32  are_between_distance_camera_2d(s32, Camera*, f32, f32);
s32  is_closer_of_camera_3d(s32, Camera*, f32);
s32  is_object_collide_player_2d(s32, Player*);
s32  is_object_collide_player_3d(s32, Player*);
s32  is_closer_of_player_1d(s32, Player*, f32);
s32  is_closer_of_player_and_distance_y(s32, Player*, f32);
