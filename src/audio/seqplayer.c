...
s32 func_800BC90C(s32, s32, s32);                   /* extern */
void *func_800BC9F8(u8, s32);                       /* extern */
? func_800BD120(void *, s32);                       /* extern */
? func_800BD264(void *, void *);                    /* extern */
void *func_800BDA44(void *);                        /* extern */
? func_800BE4D4(void *);                            /* extern */
? func_800BEB18(void *, s32);                       /* extern */
s32 func_800BF108(void *, s32);                     /* extern */
s32 func_800BF11C(void *, s32);                     /* extern */
s16 func_800BF14C(void *, s32);                     /* extern */
u8 func_800BFC68(void *, s32, void *, void *);      /* extern */
extern s16 D_803B70B4;
extern ? gNoteFrequencies;
...
void func_800BF190(void *arg0) {
    ...
    if ((temp_v0 >> 0x1F) != 0) {
        ...
        phi_s3_2 = sp4A;
loop_11:
        temp_v0_3 = func_800BF108(temp_s0);
        ...
        if (temp_v0_3 >= 0xC1) {
            if (temp_v0_3 >= 0xCD) {
                ...
                case 0xC7:                          /* switch 2 */
                    ...
                    temp_t6 = (func_800BF108(temp_s0) + sp68->unk1E + arg0->unk22 + temp_s4->unkC) & 0xFF;
                    phi_s2 = temp_t6;
                    if (temp_t6 >= 0x80) {
                        phi_s2 = 0;
                    }
                    ...
                    if ((arg0->unk8 & 0x80) != 0) {
                        ...
                        temp_v0_10 = func_800BF14C(temp_s0);
                ...
                case 0xCB:                          /* switch 2 */
                    ...
                    arg0->unk18 = func_800BF108(temp_s0);
                    phi_s3_2 = temp_s3_4;
                    break;
                case 0xCC:                          /* switch 2 */
...
block_88:
            ...
            if (temp_a1 >= 0x80) {
                ...
                if (arg0->unk8 != 0) {
                    ...
                    temp_f2 = *(&gNoteFrequencies + (temp_a1 * 4)) * phi_f0;
                    temp_t4_2 = arg0->unk8 & ~0x80;
                    switch (temp_t4_2) {            /* switch 3 */
                    case 1:                         /* switch 3 */
                    case 3:                         /* switch 3 */
                    case 5:                         /* switch 3 */
                        phi_f0_2 = *(&gNoteFrequencies + (arg0->unk4 * 4)) * phi_f0;
                        break;
                    default:                        /* switch 3 */
                        phi_f0_2 = temp_f2;
                        break;
                    ...
                    temp_v0_19 = func_800BC90C(phi_a0_2, temp_a1);
                    sp44 = temp_v0_19 == arg0->unk48;
                    arg0->unk48 = temp_v0_19;
                    arg0->unk24 = *(&gNoteFrequencies + (temp_a1 * 4)) * temp_v0_19->unk4;
                } else {
                    arg0->unk48 = NULL;
                    phi_f4 = *(&gNoteFrequencies + (temp_a1 * 4));
block_117:
                    arg0->unk24 = phi_f4;
                }
            }
...
s32 func_800BEA10(void *, s32, s32);                /* extern */
? func_800BEB54(void *, s32);                       /* extern */
? func_800BEBA4(void *);                            /* extern */
? func_800BEE88(s32 *, s32, s32);                   /* extern */
s32 func_800BF108(void *);                          /* extern */
u16 func_800BF11C(void *);                          /* extern */
u16 func_800BF14C(void *);                          /* extern */
...
loop_12:
                ...
                if (temp_v0_2 >= 0xC1) {
                    ...
                    case 0xDE:                      /* switch 1 */
                        ...
                        goto loop_12;
                    case 0xD3:                      /* switch 1 */
                        temp_f8 = *(&gPitchBendFrequencyScale + (((func_800BF108(temp_s1) + 0x7F) & 0xFF) * 4));
                        arg0->unk1 = arg0->unk1 | 0x80;
                        arg0->unk30 = temp_f8;
                        goto loop_12;
                    case 0xDD:                      /* switch 1 */
