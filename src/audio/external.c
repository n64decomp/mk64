...
s32 func_800C357C(s32 arg0) {
    ...
    var_v0 = D_800EA1E8;
    var_v1 = 1;
    if ((s32) var_v0 < (s32) D_800EA1E4) {
        do {
            if (arg0 == *(&D_80192CD0 + (var_v0 * 4))) {
                var_v1 = 0;
                var_v0 = D_800EA1E4 & 0xFF;
            }
            temp_t9 = (var_v0 + 1) & 0xFF;
            var_v0 = (u8) temp_t9;
        } while (temp_t9 < (s32) D_800EA1E4);
    }
    return var_v1;
}
#else
...
void func_800C550C(s32 arg0) {
    ...
    var_s0 = 0;
    do {
        func_800C5384(var_s0 & 0xFF, arg0);
...
void func_800C59C4(void) {
    ...
    if (&gSequenceChannelNone != D_803B17D0) {
        ...
        var_s0 = 0;
        do {
            func_800C4888(var_s0 & 0xFF);
            func_800C4FE4(var_s0 & 0xFF);
            func_800C5968(var_s0 & 0xFF);
...
#ifdef MIPS_TO_C
//generated by m2c commit eefca95b040d7ee0c617bc58f9ac6cd1cf7bce87 on Aug-14-2023
static ? D_800EA154;                                /* unable to generate initializer */
u8 D_800EA1C0 = 0;

void func_800C5BD0(void) {
    if (D_800EA1C0 == 0) {
        func_800CBBE8((*(&D_800EA154 + gPlayers->characterId) << 8) | 0xF3000000, 0);
        return;
    }
    func_800CBBE8(0xF3004D00U, 0);
}
#else
...
void func_800C8C7C(s32 arg0) {
    ...
    temp_t6 = arg0 & 0xFF;
    *(&D_800EA06C->unk00[2] + (temp_t6 * 0x10)) = (1.0f - D_800E9F54[temp_t6]) - D_800EA130[temp_t6];
}
#else
...
block_4:
            play_sound((u32) arg1, (temp_a2 * 0x3C) + &D_800E9F7C, temp_a2, D_800EA1D4, D_800EA1D4, &D_800EA1DC);
        }
    }
}
#else
...
void func_800C9250(u8 arg0) {
    ...
    temp_t6 = arg0 & 0xFF;
    func_800C90F4(temp_t6, (*(&gPlayers->characterId + (temp_t6 * 0xDD8)) * 0x10) + (gAudioRandom & 1) + 0x29008001);
}
#else
...
void func_800C97C4(s32 arg0) {
    ...
    temp_a2 = arg0 & 0xFF;
    temp_s1 = &gPlayers[temp_a2];
    temp_s0 = (temp_a2 * 0x3C) + &D_800E9F7C;
    func_800C5578(temp_s0, temp_s1->characterId + 0x0104FF00);
    func_800C5578(temp_s0, temp_s1->characterId + 0x0104FF14);
    func_800C5578(temp_s0, temp_s1->characterId + 0x0104FF2E);
    func_800C5578(temp_s0, temp_s1->characterId + 0x0104FF36);
    func_800C5578(temp_s0, temp_s1->characterId + 0x0104FF3E);
}
#else
...
void func_800C99E0(f32 *arg0, s32 arg1) {
    f32 *temp_v0;
    s32 temp_t9;
    s32 var_s0;
    ...
    if (D_800EA108 == 0) {
        ...
        if ((D_800EA1C0 + 1) > 0) {
            do {
                ...
                if (temp_v0 != NULL) {
                    func_800C5578(temp_v0, (u32) arg1);
                }
                temp_t9 = (var_s0 + 1) & 0xFF;
                var_s0 = temp_t9;
            } while (temp_t9 < (D_800EA1C0 + 1));
...
extern u8 func_800C56F0();                                 /* extern */
extern s8 D_800EA168;
...
u8 D_800EA108 = 0;
static u8 D_800EA168 = 0;
static ? D_800EA170;                                /* unable to generate initializer */
...
void func_800CB064(u8 arg0) {
    ...
    if (D_800EA108 == 0) {
        ...
        if (*temp_t9 == 1) {
            ...
            func_800C90F4(arg0, (*(&gPlayers->characterId + (arg0 * 0xDD8)) * 0x10) + 0x29008008);
