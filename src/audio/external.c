...
void func_800C19D0(u8 arg0, u8 arg1, u8 arg2) {
    ...
    case 5:
        ...
        arg0 = temp_t6;
        temp_s0->unk1C = sqrtf(temp_s0->unk1C, temp_t6);
...
? func_800C29B4(u8, s32, void *, u32);              /* extern */
...
block_11:
    ...
    case 3:
        ...
        phi_t0_4 = temp_t1_2;
        if (temp_t1_2 > 0) {
            temp_a2_2 = (temp_t8_4 * 0xA) + &D_80192CA8;
            phi_a2_3 = temp_a2_2;
            do {
                phi_v1_6 = phi_v1_5;
                if ((arg0 & 0xFF) == *(temp_a2_2 + (phi_v1_5 * 2))) {
        ...
        if (phi_t0_2 != temp_t1_2) {
            ...
            phi_v1_7 = temp_v1;
            if (phi_t0_2 < temp_a3) {
                temp_a2_3 = (sp3C * 0xA) + &D_80192CA8;
                phi_v0_2 = temp_v1;
                phi_a2 = temp_a2_3;
                do {
                    temp_a1_3 = temp_a2_3 + (phi_v0_2 * 2);
                    temp_a0_3 = temp_a2_3 + (phi_v1_7 * 2);
        ...
        if ((phi_t0_2 == 0) && (temp_a3_2 = ((arg0 & 0xFF0000) >> 0xD) & 0xFFFF, sp4C = temp_a3_2, sp34 = temp_t4_2, func_800C29B4(unksp3F, temp_a3_2 & 0xFFFF, phi_a2, temp_a3_2), (*temp_t4_2 != 0))) {
    ...
    case 5:
        ...
        temp_a2_4 = temp_t6 & 0xFF;
        temp_f0_2 = (arg0 & 0xFFFF) / 1000.0f;
        phi_v1_8 = 0;
        do {
            temp_v0_7 = (temp_a2_4 * 0x24C) + &D_801930D0 + (phi_v1_8 << 5);
        ...
        (&D_801930D0 + (temp_a2_4 * 0x24C))->unk244 = 0xFFFF;
        return;
    case 6:
        ...
        if (temp_v0_8->unk44 != temp_f0_3) {
            ...
            temp_v0_9->unk244 = temp_v0_9->unk244 | (1 << temp_a2_5);
            return;
        }
        /* Duplicate return node #76. Try simplifying control flow for better match */
        return;
    ...
    case 8:
        ...
        temp_a2_6 = ((arg0 & 0xF00) >> 8) & 0xFF;
        if (((&D_801930D0 + (temp_v0_10 * 0x24C))->unk24A & (1 << temp_a2_6)) == 0) {
            func_800CBBE8(((temp_v0_10 & 0xFF) << 0x10) | 0x6000000 | ((temp_a2_6 & 0xFF) << 8) | (((arg0 & 0xFF0000) >> 0x10) & 0xFF), arg0, temp_a2_6);
            return;
        }
        /* Duplicate return node #76. Try simplifying control flow for better match */
        return;
    ...
    case 10:
        ...
        do {
            ...
            sp5B = phi_v1_9;
            sp44 = phi_a3;
            func_800CBBE8(sp48 | ((phi_v1_9 & 0xFF) << 8), phi_a2_2, phi_a2_2, phi_a3);
...
void func_800C64A0(s32 arg0) {
    ...
    switch (temp_t7) {
    case 3:
        temp_a1 = (temp_t6 * 0xDD8) + &gPlayers;
        temp_v1 = temp_v0 + &D_800E9EF4;
        *temp_v1 = (temp_a1->unk94 / 5.0f) + 0.2f;
        phi_v1 = temp_v1;
        phi_a1 = temp_a1;
        break;
    case 1:
    ...
    case 30:
    case 31:
        temp_a1_2 = (temp_t6 * 0xDD8) + &gPlayers;
        temp_v1_3 = temp_v0 + &D_800E9EF4;
        *temp_v1_3 = (temp_a1_2->unk94 / 5.0f) + 0.2f;
        phi_v1 = temp_v1_3;
        phi_a1 = temp_a1_2;
        break;
    default:
...
void func_800C70A8(s32 arg0) {
    ...
    if (*(&D_800EA0EC + temp_a1) == 0) {
        ...
        *temp_v0 = 0;
        if ((*(&D_800E9E54 + temp_v1) > 3500.0f) || (temp_v1_2 = (temp_a1 * 0xDD8) + &gPlayers, temp_a0 = temp_v1_2->unkBC, temp_t1 = temp_a0 & 0x10, phi_t1 = temp_t1, phi_v1 = temp_v1_2, phi_a0 = temp_a0, (temp_t1 == 0x10))) {
            temp_v1_3 = (temp_a1 * 0xDD8) + &gPlayers;
            temp_t7 = temp_v1_3->unk1D4;
            temp_a0_2 = temp_v1_3->unkBC;
            *temp_v0 = 1;
        ...
        if (((phi_v1->unk94 < 0.5f) || ((phi_a0 & 8) == 8)) && (*temp_v0 != 0x1C)) {
            *temp_v0 = 0;
        }
        if ((((phi_a0 & 0x4000) == 0x4000) && ((phi_v1->unk0 & 0x2000) != 0x2000)) || ((phi_a0 & 0x800) == 0x800) || ((phi_a0 & 0x80) == 0x80) || ((phi_a0 & 0x40) == 0x40) || ((phi_v1->unk44 & 0x4000) == 0x4000)) {
            *temp_v0 = 0x12;
        }
        if ((((phi_a0 & 0x20) == 0x20) && ((phi_v1->unk0 & 0x2000) != 0x2000)) || ((phi_a0 & 0x800) == 0x800)) {
            *temp_v0 = 0x13;
        }
        if (phi_v1->unk20C != 0.0f) {
            *temp_v0 = 3;
        }
    }
}
...
block_4:
            ...
            temp_a1->unkC = 1.0f;
            temp_a1->unk10 = 0.0f;
            temp_v1_2 = *(&gPlayers + 0x254 + (temp_a2 * 0xDD8));
            switch (temp_v1_2) {
            case 0:
            case 1:
                temp_a1->unk18 = 2.8f;
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit bd0364fa19633bd6201f8007e2d0a7ed87825909
void *func_800C1C88(s32, void *, void *, void *, s32, s32); /* extern */
? play_sound(s32, void *, s32, void *, void *, void *); /* extern */
extern ? gPlayers;
...
block_4:
            temp_v1 = (temp_s3 * 0xDD8) + &gPlayers;
            temp_t0 = temp_v1->unk254;
            switch (temp_t0) {
            case 0:
            case 1:
            ...
            if (temp_v0_7 < 2) {
                ...
                if (temp_v0_7 >= 0) {
                    ...
                    do {
                        ...
                        temp_v0_8 = func_800C1C88(temp_s3 & 0xFF, temp_v1 + 0x14, temp_v1 + 0x34, temp_v1 + 0x98, phi_s0, temp_s1);
                        if (temp_v0_8 != 0) {
