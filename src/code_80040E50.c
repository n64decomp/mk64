...
u16 func_800417B4(u16 arg0, u16 arg1) {
    ...
    if ((arg1 >> 8) != (arg0 >> 8)) {
        ...
        if (temp_t0 < 0x400) {
            ...
            return (arg0 + 0x200) & 0xFFFF;
        } else if (temp_t0 < 0x4000) {
            return (arg0 + 0x400) & 0xFFFF;
        } else if (temp_t0 < 0x8000) {
            return (arg0 + 0x700) & 0xFFFF;
...
// Need more decomp to know which structs go here.
#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
void func_802ADDC8(f32, UnkActorInner*, UnkActorInner*, f32, f32); // extern

s32 func_80041924(Vec3su arg0, UnkActorInner *arg1, f32 arg2) {
    s32 phi_v1 = 0;

    func_802ADDC8(10.0f, arg1, arg1, arg1->unk40, arg2);
    if (arg0[2] == 1) {
        phi_v1 = 1;
    }
    return phi_v1;
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 7

UNUSED void func_80042B5C(void* arg0, void* arg1, void* arg2) {
    f32 sp74;
    f32 sp70;
    f32 sp6C;
    f32 sp68;
    ...
    temp_f12 = sp50 * sp48;
    temp_f18 = arg1->unk0;
    sp74 = temp_f18 * ((sp44 * temp_f0) + (temp_f12 * sp40));
    sp34 = arg1->unk4;
    temp_f4 = sp34 * ((-sp44 * sp40) + (temp_f12 * temp_f0));
    sp68 = temp_f4;
    temp_f6 = arg1->unk8;
    sp28 = sp50;
    sp30 = temp_f6;
    sp2C = sp34;
    temp_f8 = temp_f6 * (temp_f20 * sp48);
    sp5C = temp_f8;
    sp70 = temp_f18 * (temp_f20 * sp40);
    sp2C = temp_f4;
    sp64 = sp34 * (temp_f20 * temp_f0);
    temp_f4_2 = sp28;
    sp28 = temp_f8;
    sp58 = temp_f6 * -temp_f4_2;
    temp_f12_2 = temp_f4_2 * sp44;
    sp6C = temp_f18 * ((-sp48 * temp_f0) + (temp_f12_2 * sp40));
    sp60 = sp34 * ((sp48 * sp40) + (temp_f12_2 * temp_f0));
    sp54 = temp_f6 * (temp_f20 * sp44);
    arg0->unk0 = (f32) (sp74 + sp2C + sp28);
    arg0->unk4 = (f32) (sp70 + sp64 + sp58);
    arg0->unk8 = (f32) (sp6C + sp60 + sp54);
}
#else
GLOBAL_ASM("asm/non_matchings/code_80040E50/func_80042B5C.s")
#endif
...
void func_80042F70(s32 arg0, Vec3su arg1, f32 arg2) {
    ...
    sp20[2] = arg1[2];
    func_800425D0(sp28, arg0, sp20, arg2);
    func_80022180(&gGfxPool->mtxPool[D_8018D120 + 0xB], sp28);
