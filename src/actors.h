...
void render_obj_cow(Camera*, Mat4, struct Actor*);
...
void render_obj_piranha_plant(Camera*, Mat4, struct PiranhaPlant*);
...
void render_obj_tree_bowser_castle(Camera*, Mat4, struct Actor*);
void render_obj_bush_bowser_castle(Camera*, Mat4, struct Actor*);
void render_obj_tree_frappe_snowland(Camera*, Mat4, struct Actor*);
void render_obj_tree_cactus1_kalimari_desert(Camera*, Mat4, struct Actor*);
void render_obj_tree_cactus2_kalimari_desert(Camera*, Mat4, struct Actor*);
void render_obj_tree_cactus3_kalimari_desert(Camera*, Mat4, struct Actor*);
void render_obj_kiwano_fruit_dks_jungle_parkway(Camera*, Mat4, struct Actor*);
void render_obj_shell(Camera*, Mat4, struct ShellActor*);
void render_obj_green_shell(Camera*, Mat4, struct ShellActor*);
void render_obj_red_shell(Camera*, Mat4, struct ShellActor*);
void render_obj_blue_shell(Camera*, Mat4, struct ShellActor*);
void render_obj_banana(Camera*, Mat4, struct BananaActor*);
...
void render_obj_falling_rock(Camera*, struct FallingRock*);
...
extern Gfx bananaModel[];
extern Gfx FlatBananaModel[];
