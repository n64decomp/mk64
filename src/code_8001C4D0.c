...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
void func_8001CA10(void *arg0) {
    arg0->unk9C = 0;
    arg0->unk94 = 6.0f;
}
#else
GLOBAL_ASM("asm/non_matchings/code_8001C4D0/func_8001CA10.s")
#endif
...
void func_8001CA24(s32 arg0, f32 arg1) {
    ? *phi_v0;
    ? *phi_v0_2;
    ? *phi_v0_3;
    ...
    phi_v0_2 = phi_v0_3;
    if (arg0 == D_800DC4E4) {
        phi_v0_2 = phi_v0_3 + 0x170;
    }
    phi_v0 = phi_v0_2;
    if (arg0 == D_800DC4E8) {
        phi_v0 = phi_v0_2 + 0x228;
    }
    phi_v0->unk9C = 0;
    phi_v0->unk94 = arg1;
}
#else
GLOBAL_ASM("asm/non_matchings/code_8001C4D0/func_8001CA24.s")
#endif
...
loop_3:
            ...
            if (((temp_v0 & 0x200) == 0) && ((temp_v0 & 0x80) == 0)) {
                ...
                if ((phi_a1 == 0x60E8) && (D_80164A2C == 0x3C)) {
                    D_80164A28 = 2;
                    *(&D_80152300 + (arg0 * 2)) = 1;
                    temp_v0_2 = &D_801646F0 + (arg0 * 0xB8);
