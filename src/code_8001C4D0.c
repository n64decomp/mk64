...
? func_80014DE4(s32, s32, s32, void *);             /* extern */
? func_802B7F7C(void *, void *, void *, void *);    /* extern */
...
void func_8001C4D0(f32 arg0, f32 arg1, f32 arg2, ? arg3, u32 arg4, s32 arg5) {
    void *sp30;
    s32 sp2C;
    s32 sp28;
    f32 *sp24;
    ...
    *(&D_80152300 + temp_t6) = arg4;
    ...
    case 10:
        D_80164A89 = 0;
        temp_a3 = (arg5 * 0xB8) + &cameras;
        temp_a3->unk0 = arg0;
        temp_a3->unk4 = arg1;
        temp_a3->unk8 = arg2;
        temp_a3->unk2A = 0;
        temp_a3->unk14 = 150.0f;
        temp_a3->unk10 = arg1 - 3.0;
        temp_a3->unkC = 0.0f;
        temp_a3->unk18 = 0.0f;
        temp_a3->unk20 = 0.0f;
        temp_a3->unk1C = 1.0f;
        ...
        *(&D_80164498 + temp_t6_2) = 0.0f;
        temp_a3->unk9C = 0;
        temp_a3->unk94 = 0.0f;
        temp_v1 = D_800DC4DC + (arg5 * 0xDD8);
        temp_a3->unk2C = temp_v1->unk2E;
        temp_a3->unkAC = temp_v1->unk2E;
        temp_v0 = D_800DC52C;
        if (temp_v0 != 0) {
            if (temp_v0 != 1) {
                if (temp_v0 != 2) {
...
block_7:
        ...
        sp20 = temp_t2;
        sp1C = temp_t3;
        func_80014DE4(arg5, temp_t6_2, temp_t6, temp_a3);
    ...
    temp_a3_2 = (arg5 * 0xB8) + &cameras;
    func_802B7F7C(temp_a3_2, temp_a3_2 + 0xC, temp_a3_2 + 0x24, temp_a3_2);
}
#else
...
void func_8001F394(void *arg0, f32 *arg1) {
    s32 sp2C;
    s32 sp1C;
    f32 *temp_a0;
    f32 *temp_a0_2;
...
block_51:
    ...
    if (temp_v0_4 != 0) {
        if ((temp_v0_4 != 1) && (temp_v0_4 != 2) && (temp_v0_4 != 3)) {
            ...
            phi_f0 = func_80014EE4(*arg1, sp2C);
            goto block_66;
        }
    } else {
        temp_v0_5 = D_80164A28;
        if (temp_v0_5 == 1) {
            *(&D_80164498 + (sp2C * 4)) = 40.0f;
        }
        temp_a0_6 = (sp2C * 4) + &D_80164498;
        if (temp_v0_5 == 2) {
            temp_f0_6 = *temp_a0_6;
            if (temp_f0_6 >= 0.0f) {
                *temp_a0_6 = (f32) ((f64) temp_f0_6 - 0.8);
            }
            if (*temp_a0_6 <= 0.0f) {
                D_80164A28 = 0;
                *temp_a0_6 = 0.0f;
        ...
        phi_f0 = func_80014EE4(*arg1, (s32) temp_a0_6, sp2C);
block_66:
        phi_f2 = phi_f0;
    }
    *arg1 = phi_f2;
    ((sp2C * 0xB8) + &cameras)->unkB4 = phi_f2;
}
#else
