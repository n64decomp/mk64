...
void func_800A3E60(struct_8018D9E0_entry* arg0) {
    ...
    switch () {  /* switch 1 */
        ...
        case 30: /* switch 1 */
            for (var_s1 = 0; var_s1 < 6; var_s1++) {
                var_v1 = 0;
                text_rainbow_effect(-5, var_s1, 1);
        ...
        case 18: /* switch 1 */
            ...
            for (var_s1 = 0; var_s1 < 2; var_s1++) {
                text_rainbow_effect(-0x11, var_s1, 1);
        ...
        case 21: /* switch 1 */
            ...
            for (var_s1 = 0; var_s1 < 2; var_s1++) {
                text_rainbow_effect(-0x14, var_s1, 1);
    ...
    switch () {  /* switch 2 */
        ...
        case 9:  /* switch 2 */
        case 10: /* switch 2 */
            var_v0_5 = &D_800E7390[-5];
            break;
        case 17: /* switch 2 */
        case 18: /* switch 2 */
            var_v0_5 = &D_800E73C0[-17];
            break;
        case 20: /* switch 2 */
        case 21: /* switch 2 */
            var_v0_5 = &D_800E73D0[-20];
            break;
        case 30: /* switch 2 */
...
void render_pause_menu_time_trials(struct_8018D9E0_entry* arg0) {
    ...
    for (var_s0 = 0; var_s0 < 5; var_s0++) {
        text_rainbow_effect(-11, var_s0, TEXT_GREEN);
...
void render_pause_menu_versus(struct_8018D9E0_entry* arg0) {
    ...
    for (var_s0 = 0; var_s0 < 4; var_s0++) {
        ...
        text_rainbow_effect(-0x15, var_s0, TEXT_YELLOW);
...
void render_pause_grand_prix(struct_8018D9E0_entry* arg0) {
    ...
    for (var_s0 = 0; var_s0 < 2; var_s0++) {
        text_rainbow_effect(-31, var_s0, TEXT_YELLOW);
...
void render_pause_battle(struct_8018D9E0_entry* arg0) {
    ...
    for (var_a1 = 0; var_a1 < 4; var_a1++) {
        ...
        text_rainbow_effect(-0x29, var_a1, TEXT_YELLOW);
...
void func_800A54EC(void) {
    ...
    sp50.row = (var_v1->row + ((-whyTheSequel) * 0xD)) - 8;
    ...
    if (== 0) {
        ...
        switch () {  /* switch 1 */
            ...
            case 16: /* switch 1 */
                ...
                for (var_s1 = 0; var_s1 < 6; var_s1++) {
                    text_rainbow_effect(-0xB, var_s1, TEXT_GREEN);
            ...
            case 31: /* switch 1 */
                ...
                for (var_s1 = 0; var_s1 < 2; var_s1++) {
                    text_rainbow_effect(-0x1E, var_s1, TEXT_GREEN);
            ...
            case 36: /* switch 1 */
                ...
                for (var_s1 = 0; var_s1 < 2; var_s1++) {
                    text_rainbow_effect(-0x23, var_s1, TEXT_GREEN);
        ...
        switch () {  /* switch 2 */
            ...
            case 15: /* switch 2 */
            case 16: /* switch 2 */
                var_v0_9 = &D_800E73E0[-11];
                break;
            case 30: /* switch 2 */
            case 31: /* switch 2 */
                var_v0_9 = &D_800E7410[-30];
                break;
            case 35:      /* switch 2 */
            case 36:      /* switch 2 */
                if (0) {} // wtf?
                var_v0_9 = &D_800E7420[-35];
                break;
            default:
                return;
        }
...
void func_800A6154(struct_8018D9E0_entry* arg0) {
    ...
    if (== 0) {
        ...
        for (var_s1 = 0, var_s0 = 0x96; var_s1 < 2; var_s1++, var_s0 += 0x14) {
            text_rainbow_effect(-0xB, var_s1, TEXT_YELLOW);
...
void func_800AD2E8(struct_8018D9E0_entry* arg0) {
    ...
    switch () { /* switch 3; irregular */
                    ...
                    if (== 0x0000000A) {
                        ...
                        if (gControllerPak1State != 0) {
                            ...
                            switch (osPfsFindFile(&gControllerPak1FileHandle, gCompanyCode, gGameCode, (u8*) gGameName,
                                ...
                                case 0: /* switch 4 */
                                    func_800B6708();
                                    = func_800B6348((gCupSelection * 4) + gCourseIndexInCup) + 0x11;
                                    var_v1 = 1;
        ...
        case 20: /* switch 1 */
        case 21: /* switch 1 */
            if (((gControllerOne->buttonPressed | gControllerOne->stickPressed) & 0x800) && (>= 0x15)) {
                --;
                play_sound2(SOUND_MENU_CURSOR_MOVE);
                if (arg0->unk24 < 4.2) {
                    arg0->unk24 += 4.0;
...
void func_800AE218(struct_8018D9E0_entry* arg0) {
    ...
    switch () { /* switch 1 */
                        ...
                        if (gControllerPak1State != 0) {
                            ...
                            switch (osPfsFindFile(&gControllerPak1FileHandle, gCompanyCode, gGameCode, (u8*) gGameName,
                                ...
                                case PFS_NO_ERROR: /* switch 3 */
                                    func_800B6708();
                                    = func_800B6348((gCupSelection * 4) + gCourseIndexInCup) + 0x1E;
                                    var_v1 = 1;
                                    break;
        ...
        case 35: /* switch 1 */
        case 36: /* switch 1 */
            if (((gControllerOne->buttonPressed | gControllerOne->stickPressed) & 0x800) && ((s32) (u32) >= 0x24)) {
                --;
                play_sound2(SOUND_MENU_CURSOR_MOVE);
                if (arg0->unk24 < 4.2) {
                    arg0->unk24 += 4.0;
...
void func_800AEC54(struct_8018D9E0_entry* arg0) {
    switch () {
        ...
        case 3:
            ...
            if (((arg0->column + 0x14) == -(get_string_width(D_800E7780) / 2)) && (== 3)) {
                = 4;
            }
            break;
        default:
    ...
    switch () {
        ...
        case 4:
            ...
            if (arg0->unk1C >= 9) {
                arg0->unk1C = 0;
                ++;
                add_8018D9E0_entry(+0x12B, 0, 0, 4);
            }
            break;
        case 5:
            arg0->unk1C += 1;
