...
s32 get_character_width_index(char *character) {
    s32 index = 1;
...
#else
GLOBAL_ASM("asm/non_matchings/code_80091750/get_character_width_index.s")
#endif
...
s32 get_string_width(char *buffer) {
    ...
    if (*buffer != 0) {
        do {
            width_index = get_character_width_index(buffer);
            if (width_index >= 0) {
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
s32 get_character_width_index(s8 *); // extern
...
void print_text0(s32 arg0, s32 arg1, s8 *arg2, s32 arg3, f32 arg4, f32 arg5, s32 arg6) {
    ...
    if (*arg2 != 0) {
loop_2:
        temp_v0_2 = get_character_width_index(phi_s1);
        if (temp_v0_2 >= 0) {
...
void print_text1(s32 arg0, s32 arg1, s8 *arg2, s32 arg3, f32 arg4, f32 arg5, s32 arg6) {
    ...
    if (*arg2 != 0) {
loop_2:
        temp_v0 = get_character_width_index(phi_s0);
        if (temp_v0 >= 0) {
...
block_16:
    ...
    if (*arg2 != 0) {
loop_22:
        temp_v0_3 = get_character_width_index(phi_s2);
        if (temp_v0_3 >= 0) {
