...
f64 func_800917B0(f64 arg0, ? arg0_lo, f64 arg1, ? arg1_lo, s32 arg2) {
    s32 temp_f8;

    if ((arg1 <= 2147483647.0) && (arg1 >= -2147483647.0)) {
        temp_f8 = (s32) arg1;
        if (arg1 == (f64) temp_f8) {
...
Gfx *func_80095BD0(Gfx *arg0, s32 arg1, s32 arg2, s32 arg3, u32 arg4, s32 arg5, s32 arg6, f32 arg7) {
    ...
    if (D_80164AF0 < 0x2F7) {
        sp28 = &gGfxPool->mtxPool[D_80164AF0] + 0xFAC0;
        if (D_80164AF0 < 0) {
...
void func_8009DEF8(u32 arg0, s8 arg1) {
    ...
    if ((D_8018E7AC.unk4 != 1) && (D_8018E7AC.unk4 != 6)) {
        D_8018E7AC.unk4 = arg1;
        D_8018E7B8.unk10 = var_a0;
        if (var_a0 >= 0x100U) {
            D_8018E7B8.unk10 = 0x000000FFU;
        }
        D_8018E7E0 = 0;
    }
}
...
void func_8009DF8C(u32 arg0, s8 arg1) {
    ...
    if ((D_8018E7AC.unk4 != 2) && (D_8018E7AC.unk4 != 5)) {
        D_8018E7AC.unk4 = arg1;
        D_8018E7B8.unk10 = var_a0;
        if (var_a0 >= 0x100U) {
            D_8018E7B8.unk10 = 0x000000FFU;
...
void func_800A1BE0(struct_8018D9E0_entry *arg0) {
    ...
    temp_s6 = &gSaveData.allCourseTimeTrialRecords.cupRecords[gTimeTrialDataCourseIndex / 4].courseRecords[gTimeTrialDataCourseIndex % 4].records[0];
    var_s3 = D_800E7834;
    var_s0 = 0;
    var_s4 = 0x0000003F;
    do {
...
block_9:
        ...
        if (var_s1 != 0) {
            ...
            temp_v1 = gDisplayListHead;
            gDisplayListHead = temp_v1 + 8;
            temp_v1->words.w1 = 0x00000096;
            temp_v1->words.w0 = 0xFA000000;
            func_80093358(0x00000025, var_s4, *var_s3, 0, 0.6f, 0.6f);
        } else {
            set_text_color(var_s2);
            func_80093324(0x00000025, var_s4, *var_s3, 0, 0.6f, 0.6f);
        }
        var_s0 += 1;
        var_s3 += 4;
        var_s4 += 0xD;
...
void func_800A1DE0(struct_8018D9E0_entry *arg0) {
    ...
    var_s0 = 0x0000003C;
    do {
        func_80093324(0x0000001B, var_s0, (D_800E7848[gCourseRecordsMenuSelection] + var_s1)->unk-C, 0, 0.65f, 0.65f);
        var_s0 += 0xD;
        var_s1 += 4;
    } while (var_s0 < 0x63);
    var_s0_2 = D_800E7840;
    ...
    do {
        var_a0 = 1;
        if (var_s2 == D_8018EDF9) {
            var_a0 = 5;
        }
        set_text_color(var_a0);
        func_80093324(0x00000043, var_s1_2, *var_s0_2, 0, 0.65f, 0.65f);
        var_s2 += 1;
        var_s0_2 += 4;
        var_s1_2 += 0xD;
    } while (var_s2 != 2);
...
void func_800A1FB0(struct_8018D9E0_entry *arg0) {
    ...
    case 0x18:                                      /* switch 1 */
        ...
        var_s0 = 0x00000055;
        do {
            func_80092224(var_a0, var_s2, 3);
            func_80093324(0x00000032, var_s0, *var_s1, 0, 0.9f, 1.0f);
            var_s1 += 4;
            var_a0 = D_8018EDEC - 0x15;
            if (var_s2 == var_a0) {
                spE0 = 0x0032;
                spE2 = (s16) var_s0;
            }
...
block_98:
    ...
    case 0x1F:                                      /* switch 1 */
        ...
        var_s0_2 = 0x00000055;
        do {
            func_80093324(0x00000028, var_s0_2, *var_s1_2, 0, 1.0f, 1.0f);
            var_s1_2 += 4;
            var_s0_2 += 0x14;
        } while ((u32) var_s1_2 < (u32) D_800E7884);
        var_s1_3 = D_800E7840;
        var_s2_2 = 0;
        var_s0_3 = 0x00000096;
        var_a0_2 = D_8018EDEC - 0x1E;
        do {
            func_80092224(var_a0_2, var_s2_2, 1);
            func_80093324(0x00000084, var_s0_3, *var_s1_3, 0, 1.0f, 1.0f);
            var_v1 = D_8018EDEC;
            var_s1_3 += 4;
            var_a0_2 = var_v1 - 0x1E;
            if (var_s2_2 == var_a0_2) {
                spE0 = 0x0084;
                spE2 = (s16) var_s0_3;
            }
            var_s2_2 += 1;
    ...
    case 0x20:                                      /* switch 1 */
        ...
        var_s0_4 = 0x00000055;
        do {
            func_80093324(0x00000032, var_s0_4, *var_s1_4, 0, 1.0f, 1.0f);
            var_s1_4 += 4;
            var_s0_4 += 0x14;
        } while (var_s1_4 != D_800E7890);
        goto block_98;
    case 0x2A:                                      /* switch 1 */
    case 0x2B:                                      /* switch 1 */
    case 0x2C:                                      /* switch 1 */
    case 0x2D:                                      /* switch 1 */
        set_text_color(2);
        var_s1_5 = ((D_8018EDEC - 0x2A) * 0xC) + D_800E78D0;
        var_s0_5 = 0x00000055;
        do {
            func_80093324(0x00000032, var_s0_5, *var_s1_5, 0, 0.9f, 0.9f);
            var_s0_5 += 0x14;
            var_s1_5 += 4;
        } while (var_s0_5 != 0x00000091);
        goto block_98;
    case 0x34:                                      /* switch 1 */
    case 0x35:                                      /* switch 1 */
    case 0x36:                                      /* switch 1 */
    case 0x37:                                      /* switch 1 */
        set_text_color(2);
        var_s1_6 = D_800E7890[D_8018EDEC - 0x34];
        var_s0_6 = 0x00000055;
        do {
            func_80093324(0x00000023, var_s0_6, *var_s1_6, 0, 0.8f, 0.8f);
            var_s0_6 += 0x14;
            var_s1_6 += 4;
        } while (var_s0_6 != 0x000000A5);
        goto block_98;
    case 0x41:                                      /* switch 1 */
    case 0x42:                                      /* switch 1 */
        set_text_color(2);
        var_s1_7 = D_800E7900[D_8018EDEC - 0x41];
        var_s0_7 = 0x00000055;
        do {
            func_80093324(0x00000041, var_s0_7, *var_s1_7, 0, 0.9f, 0.9f);
            var_s0_7 += 0x14;
            var_s1_7 += 4;
        } while (var_s0_7 != 0x00000091);
        goto block_98;
    case 0x46:                                      /* switch 1 */
    case 0x47:                                      /* switch 1 */
        set_text_color(3);
        ...
        var_s0_8 = 0x00000055;
        do {
            func_80093324(0x00000050, var_s0_8, *var_s1_8, 0, 1.0f, 1.0f);
            var_s1_8 += 4;
            var_s0_8 += 0x14;
        } while (var_s1_8 != D_800E7A54);
        goto block_98;
    case 0x28:                                      /* switch 1 */
    case 0x29:                                      /* switch 1 */
    case 0x32:                                      /* switch 1 */
    case 0x33:                                      /* switch 1 */
        var_s5 = 0x00000028;
        if ((var_v1 != 0x28) && (var_v1 != 0x29)) {
            var_s5 = 0x00000032;
            if ((var_v1 != 0x32) && (var_s4 = spC0, (var_v1 != 0x33))) {
                var_s5 = spC4;
            } else {
                var_s4 = 1;
            }
...
loop_38:
            if (var_s3 != sp78) {
                func_800921C0(D_8018EDEC - var_s5, var_s0_9, 1);
                if (var_s0_9 == (D_8018EDEC - var_s5)) {
                    spE0 = var_s6;
                    spE2 = var_s2_3;
                }
            } else if ((var_s4 != 0) && (var_s0_9 == arg0->unk20)) {
                set_text_color((s32) gGlobalTimer % 3);
            } else {
                set_text_color(1);
            }
            temp_s1 = var_s0_9 + 1;
            convert_number_to_ascii(temp_s1, &spB8);
            func_80093324((s32) var_s6, (s32) var_s2_3, &spB9, 0, 0.6f, 0.6f);
            if (var_s3 == 0x0000002A) {
                var_v1_2 = &D_8018EE10[var_s0_9];
            } else {
                var_v1_2 = &D_8018D9C0[var_s0_9];
            }
            if (var_v1_2->ghostDataSaved == 0) {
                func_80093324(var_s3, (s32) var_s2_3, D_800E7A44, 0, 0.5f, 0.5f);
            } else {
                temp_v0 = var_v1_2->courseIndex;
                func_80093324(var_s3, (s32) var_s2_3, D_800E75C4[*(gCupCourseOrder + (((temp_v0 / 4) * 8) + ((temp_v0 % 4) * 2)))], 0, 0.5f, 0.5f);
            }
            var_s0_9 = temp_s1;
            var_s2_3 += 0x1E;
            if (temp_s1 != 2) {
    ...
    case 0x39:                                      /* switch 1 */
        set_text_color(2);
        var_s0_10 = D_800E7928;
        var_s1_9 = 0x0000004D;
        do {
            draw_text(0x000000A0, var_s1_9, *var_s0_10, 0, 0.8f, 0.8f);
            var_s0_10 += 4;
            var_s1_9 += 0x14;
...
loop_58:
            if (var_s3_2 == 0x0000002A) {
                if (var_s0_11 == arg0->unk1C) {
                    set_text_color((s32) gGlobalTimer % 3);
                } else {
                    set_text_color(1);
                }
            } else if (var_s0_11 == arg0->unk20) {
                set_text_color((s32) gGlobalTimer % 3);
            } else {
                set_text_color(1);
            }
            temp_s1_2 = var_s0_11 + 1;
            convert_number_to_ascii(temp_s1_2, &spA8);
            func_80093324(var_s6_2, var_s2_4, &spA9, 0, 0.6f, 0.6f);
            if (var_s3_2 == 0x0000002A) {
                var_v1_3 = &D_8018EE10[var_s0_11];
            } else {
                var_v1_3 = &D_8018D9C0[var_s0_11];
            }
            if (var_v1_3->ghostDataSaved == 0) {
                func_80093324(var_s3_2, var_s2_4, D_800E7A44, 0, 0.5f, 0.5f);
            } else {
                temp_v0_2 = var_v1_3->courseIndex;
                func_80093324(var_s3_2, var_s2_4, D_800E75C4[*(gCupCourseOrder + (((temp_v0_2 / 4) * 8) + ((temp_v0_2 % 4) * 2)))], 0, 0.5f, 0.5f);
            }
            var_s0_11 = temp_s1_2;
            var_s2_4 += 0x1E;
            if (temp_s1_2 != 2) {
        ...
        var_s1_10 = 0x006E;
        do {
            temp_a0 = D_8018EDEC - 0x38;
            if (var_s2_5 == temp_a0) {
                spE0 = var_s1_10;
                spE2 = 0x00D2;
            }
            func_800921C0(temp_a0, var_s0_11, 3);
            func_80093324((s32) var_s1_10, 0x000000D2, *var_s3_3, 0, 0.75f, 0.75f);
            var_s2_5 += 1;
            var_s1_10 += 0x32;
            var_s3_3 += 4;
        } while (var_s2_5 != 2);
    ...
    case 0x3C:                                      /* switch 1 */
        set_text_color(2);
        temp_v0_3 = &D_800E7938[(s32) (var_v1 - 0x3A) / 2];
        sp78 = temp_v0_3;
...
loop_80:
            ...
            } else if (var_s0_12 == arg0->unk20) {
                set_text_color(2);
            } else {
                set_text_color(1);
            }
            temp_s1_3 = var_s0_12 + 1;
            convert_number_to_ascii(temp_s1_3, &sp98);
            func_80093324(var_s6_3, var_s2_6, &sp99, 0, 0.6f, 0.6f);
            if (var_s3_4 == 0x0000002A) {
                var_v1_4 = &D_8018EE10[var_s0_12];
            } else {
                var_v1_4 = &D_8018D9C0[var_s0_12];
            }
            if (var_v1_4->ghostDataSaved == 0) {
                func_80093324(var_s3_4, var_s2_6, D_800E7A44, 0, 0.5f, 0.5f);
            } else {
                temp_v0_4 = var_v1_4->courseIndex;
                func_80093324(var_s3_4, var_s2_6, D_800E75C4[*(gCupCourseOrder + (((temp_v0_4 / 4) * 8) + ((temp_v0_4 % 4) * 2)))], 0, 0.5f, 0.5f);
            }
            var_s0_12 = temp_s1_3;
            var_s2_6 += 0x1E;
            if (temp_s1_3 != 2) {
...
void func_800A3E60(struct_8018D9E0_entry *arg0) {
    ...
    s8 **var_v0_4;
    s8 temp_v0_2;
    struct_8018EE10_entry *var_s2_3;

    temp_v0 = arg0->unk4;
    if ((temp_v0 != 0) && (temp_v0 != 0x0000001F)) {
        set_text_color(4);
        ...
        case 30:                                    /* switch 1 */
            ...
            do {
                sp6C = 0;
                func_800921C0(arg0->unk4 - 5, var_s1_2, 1);
                var_v1 = sp6C;
                switch (var_s1_2) {                 /* switch 3; irregular */
                case 4:                             /* switch 3 */
                    if (D_80162DF8 == 1) {
                        var_v1 = 1;
                    }
                ...
                if (var_v1 != 0) {
                    ...
                    temp_v1_2 = gDisplayListHead;
                    gDisplayListHead = temp_v1_2 + 8;
                    temp_v1_2->words.w1 = 0x00000096;
                    temp_v1_2->words.w0 = 0xFA000000;
                    func_80093358(0xB2 - arg0->column, arg0->row + var_s2 + 0x93, var_s0_2->unk4, 0, 0.75f, 0.75f);
                } else {
                    func_80093324(0xB2 - arg0->column, arg0->row + var_s2 + 0x93, var_s0_2->unk4, 0, 0.75f, 0.75f);
                }
                var_s1_2 += 1;
                var_s2 += 0xD;
                var_s0_2 += 4;
        ...
        case 16:                                    /* switch 1 */
            set_text_color(3);
            var_v0 = D_800E798C[arg0->unk4 - 0xB];
            var_s0_3 = 0x0000008C;
            do {
                sp50 = var_v0;
                func_80093324(0x000000A2, var_s0_3, *var_v0, 0, 0.6f, 0.6f);
                var_s0_3 += 0xD;
                var_v0 += 4;
            } while (var_s0_3 != 0x000000E7);
            break;
        case 17:                                    /* switch 1 */
        case 18:                                    /* switch 1 */
            set_text_color(1);
            ...
            var_s2_2 = 0;
            do {
                func_80093324(0x000000A5, arg0->row + var_s2_2 + 0x8C, *var_s0_4, 0, 0.7f, 0.7f);
                var_s0_4 += 4;
                var_s2_2 += 0xD;
            } while ((u32) var_s0_4 < (u32) &D_800E7A44);
            var_s2_3 = D_8018EE10;
            var_s1_3 = 0;
            var_s0_5 = 0x000000AA;
            do {
                func_800921C0(arg0->unk4 - 0x11, var_s1_3, 1);
                temp_a0 = var_s1_3 + 1;
                sp54 = temp_a0;
                convert_number_to_ascii(temp_a0, &sp60);
                func_80093324(0xB1 - arg0->column, var_s0_5, &sp61, 0, 0.6f, 0.6f);
                if (var_s2_3->ghostDataSaved == 0) {
                    func_80093324(0xBB - arg0->column, var_s0_5, D_800E7A44, 0, 0.45f, 0.45f);
                } else {
                    temp_v0_2 = var_s2_3->courseIndex;
                    func_80093324(0xBB - arg0->column, var_s0_5, D_800E75C4[*(gCupCourseOrder + (((temp_v0_2 / 4) * 8) + ((temp_v0_2 % 4) * 2)))], 0, 0.45f, 0.45f);
                }
                var_s1_3 = sp54;
                var_s0_5 += 0x1E;
                var_s2_3 += 0x80;
        ...
        case 19:                                    /* switch 1 */
            ...
            do {
                sp50 = var_v0_2;
                func_80093324(0x000000AA, var_s0_6, *var_v0_2, 0, 0.8f, 0.8f);
                var_s0_6 += 0xD;
                var_v0_2 += 4;
            } while (var_v0_2 != D_800E7A54);
            break;
        case 20:                                    /* switch 1 */
        case 21:                                    /* switch 1 */
            set_text_color(3);
            ...
            var_s2_4 = 0;
            do {
                func_80093324(0x000000A3, arg0->row + var_s2_4 + 0x8C, *var_s0_7, 0, 0.67f, 0.67f);
                var_s0_7 += 4;
                var_s2_4 += 0xD;
            } while ((u32) var_s0_7 < (u32) D_800E7A6C);
            var_s2_5 = D_800E7A6C;
            var_s1_4 = 0;
            var_s0_8 = 0x000000B9;
            do {
                func_800921C0(arg0->unk4 - 0x14, var_s1_4, 1);
                func_80093324(0xC8 - arg0->column, var_s0_8, *var_s2_5, 0, 0.75f, 0.75f);
                var_s1_4 += 1;
                var_s0_8 += 0xF;
                var_s2_5 += 4;
            } while (var_s1_4 != 2);
        ...
        case 25:                                    /* switch 1 */
            ...
            do {
                sp50 = var_v0_3;
                func_80093324(0x000000A3, var_s0_9, *var_v0_3, 0, 0.67f, 0.67f);
                var_s0_9 += 0xD;
                var_v0_3 += 4;
            } while (var_v0_3 != D_800E7A80);
            break;
        case 26:                                    /* switch 1 */
            set_text_color(3);
            var_v0_4 = D_800E7A80;
            var_s0_10 = 0x00000093;
            do {
                sp50 = var_v0_4;
                func_80093324(0x000000AA, var_s0_10, *var_v0_4, 0, 0.75f, 0.75f);
                var_s0_10 += 0xD;
                var_v0_4 += 4;
            } while (var_v0_4 != D_800E7A88);
            break;
        }
        ...
        case 9:                                     /* switch 2 */
        case 10:                                    /* switch 2 */
            var_v0_5 = &D_800E7390[arg0->unk4].unk-28;
block_50:
            sp84 = var_v0_5->unk0 - arg0->column;
            sp86 = var_v0_5->unk2 + arg0->row;
            func_800A66A8(arg0, &sp84);
            break;
        case 17:                                    /* switch 2 */
        case 18:                                    /* switch 2 */
            var_v0_5 = &D_800E73C0[arg0->unk4].unk-88;
            goto block_50;
        case 20:                                    /* switch 2 */
        case 21:                                    /* switch 2 */
            var_v0_5 = &D_800E73D0[arg0->unk4].unk-A0;
            goto block_50;
        case 30:                                    /* switch 2 */
            var_v0_5 = &D_800E7390[arg0->unk1C].unk-28;
            goto block_50;
        }
    }
}
...
extern char *D_800E76A8[9];
extern char *D_800E7744[6];// = { D_800EFF20, D_800EFF28, D_800EFF30, D_800EFF38, D_800EFF40, " " };
extern char D_800EFE0C[9];// = "ーーーー"; // NOT hyphes, those are EUC-JP dashes
// The s/n/r/t characters here ARE NOT ASCII, they are EUC-JP characters
extern char D_800EFF20[5];// = "1 ｓ";
extern char D_800EFF28[5];// = "2 ｎ";
extern char D_800EFF30[5];// = "3 ｒ";
extern char D_800EFF38[5];// = "4 ｔ";
extern char D_800EFF40[5];// = "5 ｔ";
...
void func_800A54EC(void) {
    ...
    if (gIsGamePaused != 0) {
        ...
        sp40 = temp_t2;
        guOrtho(&gGfxPool->mtxPool[D_80164AF0] + 0xFAC0, 0.0f, 319.0f, 239.0f, 0.0f, -100.0f, 100.0f, 1.0f);
        temp_v1_2 = gDisplayListHead;
        gDisplayListHead = temp_v1_2 + 8;
        ...
        case TIME_TRIALS:
            ...
            break;
        case VERSUS:
            var_v1 = ((gScreenModeSelection << 5) + (gIsGamePaused * 8)) - 8 + D_800E8540;
            break;
        case GRAND_PRIX:
            var_v1 = ((gScreenModeSelection << 5) + (gIsGamePaused * 8)) - 8 + D_800E85C0;
            break;
        case BATTLE:
            var_v1 = ((gScreenModeSelection << 5) + (gIsGamePaused * 8)) - 8 + D_800E8600;
            break;
        }
        sp50 = var_v1->column - 8;
        sp52 = (var_v1->row + ((sp48->unk4 - D_800F0B50[temp_t2]) * 0xD)) - 8;
...
void func_800A5738(struct_8018D9E0_entry *arg0) {
    ...
    s8 **var_v0_8;
    s8 temp_v0_2;
    struct_8018EE10_entry *var_s2_2;

    temp_v1 = arg0->unk4;
    if (temp_v1 == 0) {
        if ((arg0->unk1C >= 0x1E) && (((s32) ((s32) gGlobalTimer / 16) % 2) != 0)) {
            gDisplayListHead = draw_box(gDisplayListHead, 0x000000C0, 0x00000021, (s32) ((f32) get_string_width(D_800E775C->unk14) * 0.8f) + 0xC6, 0x00000032, 0, 0, 0, 0x00000096);
            set_text_color(1);
            func_80093324(0x000000BF, 0x00000030, D_800E775C->unk14, 0, 0.8f, 0.8f);
        }
    } else {
        if (temp_v1 == 1) {
            var_s1 = arg0->unk1C;
            var_s2 = (s32) (var_s1 * 0xFF) / 140;
        } else {
            var_s1 = 0x0000008C;
            var_s2 = 0x000000FF;
        }
        temp_v0 = draw_box(gDisplayListHead, 0, 0, 0x0000013F, 0x000000EF, 0, 0, 0, var_s1);
        gDisplayListHead = temp_v0;
        gDisplayListHead = temp_v0 + 8;
        temp_v0->words.w1 = var_s2 & 0xFF;
        temp_v0->words.w0 = 0xFA000000;
        set_text_color(3);
        func_80093754(0x000000A0, 0x00000050, D_800E7574[*(gCupCourseOrder + ((gCupSelection * 8) + (gCupCourseSelection * 2)))], 0, 1.0f, 1.0f);
        temp_v1_2 = arg0->unk4;
        ...
        case 16:                                    /* switch 1 */
            set_text_color(2);
            func_80093754(0x0000009D, 0x00000060, D_800E7728->unk0, 0, 0.8f, 0.8f);
            ...
            func_80093754(0x0000009D, 0x0000007C, D_800E7728->unk4, 0, 0.8f, 0.8f);
            ...
            do {
                sp50 = var_v0;
                func_800921C0(arg0->unk4 - 0xB, var_s1_2, 1);
                func_80093358((s32) D_800E8538->column, D_800E8538->row + var_s0, var_v0->unk4, 0, 0.75f, 0.75f);
                var_s1_2 += 1;
                var_s0 += 0xD;
                var_v0 += 4;
            } while (var_s1_2 != 6);
        ...
        case 26:                                    /* switch 1 */
            set_text_color(3);
            var_v0_2 = D_800E798C[arg0->unk4 - 0x15];
            var_s0_2 = 0x0000006E;
            do {
                sp50 = var_v0_2;
                func_80093324(0x0000004D, var_s0_2, *var_v0_2, 0, 0.8f, 0.8f);
                var_s0_2 += 0xD;
                var_v0_2 += 4;
            } while (var_s0_2 != 0x000000C9);
            break;
        case 30:                                    /* switch 1 */
        case 31:                                    /* switch 1 */
            set_text_color(1);
            ...
            do {
                sp50 = var_v0_3;
                func_80093324(0x0000005A, arg0->row + var_s0_3 + 0x6E, *var_v0_3, 0, 0.8f, 0.8f);
                var_s0_3 += 0xD;
                var_v0_3 += 4;
            } while ((u32) var_v0_3 < (u32) &D_800E7A44);
            var_s2_2 = D_8018EE10;
            var_s1_3 = 0;
            var_s0_4 = 0x00000096;
            do {
                func_800921C0(arg0->unk4 - 0x1E, var_s1_3, 1);
                temp_a0_3 = var_s1_3 + 1;
                sp54 = temp_a0_3;
                convert_number_to_ascii(temp_a0_3, &sp5C);
                func_80093324(0x5A - arg0->column, var_s0_4, &sp5D, 0, 0.75f, 0.75f);
                if (var_s2_2->ghostDataSaved == 0) {
                    func_80093324(0x69 - arg0->column, var_s0_4, D_800E7A44, 0, 0.75f, 0.75f);
                } else {
                    temp_v0_2 = var_s2_2->courseIndex;
                    func_80093324(0x69 - arg0->column, var_s0_4, D_800E75C4[*(gCupCourseOrder + (((temp_v0_2 / 4) * 8) + ((temp_v0_2 % 4) * 2)))], 0, 0.75f, 0.75f);
                }
                var_s1_3 = sp54;
                var_s0_4 += 0x14;
                var_s2_2 += 0x80;
        ...
        case 32:                                    /* switch 1 */
            ...
            do {
                sp50 = var_v0_4;
                func_80093324(0x00000064, var_s0_5, *var_v0_4, 0, 0.8f, 0.8f);
                var_s0_5 += 0xD;
                var_v0_4 += 4;
            } while (var_v0_4 != D_800E7A54);
            break;
        case 35:                                    /* switch 1 */
        case 36:                                    /* switch 1 */
            set_text_color(3);
            ...
            do {
                sp50 = var_v0_5;
                func_80093324(0x00000055, arg0->row + var_s0_6 + 0x6E, *var_v0_5, 0, 0.8f, 0.8f);
                var_s0_6 += 0xD;
                var_v0_5 += 4;
            } while ((u32) var_v0_5 < (u32) D_800E7A6C);
            var_v0_6 = D_800E7A6C;
            var_s1_4 = 0;
            var_s0_7 = 0x0000009B;
            do {
                sp50 = var_v0_6;
                func_800921C0(arg0->unk4 - 0x23, var_s1_4, 1);
                func_80093324(0x7D - arg0->column, var_s0_7, *var_v0_6, 0, 0.8f, 0.8f);
                var_s1_4 += 1;
                var_s0_7 += 0xF;
                var_v0_6 += 4;
            } while (var_s1_4 != 2);
        ...
        case 40:                                    /* switch 1 */
            ...
            do {
                sp50 = var_v0_7;
                func_80093324(0x00000055, var_s0_8, *var_v0_7, 0, 0.8f, 0.8f);
                var_s0_8 += 0xD;
                var_v0_7 += 4;
            } while (var_v0_7 != D_800E7A80);
            break;
        case 41:                                    /* switch 1 */
            set_text_color(3);
            var_v0_8 = D_800E7A80;
            ...
            do {
                sp50 = var_v0_8;
                func_80093324(0x0000005D, var_s0_9, *var_v0_8, 0, 0.8f, 0.8f);
                var_s0_9 += 0xD;
                var_v0_8 += 4;
            } while (var_v0_8 != D_800E7A88);
            break;
        }
        switch (arg0->unk4) {                       /* switch 2 */
        case 11:                                    /* switch 2 */
        ...
        case 15:                                    /* switch 2 */
        case 16:                                    /* switch 2 */
            var_v0_9 = &D_800E73E0[arg0->unk4].unk-58;
block_42:
            sp98 = var_v0_9->unk0;
            sp9A = var_v0_9->unk2;
        ...
        case 30:                                    /* switch 2 */
        case 31:                                    /* switch 2 */
            var_v0_9 = &D_800E7410[arg0->unk4].unk-F0;
            goto block_42;
        case 35:                                    /* switch 2 */
        case 36:                                    /* switch 2 */
            var_v0_9 = &D_800E7420[arg0->unk4].unk-118;
            goto block_42;
        }
    }
}
...
void func_800A6154(struct_8018D9E0_entry *arg0) {
    ...
    if (arg0->unk4 == 0) {
        ...
        do {
            func_80093358(0x0000008C, var_s0, var_s2->unk4, 0, 1.0f, 1.0f);
            var_s0 += 0x14;
            var_s2 += 0xC;
        } while (var_s0 != 0x000000BE);
    } else {
        ...
        do {
            ...
            func_80093324(0x0000008C, var_s0_2, var_s2_2->unk4, 0, 1.0f, 1.0f);
            var_s1 += 1;
            var_s2_2 += 0xC;
            var_s0_2 += 0x14;
        } while (var_s1 != 2);
    ...
    if (temp_v0_2 > 0) {
        temp_v0_3 = func_80098FC8(gDisplayListHead, 0, 0, 0x0000013F, temp_v0_2);
        gDisplayListHead = temp_v0_3;
        gDisplayListHead = func_80098FC8(temp_v0_3, 0, 0xEF - arg0->unk20, 0x0000013F, 0x000000EF);
    }
}
#else
...
#ifdef MIPS_TO_C
//generated by m2c commit eefca95b040d7ee0c617bc58f9ac6cd1cf7bce87 on Sep-01-2023
? func_800A66A8(struct_8018D9E0_entry *, ? *);      /* extern */
...
void func_800A638C(struct_8018D9E0_entry *arg0) {
    ...
    if (arg0->unk4 == 0) {
        ...
        temp_v0->words.w0 = 0xFA000000;
        temp_v0->words.w1 = ((s32) (arg0->unk1C * 0xFF) / 100) & 0xFF;
        func_80093754(0x000000A0, arg0->row + 0x1E, D_800E7778[(s32) gModeSelection / 3], 0, 1.0f, 1.0f);
    } else {
        gDisplayListHead = draw_box(gDisplayListHead, 0, 0, 0x0000013F, 0x000000EF, 0, 0, 0, 0x00000064);
        set_text_color(5);
        draw_text(0x000000A0, arg0->row + 0x1E, D_800E7778[(s32) gModeSelection / 3], 0, 1.0f, 1.0f);
    }
    temp_a0 = arg0->unk4;
    ...
    temp_v0_2 = gDisplayListHead;
    gDisplayListHead = temp_v0_2 + 8;
    temp_v0_2->words.w1 = var_a1 & 0xFF;
    ...
    if (D_8018EDF3 != 2) {
        if (D_8018EDF3 != 3) {
            if (D_8018EDF3 != 4) {
                ...
                func_800A6CC0(arg0, var_a1);
            }
        } else {
            func_800A6BEC(arg0, var_a1);
        }
    } else {
        func_800A69C8((s32) arg0);
    }
    var_s0 = 0;
    var_s1 = 0x000000AE;
    if (arg0->unk4 >= 0xA) {
        var_s2 = D_800E775C;
        do {
            func_800921C0(arg0->unk4 - 0xA, var_s0, 1);
            func_80093324(0x00000069, var_s1, var_s2->unk4, 0, 0.8f, 0.8f);
            var_s0 += 1;
            var_s1 += 0xF;
            var_s2 += 4;
        } while (var_s0 != 4);
        func_800A66A8(arg0, &D_800E7360[arg0->unk4].unk-50);
    }
}
#else
...
#ifdef MIPS_TO_C
//generated by m2c commit eefca95b040d7ee0c617bc58f9ac6cd1cf7bce87 on Sep-01-2023
? func_800A6D94(s32, s32, u8 *);                    /* extern */
...
void func_800A9A98(void *arg0) {
    ...
    default:
        ...
        break;
    case 0xF:
        var_v0 = (s32) *(&D_800F0C9C + 3 + gMainMenuSelectionDepth);
        break;
    case 0x5D:
        ...
        if (func_800B4520() == 0) {
            ...
            if ((gControllerOne->buttonPressed | gControllerOne->stickPressed) & 0x400) {
                if (arg0->unk4 < 0xA) {
                    ...
                    if ((arg0->unk4 == 0x0000000A) && (D_80162DD4[0] != 0)) {
                        arg0->unk4 -= 2;
                    } else {
                        play_sound2(0x49008000);
                        if (arg0->unk24 < 4.2) {
...
#ifdef MIPS_TO_C
//generated by m2c commit eefca95b040d7ee0c617bc58f9ac6cd1cf7bce87 on Aug-28-2023
extern u32 D_8018CA78;
extern s8 D_8018ED90;
