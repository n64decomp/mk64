...
void func_8009F5E0(struct_8018D9E0_entry* arg0) {
    ...
    if ((s8) arg0->visible != 0) {
        ...
        switch (arg0->type) { /* switch 6; irregular */
            ...
            case 0x97: /* switch 6 */
                set_text_color(TEXT_BLUE_GREEN_RED_CYCLE_2);
                print_text_mode_1(arg0->column, arg0->row, gCourseNames[gCurrentCourseId], arg0->unk1C, arg0->unk24, 1.0f);
                break;
            case 0x98: /* switch 6 */
                func_800A2D1C(arg0);
                break;
        ...
        switch (arg0->state) { /* switch 1 */
            ...
            case 16:           /* switch 1 */
                ...
                for (var_s1 = 0; var_s1 < 6; var_s1++) {
                    ...
                    print_text_mode_2(D_800E8538[zero].column, D_800E8538[zero].row + (0xD * var_s1), gMenuText[var_s1 + 1],
                                  0, 0.75f, 0.75f);
                }
                break;
            case 21: /* switch 1 */
