...
void func_800AA2EC(struct_8018D9E0_entry *arg0) {
    ...
    case TIME_TRIALS_DATA_SELECTION_FROM_BACK_OUT:
        if ((arg0->unk4 == 0) && (temp_v0 = D_8018EDF3, (temp_v0 == 1)) && (*(&D_800E86AC - 1 + temp_v0) == 1)) {
            if (controller_pak_1_state != 0) {
                sp20 = 0;
                temp_v0_2 = osPfsFindFile(&gControllerPak1FileHandle, company_code, game_code, &game_name, &ext_code, &gControllerPak1FileNo);
                var_t1 = 0;
            ...
            if (var_t1 == 0) {
                if (controller_pak_ == 0) {
                    if (check_for_controller_pak(0) == 0) {
                        arg0->unk4 = 2;
                        return;
                    }
                    temp_v0_3 = osPfsInit(&gSIEventMesgQueue, &gControllerPak1FileHandle, 0);
                    if (temp_v0_3 != 0) {
                        if (temp_v0_3 != 1) {
                            if (temp_v0_3 != 4) {
...
block_22:
                    ...
                    controller_pak_1_state = 1;
                    if (osPfsFindFile(&gControllerPak1FileHandle, company_code, game_code, &game_name, &ext_code, &gControllerPak1FileNo) == 0) {
                        arg0->unk4 = 1;
                        return;
                    }
        ...
        if (func_800B4520() == 0) {
            ...
            if (var_a1_2 & 0x9000) {
                ...
                if (temp_v0_5 == 0x0000000A) {
                    ...
                    if (controller_pak_1_state != 0) {
                        sp28 = 0;
                        temp_v0_6 = osPfsFindFile(&gControllerPak1FileHandle, company_code, game_code, game_name, ext_code, &gControllerPak1FileNo);
                        var_v1 = 0;
