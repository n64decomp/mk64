...
void func_800AF4DC(struct_8018D9E0_entry *arg0) {
    ...
    case 1:
        ...
        arg0->unk24 = (bitwise s32) (f32) (((f64) arg0->unk1C * 0.05) + 1.0);
    ...
    case 2:
        ...
        arg0->unk24 = (bitwise s32) (f32) ((temp_f0 * 0.0085 * temp_f0) + 0.4);
        if ((temp_t6_2 >= 9) && ((f64) arg0->unk24 > 1.0)) {
            arg0->unk4 = 3;
            arg0->unk24 = 0x3F800000;
            return;
        }
        break;
    case 3:
...
void func_800AF740(struct_8018D9E0_entry *arg0) {
    ...
    case 0:
        ...
        arg0->column = (s32) temp_v1->startingColumn;
        sp20 = temp_v1;
        arg0->unk20 = (s32) ((f32) temp_v1->columnExtra - (((f32) get_string_width(D_802854B0[temp_v0]) * temp_v1->textScaling) / 2.0f));
        /* fallthrough */
    case 1:
        func_800A9208(arg0, arg0->unk20);
