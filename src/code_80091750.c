...
void func_80091EE4(void) {
    ...
    if ((D_8018EDFB != 0) && (tmp == 0)) {
        temp_s2 = (gCupSelection * 4) + gCupSelectedCourseIndex;
        func_800B6708();
...
#ifdef NON_MATCHING
// https://decomp.me/scratch/zyWcm
// I think I have the GIB macros right, but everything else is suspect
...
Gfx *func_80096CD8(Gfx *displayListHead, s32 arg1, s32 arg2, u32 width, u32 arg4) {
    ...
    if (arg1 < 0) {
        width -= arg1;
        arg1 = 0;
    } else if ((arg1 + width) > 0x140) {
        width = 0x140 - arg1;
    }
    if (arg2 < 0) {
        arg4 -= arg2;
        arg2 = 0;
    } else if ((arg2 + arg4) > 0xF0) {
        arg4 = 0xF0 - arg2;
    }
    if (width == 0) return displayListHead;
    else if (arg4 == 0) return displayListHead;
    else {
        temp_v0 = random_int(0x0064U);
        displayListHead = draw_box(displayListHead, arg1, arg2, arg1 + width, arg2 + arg4, 0, 0, 0, temp_v0);
        temp_v0 += 0x96;
        gDPPipeSync(displayListHead++);
        gDPSetRenderMode(displayListHead++, G_RM_XLU_SURF, G_RM_XLU_SURF2);
        gDPSetPrimColor(displayListHead++, 0, 0, temp_v0, temp_v0, temp_v0, temp_v0);
        gDPSetCombineMode(displayListHead++, G_CC_MODULATEIA_PRIM, G_CC_MODULATEIA_PRIM);
        for (var_fp = arg2; (u32)var_fp < (arg2 + arg4); var_fp += spCC) {
            var_t5 = spCC;
            temp_t6 = var_fp + spCC;
            if ((arg2 + arg4) < temp_t6) {
                var_t5 = (arg2 + arg4) - var_fp;
                if (var_t5 == 0) return displayListHead;
            }
            for (var_s1_3 = arg1; (u32)var_s1_3 < (arg1 + width); var_s1_3 += var_ra) {
                var_s4_2 = var_ra;
                temp_t2 = var_s1_3 + var_ra;
                if ((arg1 + width) < temp_t2) {
                    var_s4_2 = (arg1 + width) - var_s1_3;
                    if (var_s4_2 == 0) return displayListHead;
                }
                gDPLoadTextureTile(displayListHead++, (random_int(0x0080U) * 2) + &D_0B002A00, G_IM_FMT_IA, G_IM_SIZ_16b, width, 0,
                    var_s1_3, var_fp, var_s1_3 + var_s4_2, var_fp + var_t5, 0,
                    G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, masks, maskt, G_TX_NOLOD, G_TX_NOLOD);

                gSPTextureRectangle(displayListHead++, var_s1_3 * 4, var_fp * 4, (var_s1_3 + var_s4_2) * 4, (var_fp + var_t5) * 4, 0, var_s1_3 << 5, var_fp << 5, 1024, 1024);
...
Gfx *func_80097274(Gfx *arg0, s8 arg1, s32 arg2, s32 arg3, s32 arg4, s32 arg5, s32 arg6, s32 arg7, s32 arg8, u8 * arg9, s32 argA, u32 argB, u32 argC) {
    u32 sp108;
    s32 sp104;
    s32 sp100;
    s32 spFC;
...
func_8009CE64_label1:
        ...
        if (gDebugMenuSelection != 0x40) {
            ...
            case 2:                                 /* switch 3 */
                ...
                gCupSelectedCourseIndex = (s8) gPerCupIndexByCourseId[gCurrentCourseId];
                break;
            case 3:                                 /* switch 3 */
                switch (gMenuSelection) {
                case 11:
            ...
            gCupSelectedCourseIndex = gPerCupIndexByCourseId[gCurrentCourseId];
...
void add_8018D9E0_entry(s32 type, s32 column, s32 row, s8 priority) {
    ...
    case 0xBB:
        ...
        if ((var_ra->unk1C == 0) || (var_ra->unk20 != 0)) {
            func_800B559C((gCupSelection * 4) + gCupSelectedCourseIndex);
        }
        break;
    case 0xE6:
...
void func_800A2EB8(struct_8018D9E0_entry *arg0) {
    ...
    convert_number_to_ascii(gCupSelectedCourseIndex + 1, sp68);
...
void func_800A34A8(struct_8018D9E0_entry *arg0) {
    ...
    if (arg0->cursor != 0) {
        ...
        convert_number_to_ascii(gCupSelectedCourseIndex + 1, sp78);
...
void func_800A3C84(struct_8018D9E0_entry *arg0) {
    ...
    set_text_color(TEXT_BLUE_GREEN_RED_CYCLE_1);
    draw_text(arg0->column + 0x43, arg0->row + 0x19, gCourseNamesDup[gCupCourseOrder[gCupSelection][gCupSelectedCourseIndex]], 0, 0.6f, 0.6f);
    set_text_color(TEXT_YELLOW);
...
void func_800A3E60(struct_8018D9E0_entry *arg0) {
    ...
    set_text_color(4);
    draw_text(arg0->column + 0x55, 0x19 - arg0->row, gCourseNamesDup[gCupCourseOrder[gCupSelection][gCupSelectedCourseIndex]], 0, 0.6f, 0.6f);
    set_text_color(3);
...
void render_pause_menu_time_trials(struct_8018D9E0_entry *arg0) {
    ...
    set_text_color(TEXT_YELLOW);
    draw_text(0x000000A0, 0x00000050, gCourseNamesDup[gCupCourseOrder[gCupSelection][gCupSelectedCourseIndex]], 0, 1.0f, 1.0f);
    set_text_color(TEXT_RED);
...
void render_pause_grand_prix(struct_8018D9E0_entry *arg0) {
    ...
    set_text_color(TEXT_YELLOW);
    draw_text(160, temp_s3->row - 30, gCourseNamesDup[gCupCourseOrder[gCupSelection][gCupSelectedCourseIndex]], 0, 1.0f, 1.0f);
...
void func_800A5738(struct_8018D9E0_entry *arg0) {
    ...
    if (arg0->cursor == 0) {
        ...
        set_text_color(3);
        func_80093754(0x000000A0, 0x00000050, gCourseNamesDup[gCupCourseOrder[gCupSelection][gCupSelectedCourseIndex]], 0, 1.0f, 1.0f);
        switch (arg0->cursor) {                        /* switch 1 */
        case 1:                                     /* switch 1 */
        case 11:                                    /* switch 1 */
        case 12:                                    /* switch 1 */
...
void func_800A8A98(struct_8018D9E0_entry *arg0) {
    ...
    for (someIndex = 0; someIndex < NUM_COURSES_PER_CUP; someIndex++) {
        if ((someIndex == gCupSelectedCourseIndex) && (D_8018EDEC >= 2) && (gModeSelection != GRAND_PRIX)) {
...
void func_800A8F48(UNUSED struct_8018D9E0_entry *arg0) {
    ...
    case 2:
    default:
        if (func_800B639C((gCupSelection * 4) + gCupSelectedCourseIndex) >= 0) {
    ...
    default:
        if (D_8018EDEC != one) {
            ...
            for (var_a1 = 0; var_a1 < NUM_COURSES_PER_CUP; var_a1++) {
                if (gCupSelectedCourseIndex == var_a1) {
...
void func_800AC458(struct_8018D9E0_entry *arg0) {
    ...
    case 9:
        ...
        if (arg0->unk1C <= 0) {
            ...
            arg0->unk1C = 0;
            if (gCupSelectedCourseIndex == FOURTH_COURSE_IN_CUP) {
...
void func_800AD2E8(struct_8018D9E0_entry *arg0) {
            ...
            if (gControllerOne->buttonPressed & 0x9000) {
                if (arg0->cursor == 0x0000000A) {
                    ...
                    if (gControllerPak1State != 0) {
                        ...
                        case 0:                     /* switch 4 */
                            func_800B6708();
                            arg0->cursor = func_800B6348((gCupSelection * 4) + gCupSelectedCourseIndex) + 0x11;
                            var_v1 = 1;
    ...
    case 18:                                        /* switch 1 */
        ...
        if (func_800B639C((gCupSelection * 4) + gCupSelectedCourseIndex) != arg0->unk20) {
            if ((gControllerOne->buttonPressed | gControllerOne->stickPressed) & 0x800) {
                if (arg0->cursor >= 0x12) {
                    arg0->cursor--;
                    play_sound2(SOUND_MENU_CURSOR_MOVE);
                ...
                if (arg0->cursor == 0x00000010) {
                    ...
                    if (gControllerPak1State != 0) {
                        ...
                        case PFS_NO_ERROR:                     /* switch 3 */
                            func_800B6708();
                            arg0->cursor = func_800B6348((gCupSelection * 4) + gCupSelectedCourseIndex) + 0x1E;
                            var_v1 = 1;
                            break;
