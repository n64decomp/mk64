...
// Some sort of sorting algorithm, not really sure how it works
// arg0 is sorted based on the values in gCharacterGrandPrixPoints
// D_80164478 is referenced in tie break scenarios
...
extern ? gCharacterGrandPrixPoints;
extern void *gGrandPrixOverallStandings;
...
void *func_800AC458(void *arg0) {
    ...
    case 6:
        ...
        if (((temp_t3 % 3) == 0) || (D_8018D9D8 != 0)) {
            ...
            if (temp_t0 > 0) {
                *temp_a2_2 = temp_t0 - 1;
                temp_v1_2 = *(&gPlayers->characterId + (*(&D_80164360 + (temp_a1_2 * 2)) * 0xDD8)) + &gCharacterGrandPrixPoints;
                sp18 = 0;
                arg0 = temp_a3;
                *temp_v1_2 += 1;
                sp1C = temp_a1_2;
    ...
    case 9:
        ...
        if ((temp_a3->unk1C <= 0) && (temp_a3->unk4 = 0xA, temp_a3->unk1C = 0, phi_a1 = 0, phi_v0_2 = &gGrandPrixOverallStandings, (gCourseSelection == 3))) {
