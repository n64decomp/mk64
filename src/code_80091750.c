...
void func_8009969C(MkTexture *, s32, MkAnimation *); /* extern */
...
#ifdef MIPS_TO_C
//generated by m2c commit 6b6e1390bf30013247343623194964ff13d0c45b
? func_8009CE1C(s32 *, s32, s32, s32);              /* extern */
extern s32 D_800E86A4;
...
void func_8009CE64(s32 *arg0, s32 arg1, s32 arg2, s32 arg3) {
    s32 sp28;
    s8 *sp18;
    s16 temp_a0;
    s32 *var_a0;
        ...
        if (*temp_v0_2 == 2) {
            ...
            if (temp_v0_3 != NULL) {
                ...
                if (temp_v0_4 != NULL) {
                    ...
                    switch (temp_v1_3) {            /* switch 6; irregular */
                    case 11:                        /* switch 6 */
                        func_802903B0();
                        D_8016556E = 1;
                        return;
...
block_74:
            ...
            case 2:                                 /* switch 3 */
                ...
                case 1:                             /* switch 4 */
                    ...
                    var_a2 = 2;
                    gScreenModeSelection = (s32) SCREEN_MODE_2P_SPLITSCREEN_HORIZONTAL;
            ...
            case 4:                                 /* switch 3 */
                ...
                var_t7 = 0x0000000B;
                if (temp_v1_6 != (s32) OPTIONS_MENU) {
                    if (temp_v1_6 == MAIN_MENU) {
                        gMenuSelection = (s32) OPTIONS_MENU;
                    }
                } else {
                    goto block_74;
                }
            ...
            if (gMenuSelection >= 0xE) {
                ...
                func_8009CE1C(var_a0, 1, var_a2, var_a3);
            }
            D_8018EE0C = 0;
            return;
        }
        switch (gDebugGotoScene) {                        /* switch 5; irregular */
        case DEBUG_GOTO_ENDING_SEQUENCE:                                     /* switch 5 */
            gGamestateNext = (s32) 5;
            break;
        case DEBUG_GOTO_CREDITS_SEQUENCE_CC_50:                                     /* switch 5 */
        case DEBUG_GOTO_CREDITS_SEQUENCE_CC_EXTRA:                                     /* switch 5 */
            gGamestateNext = 9;
            gCreditsCourseId = COURSE_LUIGI_RACEWAY;
            break;
        default:                                    /* switch 5 */
            gGamestateNext = 4;
            if (gModeSelection == (s32) TIME_TRIALS) {
                D_8018EDFB = 1;
            }
        } else {
            gGamestateNext = (s32) 5;
        ...
        func_8000F124(1, 2);
        if ((gScreenModeSelection == SCREEN_MODE_3P_4P_SPLITSCREEN) && ((temp_v1_8 = gModeSelection, (temp_v1_8 == GRAND_PRIX)) || (temp_v1_8 == TIME_TRIALS))) {
            gModeSelection = VERSUS;
        }
        ...
        if ((temp_a0 != 0x000F) && (temp_a0 != 0x0010) && (temp_a0 != 0x0011) && (temp_a0 != 0x0013)) {
            ...
            if ((var_v0 == VERSUS) && (gPlayerCountSelection1 == 1)) {
                gModeSelection = GRAND_PRIX;
            }
        } else {
...
void func_8006EF60();                                  /* extern */
void func_800996BC(MkTexture *, ?, s8);                /* extern */
s32 func_8009A374(void *);                          /* extern */
s32 func_8009A478(void *, s32);                     /* extern */
void func_8009B0A4(?, ?);                              /* extern */
void func_8009B538(?, ?, u16, u16, s32);               /* extern */
u32 func_8009B8C4(u64 *);                           /* extern */
void func_8009B954(MkTexture *);                       /* extern */
void func_8009B998();                                  /* extern */
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 06ada559d7a32fdab49fa2d619cdfa027615bcda
void func_800A08D8(u8, s32, s32);                      /* extern */
...
#ifdef MIPS_TO_C
//generated by m2c commit 0927f17aac197848d4ebdf0c6bbad74b01f0851c
static ? D_800E7940;                                /* unable to generate initializer */
...
block_6:
    ...
    temp_s3 = arg0->unk4 - 2;
    set_text_color(3);
    var_s2 = (temp_s3 * 0x10) + &D_800E7940;
    var_s0 = 0x00000041;
    var_s1 = 0;
    do {
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 06ada559d7a32fdab49fa2d619cdfa027615bcda
void func_800A32B4(s32, s32, s8, s32);                 /* extern */
...
block_7:
    ...
    do {
        var_s1_2 = D_8018D9E0;
loop_113:
        temp_v0_6 = var_s1_2->type;
        var_v1_2 = 0;
        if ((temp_v0_6 == 4) || (temp_v0_6 == 5) || (temp_v0_6 == 0x000000C7)) {
            if (arg0 != 0) {
                goto block_119;
            }
        } else if (arg0 == 0) {
...
#ifdef MIPS_TO_C
//generated by m2c commit 6b6e1390bf30013247343623194964ff13d0c45b
static ? D_800E7208;                                /* unable to generate initializer */
...
void func_800A8A98(struct_8018D9E0_entry *arg0) {
    ...
    temp_v0_3->words.w1 = 0xFFFCF279;
    do {
        if ((var_s4 == gCupCourseSelection) && (temp_v0_4 = D_8018EDEC, ((temp_v0_4 < 2) == 0)) && (gModeSelection != GRAND_PRIX)) {
            if ((temp_v0_4 == 2) || (temp_v0_4 == 4)) {
                var_v0 = func_800959A0(gDisplayListHead, var_s0->unk0 + temp_s2, var_s0->unk2 + temp_s3, var_s0->unk8 + temp_s2, var_s0->unkA + temp_s3);
            } else {
                var_v0 = func_80098C18(gDisplayListHead, var_s0->unk0 + temp_s2, var_s0->unk2 + temp_s3, var_s0->unk8 + temp_s2, var_s0->unkA + temp_s3, 0x000000FF, 0x000000F9, 0x000000DC, 0x000000FF);
            }
        } else {
            var_v0 = func_80098C18(gDisplayListHead, var_s0->unk0 + temp_s2, var_s0->unk2 + temp_s3, var_s0->unk8 + temp_s2, var_s0->unkA + temp_s3, 1, 1, 1, 0x000000FF);
        }
        gDisplayListHead = var_v0;
        var_s4 += 1;
        var_s0 += 0x10;
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 06ada559d7a32fdab49fa2d619cdfa027615bcda
void func_800B536C(s32, s32, s32, struct_8018D9E0_entry *); /* extern */
void func_800CA330(?, s32);                            /* extern */
void play_sound2(?, s32, u8 *, struct_8018D9E0_entry *); /* extern */
extern void *D_800DC5EC;
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 06ada559d7a32fdab49fa2d619cdfa027615bcda
void func_8009DFE0(?, struct_8018D9E0_entry *);        /* extern */
void func_800CA330(?);                                 /* extern */
void play_sound2(?, struct_8018D9E0_entry *);          /* extern */
extern void *gControllerFive;
...
static u8 D_800F2E64;                                /* unable to generate initializer; const */
static u8 D_800F2E74;                                /* unable to generate initializer; const */
static s8 gGP1stPlaceReward = 9;                    /* const */
static s8 gGP2ndPlaceReward = 6;                    /* const */
static s8 gGP3rdPlaceReward = 3;                    /* const */
static s8 gGP4thPlaceReward = 1;                    /* const */
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 06ada559d7a32fdab49fa2d619cdfa027615bcda
void func_8009DFE0(?, struct_8018D9E0_entry *, void *, s32 *); /* extern */
void func_800C9F90(?);                                 /* extern */
void func_800CA330(?);                                 /* extern */
void func_8028DF38(?, struct_8018D9E0_entry *, void *, s32 *); /* extern */
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 06ada559d7a32fdab49fa2d619cdfa027615bcda
void func_8009DFE0(?);                                 /* extern */
s32 func_800B6178(s32);                             /* extern */
s32 func_800B6348(s32);                             /* extern */
s32 func_800B63F0(s32);                             /* extern */
void func_800B6708();                                  /* extern */
void func_800CA330(?);                                 /* extern */
void func_800CA388(?);                                 /* extern */
s32 osPfsFindFile(? *, u16, s32, ? *, ? *, ? *);    /* extern */
void play_sound2(?, s32);                              /* extern */
...
void func_800A91D8(s16, s16);                          /* extern */
