...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 06ada559d7a32fdab49fa2d619cdfa027615bcda
? guRotate(Mtx *, f32, f32, f32, f32);              /* extern */
? guScale(Mtx *, f32, f32, f32);                    /* extern */
...
void func_8009B954(MkTexture *arg0) {
    ...
    temp_v1->unk0 = segmented_to_virtual(arg0);
    temp_v1->unk4 = (s32) D_8018E75C;
}
#else
...
Gfx *func_8009B9D0(Gfx *arg0, MkTexture *arg1) {
    u32 sp34;
    s32 sp2C;
    ? *temp_s0;
    Gfx *temp_t0;
...
void func_800A32B4(s32 arg0, s32 arg1, s32 arg2, s32 arg3) {
    ...
    sp50 = gTimePlayerLastTouchedFinishLine[*(&D_80164360 + (arg3 * 2))];
    ...
    if (temp_v1 != 0) {
        ...
        do {
            ...
            if (phi_v0 == 0) {
                ...
                if (temp_v1_2 < 9) {
                    phi_v0_2 = (s32) *(&D_80164360 + (phi_s1 * 2));
                    phi_v1 = 0;
                } else {
        ...
        do {
            ...
            if (phi_v0_3 == 0) {
                if (temp_v1_3 < 9) {
                    phi_v0_4 = (s32) *(&D_80164360 + (phi_s1_2 * 2));
                } else {
...
? guRotate(Mtx *, f32, f32, f32, f32);              /* extern */
? guScale(f32, f32, Mtx *, f32, f32, f32);          /* extern */
? guTranslate(Mtx *, f32, f32, f32);                /* extern */
extern ? D_0D003090;
...
void func_800A66A8(struct_8018D9E0_entry *arg0, f32 *arg1) {
    ...
    guScale(temp_f12, temp_f14, temp_s1, 1.2f, 1.2f, 1.2f);
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 06ada559d7a32fdab49fa2d619cdfa027615bcda
static s8 *D_800E7A34[2] = { "RACE DATA CANNOT ", "BE SAVED FOR GHOST" }; /* const */
...
void func_800A70E8(struct_8018D9E0_entry *arg0) {
    ...
    if (arg0->unk4 == 1) {
        temp_s0 = (s32) ((f32) get_string_width(D_800E7A34->unk0) * 0.45f);
        ...
        temp_a1 = 0x180 - (((s32) arg0->unk1C % 32) * 8);
        phi_a1 = temp_a1;
        if (temp_a1 >= 0x100) {
            phi_a1 = 0xFF;
        }
        temp_v0 = gDisplayListHead;
        gDisplayListHead = temp_v0 + 8;
        temp_v0->words.w1 = phi_a1 & 0xFF;
        temp_v0->words.w0 = 0xFA000000;
        set_text_color(2);
        phi_s0_2 = 0x2C;
        phi_s1 = D_800E7A34;
        do {
            func_80093358(0xC0, phi_s0_2, *phi_s1, 0, 0.45f, 0.45f);
    ...
    if (gModeSelection != 0) {
        ...
        if ((phi_v0 != 0) && (phi_v0 != phi_a0)) {
            ...
            do {
                ...
                if ((phi_a1_2 + 1) == ((s32) arg0->unk1C % 4)) {
...
void func_800AC458(struct_8018D9E0_entry *arg0) {
    ...
    case 6:
        ...
        if (((temp_t3 % 3) == 0) || (D_8018D9D8 != 0)) {
            ...
            if ((s32) temp_t0 > 0) {
                *temp_a2_2 = temp_t0 - 1;
                temp_v1_2 = &gGPPointsByCharacterId[*(&gPlayers->characterId + (*(&D_80164360 + (temp_a1_2 * 2)) * 0xDD8))];
                sp18 = 0;
                arg0 = temp_a3;
                *temp_v1_2 += 1;
                sp1C = temp_a1_2;
...
void func_800AF740(struct_8018D9E0_entry *arg0) {
    ...
    case 0:
        ...
        arg0->column = (s32) temp_v1->startingColumn;
        sp20 = temp_v1;
        arg0->unk20 = (s32) ((f32) temp_v1->columnExtra - (((f32) get_string_width(*(&D_802854B0 + (temp_v0 * 4))) * temp_v1->textScaling) / 2.0f));
        /* fallthrough */
    case 1:
        func_800A9208(arg0, arg0->unk20);
        temp_t6 = (s32) (arg0->column - arg0->unk20) / 4;
        arg0->unk1C = temp_t6;
        if (temp_t6 >= 9) {
            arg0->unk1C = 8;
        }
