...
void dma_copy_base_729a30(s32 arg0, u32 arg1, void *arg2) {
    ...
    osPiStartDma(&sp30, 0, 0, (arg0 & 0xFFFFFF) + &_textures_0aSegmentRomStart, arg2, arg1, &D_8014EF58);
    osRecvMesg(&D_8014EF58, &sp2C, 1);
}
#else
...
void dma_copy_base_7fa3c0(s32 arg0, u32 arg1, void *arg2) {
    ...
    osInvalDCache(arg2, arg1);
    osPiStartDma(&sp30, 0, 0, (arg0 & 0xFFFFFF) + &_textures_0bSegmentRomStart, arg2, arg1, &D_8014EF58);
    osRecvMesg(&D_8014EF58, &sp2C, 1);
}
#else
...
void func_80099AEC(void) {
    ...
    if (temp_s2 != 0) {
        ...
        osPiStartDma(&sp6C, 0, 0, &_textures_0aSegmentRomStart + (temp_s2->unk4 & 0xFFFFFF), D_8018D9B4, phi_s0_2, &D_8014EF58);
        osRecvMesg(&D_8014EF58, &sp68, 1);
loop_9:
        temp_v0 = phi_s1->unk8;
        phi_s5 = phi_s5_3;
        if (temp_v0 == 0) {
            ...
            osPiStartDma(&sp6C, 0, 0, sp58 + (temp_v0->unk4 & 0xFFFFFF), temp_t7 + D_8018D9B4, phi_s0_4, &D_8014EF58);
        }
        ...
        if (phi_s5 == 0) {
            ...
            if (temp_v0_2 == 0) {
                ...
                osPiStartDma(&sp6C, 0, 0, sp58 + (temp_v0_2->unk4 & 0xFFFFFF), D_8018D9B4, phi_s0_6, &D_8014EF58);
            }
...
void func_80099EC4(void) {
    ...
    if (temp_s2 != 0) {
        ...
        osInvalDCache(D_8018D9B4, phi_s0_2);
        osPiStartDma(&sp68, 0, 0, &_textures_0aSegmentRomStart + (temp_s2->unk4 & 0xFFFFFF), D_8018D9B4, phi_s0_2, &D_8014EF58);
        osRecvMesg(&D_8014EF58, &sp64, 1);
loop_6:
        temp_v0 = phi_s1->unk8;
        phi_s4 = phi_s4_3;
        if (temp_v0 == 0) {
            ...
            osPiStartDma(&sp68, 0, 0, &_textures_0aSegmentRomStart + (temp_v0->unk4 & 0xFFFFFF), D_8018D9B4 + 0x1400, phi_s0_4, &D_8014EF58);
        }
        ...
        if (phi_s4 == 0) {
            ...
            if (temp_v0_3 == 0) {
                ...
                osInvalDCache(D_8018D9B4, phi_s0_6);
                osPiStartDma(&sp68, 0, 0, &_textures_0aSegmentRomStart + (temp_v0_3->unk4 & 0xFFFFFF), D_8018D9B4, phi_s0_6, &D_8014EF58);
            }
