...
void func_800A3C84(struct_8018D9E0_entry* arg0) {
    ...
    draw_text(arg0->column + 0x43, arg0->row + 0x19,
              gCourseNamesDup[gCupCourseOrder[gCupSelection][gCupSelectedCourseIndex]], 0, 0.6f, 0.6f);
    set_text_color(TEXT_YELLOW);
...
void render_pause_menu_time_trials(struct_8018D9E0_entry* arg0) {
    ...
    set_text_color(TEXT_YELLOW);
    draw_text(0x000000A0, 0x00000050, gCourseNamesDup[gCupCourseOrder[gCupSelection][gCupSelectedCourseIndex]], 0, 1.0f,
              1.0f);
    set_text_color(TEXT_RED);
...
void render_pause_grand_prix(struct_8018D9E0_entry* arg0) {
    ...
    set_text_color(TEXT_YELLOW);
    draw_text(160, temp_s3->row - 30, gCourseNamesDup[gCupCourseOrder[gCupSelection][gCupSelectedCourseIndex]], 0, 1.0f,
              1.0f);
...
void func_800A5738(struct_8018D9E0_entry* arg0) {
    ...
    if (arg0->cursor == 0) {
        ...
        set_text_color(3);
        func_80093754(0x000000A0, 0x00000050, gCourseNamesDup[gCupCourseOrder[gCupSelection][gCupSelectedCourseIndex]],
                      0, 1.0f, 1.0f);
        switch (arg0->cursor) { /* switch 1 */
            case 1:             /* switch 1 */
            case 11:            /* switch 1 */
