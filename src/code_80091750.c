...
void func_800942D0(void) {
    ...
    s32 var_s2;
    s32 thing;
    test = &gGfxPool->mtxPool[0x32B];
    gSPMatrix(gDisplayListHead++, &gGfxPool->mtxPool[0], G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_PROJECTION);
    gSPMatrix(gDisplayListHead++, &gGfxPool->mtxPool[7], G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
...
void func_800AA2EC(struct_8018D9E0_entry *arg0) {
    ...
    case TIME_TRIALS_DATA_SELECTION_FROM_BACK_OUT:
        if ((arg0->unk4 == 0) && (D_8018EDF3 == 1) && ((D_800E86AC - 1)[D_8018EDF3] == 1)) {
            if (gControllerPak1State != 0) {
                sp20 = 0;
                temp_v0 = osPfsFindFile(&gControllerPak1FileHandle, gCompanyCode, gGameCode, gGameName, gExtCode, &gControllerPak1FileNote);
                var_t1 = 0;
            ...
            if (var_t1 == 0) {
                if (gControllerPak1State == 0) {
                    ...
                    temp_v0_2 = osPfsInit(&gSIEventMesgQueue, &gControllerPak1FileHandle, 0);
                    if (temp_v0_2 != 0) {
                        if (temp_v0_2 != 1) {
                            if (temp_v0_2 != 4) {
...
void func_800AC458(void *arg0) {
    ...
    case 9:
        ...
        arg0->unk1C = temp_t7;
        if (D_8018D9D8 != 0) {
            arg0->unk1C = (s32) (temp_t7 - 5);
        }
        if (arg0->unk1C <= 0) {
            arg0->unk4 = 0x0000000AU;
            arg0->unk1C = 0;
            var_a1 = 0;
...
loop_41:
    ...
    case 12:
        ...
        arg0->unk10 = temp_a1_3;
        if (temp_a1_3 < 0xF0) {
            arg0->unk20 = (s32) (temp_a1_3 + 0x10);
            D_800DC5EC->screenStartY += 0x10;
            D_800DC5F0->screenStartY -= 0x10;
            return;
        }
        arg0->unk20 = 0;
        arg0->unk4 = 0x0000000DU;
        arg0->unk1C = 0;
        ...
        if (func_800B4520() == 0) {
            ...
            if (var_a1_2 & 0x9000) {
                ...
                if (temp_v0_5 == 0x0000000A) {
                    ...
                    if (gControllerPak1State != 0) {
                        sp28 = 0;
                        temp_v0_6 = osPfsFindFile(&gControllerPak1FileHandle, gCompanyCode, gGameCode, gGameName, gExtCode, &gControllerPak1FileNote);
                        var_v1 = 0;
        ...
        if (func_800B4520() == 0) {
            ...
            if (var_a0 & 0x9000) {
                if (arg0->unk4 == 0x00000010) {
                    ...
                    if (gControllerPak1State != 0) {
                        sp28 = 0;
                        temp_v0_2 = osPfsFindFile(&gControllerPak1FileHandle, gCompanyCode, gGameCode, gGameName, gExtCode, &gControllerPak1FileNote);
                        var_v1 = 0;
