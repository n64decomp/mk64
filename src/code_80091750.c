...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
void swap_values(s32 *, s32 *); // extern
extern ? D_02008030;
extern ? D_02008058;
...
void *func_80098C18(void *arg0, s32 arg1, s32 arg2, s32 arg3, s32 arg4, s32 arg5, s32 arg6, u32 arg7, s32 arg8) {
    ...
    arg8 &= 0xFF;
    if (arg3 < arg1) {
        swap_values(&arg1, &arg3);
    }
    if (arg4 < arg2) {
        swap_values(&arg2, &arg4);
    }
    ...
    if (arg0->unk15 != 0) {
        ...
        if (temp_t0 >= 0x10F) {
            ...
            case 0xD4:                              /* switch 3 */
                ...
                return;
            case 0xD5:                              /* switch 3 */
            // Setting the text color of the text on the controller pak menu
...
void func_800A0DFC(void) {
    ...
    phi_s0 = gControllerPakPagesFree;
    phi_s1 = 0x110;
    do {
        temp_lo = phi_s0 / 0xA;
