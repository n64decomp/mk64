...
//GLOBAL_ASM("asm/non_matchings/memory/func_802A8348.s")
...
s32 func_802A84F4(s32 arg0, u32 arg1, s32 arg2) {
    u8 *temp_v0;
    u32 temp_a0;
...
u32 MIO0_0F(s32 arg0, u32 arg1, s32 arg2) {
    u32 oldHeapEndPtr;
    u8 *temp_v0;
    u32 temp_a0;
    unsigned long new_var;
...
void func_802A87A8(u32 arg0, s32 arg1) {
    u8 *sp18;
    u8 *temp_v0;

    temp_v0 = gPrevLoadedAddress;
    gPrevLoadedAddress = temp_v0 + (((arg1 * 0x18) + 0xF) & ~0xF);
    sp18 = temp_v0;
    mio0decode(*(&gSegmentTable + ((arg0 >> 0x18) * 4)) + (arg0 & 0xFFFFFF) + 0x80000000, temp_v0);
    func_802A86A8(sp18, arg1);
