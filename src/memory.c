...
void func_802A7C08(void) {
    ...
    do {
        ...
        temp_v1->unk0 = ((phi_a0 & 0xFFFF) << 8) | 0xBC000000 | 6;
        temp_v1->unk4 = phi_a1->unk0;
        temp_v1_2 = gDisplayListHead;
        gDisplayListHead = temp_v1_2 + 8;
        temp_v1_2->unk0 = ((phi_a2 & 0xFFFF) << 8) | 0xBC000000 | 6;
        temp_v1_2->unk4 = phi_a1->unk4;
        temp_v1_3 = gDisplayListHead;
        gDisplayListHead = temp_v1_3 + 8;
        temp_v1_3->unk0 = ((phi_a3 & 0xFFFF) << 8) | 0xBC000000 | 6;
        temp_v1_3->unk4 = phi_a1->unk8;
        temp_v1_4 = gDisplayListHead;
        gDisplayListHead = temp_v1_4 + 8;
        temp_v1_4->unk0 = ((phi_t0 & 0xFFFF) << 8) | 0xBC000000 | 6;
        temp_t0 = phi_t0 + 0x10;
        temp_v1_4->unk4 = phi_a1->unkC;
        phi_a0 += 0x10;
        phi_a1 += 0x10;
        phi_a2 += 0x10;
        phi_a3 += 0x10;
...
#else
GLOBAL_ASM("asm/non_matchings/memory/func_802A7C08.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
extern s32 D_8015F724;
extern s32 gPrevLoadedAddress;

void func_802A7CF0(s32 arg0, s32 arg1) {
    s32 temp_a0;

    temp_a0 = (arg0 + 0xF) & ~0xF;
    D_8015F724 = ((arg1 & ~0xF) - temp_a0) - 0x10;
    gPrevLoadedAddress = temp_a0;
}
#else
GLOBAL_ASM("asm/non_matchings/memory/func_802A7CF0.s")
#endif
...
void func_802A7D1C(s32 arg0) {
    s32 temp_t6;

    temp_t6 = (arg0 + 0xF) & ~0xF;
    D_8015F724 = D_8015F724 - temp_t6;
    gPrevLoadedAddress = gPrevLoadedAddress + temp_t6;
}
#else
GLOBAL_ASM("asm/non_matchings/memory/func_802A7D1C.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
? dma_copy(s32, s32, s32); // extern
s32 func_802A7D1C(s32, s32); // extern
...
s32 func_802A7D70(s32 arg0, s32 arg1) {
    ...
    temp_a2 = arg1 - arg0;
    sp1C = temp_a2;
    temp_v0 = func_802A7D1C(temp_a2, temp_a2);
    phi_a0 = temp_v0;
    if (temp_v0 != 0) {
        sp24 = temp_v0;
...
#else
GLOBAL_ASM("asm/non_matchings/memory/func_802A7D70.s")
#endif
...
void *func_802A7E14(s32 arg0, s32 arg1) {
    ? *temp_a1;
    ? *temp_a1_2;
    ? *temp_v0_2;
    ? *temp_v0_3;
    ...
    temp_v0 = D_802BA278;
    temp_a0 = ((arg0 + 0xF) & ~0xF) + 8;
    phi_v1 = NULL;
    if (temp_v0 >= temp_a0) {
        D_802BA278 = temp_v0 - temp_a0;
        if (arg1 == 0) {
            temp_a1 = D_802BA27C;
            temp_v0_2 = temp_a1 + temp_a0;
            temp_a1->unk4 = temp_v0_2;
            *temp_v0_2 = D_802BA27C;
            temp_v1 = D_802BA27C;
            D_802BA27C = temp_v0_2;
            return temp_v1 + 8;
        }
        temp_a1_2 = D_802BA280;
        temp_v0_3 = temp_a1_2 - temp_a0;
        *temp_a1_2 = temp_v0_3;
        temp_v0_3->unk4 = D_802BA280;
        D_802BA280 = temp_v0_3;
        phi_v1 = temp_v0_3 + 8;
...
#else
GLOBAL_ASM("asm/non_matchings/memory/func_802A7E14.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
extern s32 D_802BA278;
extern u32 D_802BA27C;
extern s32 *D_802BA280;

s32 func_802A7EA4(s32 arg0) {
    ? *temp_a0_2;
    s32 *temp_a0;
    u32 temp_v0;
    s32 *phi_a0;
    ...
    if (temp_v0 < D_802BA27C) {
        ...
        D_802BA27C = temp_v0;
        D_802BA27C->unk4 = 0;
        D_802BA278 = (D_802BA278 + phi_v1) - D_802BA27C;
    } else {
        if (temp_v0->unk0 != 0) {
            phi_a0_2 = temp_v0->unk0;
            do {
                temp_a0_2 = *phi_a0_2;
                phi_a0_2 = temp_a0_2;
                phi_v1_2 = phi_a0_2;
        ...
        D_802BA280 = temp_v0->unk4;
        *D_802BA280 = 0;
        D_802BA278 = (D_802BA278 + D_802BA280) - phi_v1_2;
    }
    return D_802BA278;
}
#else
GLOBAL_ASM("asm/non_matchings/memory/func_802A7EA4.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
void *func_802A7E14(u32, ?); // extern
extern OSMesgQueue D_8014EF58;
extern void *D_8014F098;
extern OSIoMesg D_8014F0A0;

void *func_802A80B0(u32 arg0, s32 arg1, ? arg2) {
    void *sp34;
    u32 sp2C;
    u32 temp_a0;
    void *temp_v0;
    ...
    temp_a0 = arg1 - arg0;
    sp2C = temp_a0;
    temp_v0 = func_802A7E14(temp_a0, arg2);
    sp34 = temp_v0;
    if (temp_v0 != 0) {
        osInvalDCache(temp_v0, sp2C);
        osPiStartDma(&D_8014F0A0, 0, 0, arg0, sp34, sp2C, &D_8014EF58);
        osRecvMesg(&D_8014EF58, &D_8014F098, 1);
    }
    return sp34;
}
#else
GLOBAL_ASM("asm/non_matchings/memory/func_802A80B0.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
s32 func_802A80B0(s32, s32, ?); // extern
extern ? D_802B8CD4;

s32 func_802A8190(s32 arg0, ? arg1) {
    s32 sp24;
    s32 sp18;
    s32 temp_v0_2;
    void *temp_v0;
    ...
    temp_v0 = (arg0 * 0x10) + &D_802B8CD4;
    sp18 = temp_v0->unk2;
    temp_v0_2 = func_802A80B0(temp_v0->unk4, temp_v0->unk8, arg1);
    phi_a1 = temp_v0_2;
    if (temp_v0_2 != 0) {
        sp24 = temp_v0_2;
        set_segment_base_addr(sp18, temp_v0_2);
        phi_a1 = sp24;
    }
    return phi_a1;
}
#else
GLOBAL_ASM("asm/non_matchings/memory/func_802A8190.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
? dma_copy(s32, s32, s32, s32); // extern
extern s32 gPrevLoadedAddress;
...
s32 func_802A82E4(s32 arg0, s32 arg1) {
    ...
    temp_a0 = gPrevLoadedAddress;
    temp_t6 = ((arg1 - arg0) + 0xF) & ~0xF;
    sp1C = temp_t6;
    sp24 = temp_a0;
    dma_copy(temp_a0, arg0, temp_t6, arg1);
    gPrevLoadedAddress = gPrevLoadedAddress + sp1C;
    return sp24;
}
#else
GLOBAL_ASM("asm/non_matchings/memory/func_802A82E4.s")
#endif
...
u8 *func_802A84F4(s32 arg0, u32 arg1, s32 arg2) {
    u8 *sp2C;
    void *sp28;
    u32 temp_a1;
    u8 *temp_v0;
    ...
    osPiStartDma(&D_8014F0A0, 0, 0, (arg0 & 0xFFFFFF) + &_other_texturesSegmentRomStart, sp28, arg1, &D_8014EF58);
    osRecvMesg(&D_8014EF58, &D_8014F098, 1);
    mio0decode(temp_a0, sp2C);
    gPrevLoadedAddress = &gPrevLoadedAddress[arg2];
    return temp_v0;
}
#else
GLOBAL_ASM("asm/non_matchings/memory/func_802A84F4.s")
#endif
...
void *MIO0_0F(s32 arg0, u32 arg1, s32 arg2) {
    void *sp2C;
    void *sp28;
    u32 temp_a1;
    void *temp_a0;
...
#else
GLOBAL_ASM("asm/non_matchings/memory/MIO0_0F.s")
#endif
...
void func_802A86A8(void *arg0, u32 arg1) {
    s8 temp_a0;
    s8 temp_a3;
    u32 temp_a2;
    void *temp_v0;
    ...
    if (arg1 != 0) {
        ...
        do {
            ...
            temp_v0 = phi_v0 + 0xE;
            temp_v1_2->unk-E = phi_v0->unk2 * D_800DC608;
            temp_a0 = temp_v0->unk-4;
            temp_a3 = temp_v0->unk-3;
            temp_v1_2->unk-C = temp_v0->unk-A;
            temp_v1_2->unk-8 = temp_v0->unk-8;
            temp_v1_2->unk-4 = temp_a0 & 0xFC;
            temp_v1_2->unk-3 = temp_a3 & 0xFC;
            temp_v1_2->unk-6 = temp_v0->unk-6;
            temp_v1_2->unk-2 = temp_v0->unk-2;
            temp_v1_2->unk-A = (temp_a0 & 3) | ((temp_a3 * 4) & 0xC);
