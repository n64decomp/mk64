...
extern Vtx itemBoxQuestionMarkVertex[];
...
extern Vtx gBananaVertex[];
extern Vtx gFlatBananaVertices[];
extern s8  gBananaTexture[];
extern s8  gFlatBananaTexture[];
