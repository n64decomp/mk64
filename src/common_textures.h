...
extern s8  gTextureParticleFire[];
...
extern s32 unkPad;
extern s8 gTextureSpeedometer[];
extern s8 gTextureSpeedometerNeedle[];
extern s8 gTextureHUDLap[];
extern u8 gTextureHUD123[];
extern s8 gTextureHUDLapTime[];
extern s8 gTextureHUDLap1On3[];
extern s8 gTextureHUDLap2On3[];
extern s8 gTextureHUDLap3On3[];
extern s8 gTextureHUDTotalTime[];
extern s8 gTextureHUDTime[];
extern u8 gTextureHUDNormalDigit[];
extern u8 gTextureHUDPlace[][4096];
...
extern u8 gTLUTPlayerEmblem[];
extern s16 tlutPad[];
extern u8 gTexturePlayerEmblem[][2048];
...
extern u8 gTextureParticleLeaf[];
