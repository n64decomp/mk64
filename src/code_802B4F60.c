...
GLOBAL_ASM("asm/non_matchings/code_802B4F60/code_802B4F60.s")
...
u32 func_802B5224(sm64_Vec3f arg0, sm64_Vec3f arg1) {
    f32 temp_v1;
    f32 temp_v2;
...
u32 func_802B5258(sm64_Vec3f arg0, Vec3s arg1) {
    f32 temp_v1;
    f32 temp_v2;
    temp_v1 = arg1[0] - arg0[0];
    temp_v2 = arg1[2] - arg0[2];
...
void *vec3f_copy(sm64_Vec3f dest, sm64_Vec3f src) {
    dest[0] = src[0];
    dest[1] = src[1];
    dest[2] = src[2];
...
void *func_802B5320(sm64_Vec3f dest, f32 x, f32 y, f32 z) {
    dest[0] = x;
    dest[1] = y;
    dest[2] = z;
    return &dest;
...
*/
GLOBAL_ASM("asm/non_matchings/code_802B4F60/func_802B5350.s")
/*
...
*/
GLOBAL_ASM("asm/non_matchings/code_802B4F60/func_802B5398.s")
/*
...
GLOBAL_ASM("asm/non_matchings/code_802B4F60/code_cont.s")