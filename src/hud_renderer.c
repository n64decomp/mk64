...
void func_8004E78C(s32 playerId) {
    func_8004CB60((s32) hudPlayers[playerId].lapX, hudPlayers[playerId].lapY + 3, (s32) D_0D00A958);
    func_8004CB90(hudPlayers[playerId].lapX + 0x1C, (s32) hudPlayers[playerId].lapY, D_800E4570[hudPlayers[playerId].alsoLapCount]);
}

void func_8004E800(s32 playerId) {
    if (hudPlayers[playerId].unk_81 != 0) {
        if (hudPlayers[playerId].lapCount != 3) {
            func_8004A384(hudPlayers[playerId].rankX + hudPlayers[playerId].slideRankX, hudPlayers[playerId].rankY + hudPlayers[playerId].slideRankY, 0U,
                hudPlayers[playerId].rankScaling, 0x000000FF, D_800E55F8[D_8018CF98[playerId]], 0, 0x000000FF, D_0D00D258[D_8018CF98[playerId]],
                D_0D0068F0, 0x00000080, 0x00000040, 0x00000080, 0x00000040);
        } else {
            func_8004A384(hudPlayers[playerId].rankX + hudPlayers[playerId].slideRankX, hudPlayers[playerId].rankY + hudPlayers[playerId].slideRankY, 0U,
                hudPlayers[playerId].rankScaling, 0x000000FF, D_800E55F8[D_80165594], 0, 0x000000FF, D_0D00D258[gGPCurrentRaceRankByPlayerId[playerId]],
                D_0D0068F0, 0x00000080, 0x00000040, 0x00000080, 0x00000040);
        }
    }
}
...
void func_8004E998(s32 playerId) {
    if (hudPlayers[playerId].unk_81 != 0) {
        if (hudPlayers[playerId].lapCount != 3) {
            func_8004A384(hudPlayers[playerId].rankX + hudPlayers[playerId].slideRankX, hudPlayers[playerId].rankY + hudPlayers[playerId].slideRankY, 0U,
                hudPlayers[playerId].rankScaling, 0x000000FF, D_800E5618[gGPCurrentRaceRankByPlayerId[playerId]], 0, 0x000000FF, D_0D015258[gGPCurrentRaceRankByPlayerId[playerId]],
                D_0D006030, 0x00000040, 0x00000040, 0x00000040, 0x00000040);
        } else {
            func_8004A384(hudPlayers[playerId].rankX + hudPlayers[playerId].slideRankX, hudPlayers[playerId].rankY + hudPlayers[playerId].slideRankY, 0U,
                hudPlayers[playerId].rankScaling, 0x000000FF, D_800E5618[D_80165598], 0, 0x000000FF, D_0D015258[gGPCurrentRaceRankByPlayerId[playerId]],
                D_0D006030, 0x00000040, 0x00000040, 0x00000040, 0x00000040);
        }
    }
}
...
void func_8004ED40(s32 arg0) {
    func_8004A2F4(hudPlayers[arg0].speedometerX, hudPlayers[arg0].speedometerY, 0U, 1.0f, D_8018D300, D_8018D308, D_8018D310, 0xFF, (u8* ) D_0D009958, D_0D0064B0, 0x40, 0x60, 0x40, 0x30);
...
void func_8004F168(s32 arg0, s32 arg1, s32 arg2) {
    ...
    if (temp_v1->type & 0x8000) {
        temp_a0 = ((D_8018D2C0[arg0] + D_8018D2F0) - ((s16) D_8018D2B0 / 2)) + D_8018D2E0 + (s16) (s32) (temp_v1->pos[0] * D_8018D2A0);
        temp_a1 = ((D_8018D2D8[arg0] + D_8018D2F8) - ((s16) D_8018D2B8 / 2)) + D_8018D2E8 + (s32) (temp_v1->pos[2] * D_8018D2A0);
        if (arg2 != 8) {
            if ((gGPCurrentRaceRankByPlayerId[arg1] == 0) && (gModeSelection != 3) && (gModeSelection != 1)) {
                func_80046424((s32) temp_a0, (s32) temp_a1, (temp_v1->unk_02C[1] + 0x8000) & 0xFFFF, 1.0f, (u8 *) gMiniMapKartTextures[arg2], D_0D005470, 8, 8, 8, 8);
                return;
            }
            func_800463B0((s32) temp_a0, (s32) temp_a1, (temp_v1->unk_02C[1] + 0x8000) & 0xFFFF, 1.0f, (u8 *) gMiniMapKartTextures[arg2], D_0D005470, 8, 8, 8, 8);
            return;
        }
        if (gGPCurrentRaceRankByPlayerId[arg1] == 0) {
            func_8004C450((s32) temp_a0, (s32) temp_a1, 8U, 8U, (u8 *) gTextureMiniMapProgressDot);
            return;
        }
        func_8004C364((s32) temp_a0, (s32) temp_a1, 8U, 8U, (u8 *) gTextureMiniMapProgressDot);
    }
}
#else
    ...
    case 0:
        for (var_s1 = D_8018D158 - 1; var_s1 >= 0; var_s1--) {
            ...
            if ((gPlayerOne + temp_a1)->type & 0x1000) {
                func_8004F168(arg0, temp_a1, 8);
            }
        }
        for (var_s1 = D_8018D158 - 1; var_s1 >= 0; var_s1--) {
            temp_a1 = gGPCurrentRacePlayerIdByRank[var_s1];
            if (((gPlayerOne + temp_a1)->type & 0x1000) != 0x1000) {
...
#ifdef MIPS_TO_C
//generated by m2c commit beb457dabfc7a01ec6540a5404a6a05097a13602 on Dec-19-2023
    ...
    if ((gModeSelection != 2) && (gModeSelection != 3)) {
        ...
        if (D_8018D320 == temp_s4->lapCount) {
            ...
            if (D_8015F890 == 0) {
                ...
                do {
                    if (*var_s3 == 0) {
                        print_timer((s32) var_s1->lap1CompletionTimeX, temp_s4->timerY + var_s0, (s32) var_s2->lapDurations[0]);
                    } else {
                        func_8004F9CC((s32) var_s1->lap1CompletionTimeX, temp_s4->timerY + var_s0, (s32) var_s2->lapDurations[0]);
                    }
                    var_s0 += 0x10;
                    var_s3 += 4;
                    var_s1 += 2;
                ...
                func_8004CB90(temp_s4->totalTimeX - 0x13, temp_s4->timerY + 0x38, (u8 *) D_0D00BD58);
                if (D_801657E5 != 0) {
            ...
            if (temp_s4->blinkTimer == 0) {
                func_8004CB90(temp_s4->timerX - 0x13, temp_s4->timerY + 8, (u8 *) D_0D00C158);
                print_timer((s32) temp_s4->timerX, (s32) temp_s4->timerY, (s32) temp_s4->someTimer);
                return;
            }
            func_8004CB90(temp_s4->timerX - 0x13, temp_s4->timerY + 8, (u8 *)0x0D00AD58);
            if (D_801657E3 != 0) {
...
void func_800514BC(void) {
    ...
    if (var_s3 > 0) {
        ...
        do {
            temp_a0 = *var_s2;
            if ((gPlayerOne[temp_a0].type & 0x8000) && ((temp_a0 != 0) || (gPlayerCountSelection1 != 1))) {
                func_80050E34((s32) temp_a0, var_s0);
            }
            var_s1 += 1;
            var_s0 -= 1;
            var_s2 -= 2;
