...
void func_800523B8(s32 objectIndex, s32 arg1, u32 arg2) {
    ...
    temp_v1 = &gObjectList[objectIndex];
    temp_v1->orientation[1] = func_800418AC(temp_v1->pos[0], temp_v1->pos[2], camera->pos);
    func_800484BC(temp_v1->pos, temp_v1->orientation, temp_v1->sizeScaling, temp_v1->unk_0A0, (u8 *) temp_v1->activeTLUT, temp_v1->activeTexture, temp_v1->vertex, 0x00000030, 0x00000028, 0x00000030, 0x00000028);
...
void func_80052590(s32 cameraId) {
    ...
    D_80183E80[0] = gObjectList[temp_s0].orientation[0];
    D_80183E80[2] = gObjectList[temp_s0].orientation[2];
    ...
    for (someIndex = 0; someIndex < gObjectParticle2_SIZE; someIndex++) {
        ...
        if (objectIndex != NULL_OBJECT_ID) {
            ...
            if (temp_s1->state > 0) {
                ...
                if (is_obj_index_flag_unk_054_active(objectIndex, 0x00040000) != 0) {
                    temp_s1->orientation[1] = func_800418AC(temp_s1->pos[0], temp_s1->pos[2], sp44->pos);
    ...
    for (var_s2 = 0; var_s2 < gObjectParticle3_SIZE; var_s2++) {
        ...
        if (temp_s1 != -1) {
            ...
            if ((temp_v0->state > 0) && (temp_v0->unk_0D5 == 3) && (gMatrixHudCount <= MTX_HUD_POOL_SIZE_MAX)) {
                rsp_set_matrix_transformation(temp_v0->pos, temp_v0->orientation, temp_v0->sizeScaling);
        ...
        if (is_obj_index_flag_unk_054_active(objectIndex, 0x00000020) != 0) {
            if (func_80072320(objectIndex, 4) != 0) {
                if (arg2 >= arg1) {
                    ...
                    rsp_set_matrix_transformation_inverted_x_y_orientation(sp34, temp_s0->orientation, temp_s0->sizeScaling);
                    gSPDisplayList(gDisplayListHead++, D_0D0077D0);
                    func_80004DFC((animation_type_1 *) temp_s0->model, (animation_type_2 **) temp_s0->vertex, (s16) temp_s0->unk_0D8, (s16) temp_s0->itemDisplay);
                }
            } else if (arg1 < 0x15F91U) {
                func_8004A7AC(objectIndex, 1.5f);
            }
        }
        rsp_set_matrix_transformation(temp_s0->pos, temp_s0->orientation, temp_s0->sizeScaling);
        gSPDisplayList(gDisplayListHead++, D_0D0077D0);
        func_80004DFC((animation_type_1 *) temp_s0->model, (animation_type_2 **) temp_s0->vertex, (s16) temp_s0->unk_0D8, (s16) temp_s0->itemDisplay);
    }
}
