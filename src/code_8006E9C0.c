...
void func_80070780(void) {
    ...
    case 2:
        ...
        if (D_80165750 > 0) {
            ...
            do {
                ...
                var_s2 += 8;
                var_s1 += 4;
                temp_v0_2->unk10 = (f32) (temp_f6 * D_8018D01C);
                temp_v0_2->unk18 = (f32) temp_v1->unk2;
                temp_v0_2->unk_0D5 = (s8) temp_v1->unk4;
        ...
        temp_v0_3->unk4 = (f32) ((f64) D_8018D01C * -68.0);
        ...
        do {
            ...
            var_s3_2 += 1;
            var_s2_2 += 4;
            temp_v0_4->unk8 = (f32) var_s1_2->unk2;
            temp_v0_4->unk4 = (f32) ((f32) var_s1_2->unk0 * D_8018D01C);
            temp_v0_4->unk_0C0 = 0;
            temp_v0_4->unkC = (f32) var_s1_2->unk4;
            if (temp_t9 != 0) {
    ...
    case 3:
        if (gGamestate != 9) {
            ...
            func_80073444(temp_s0_4, &D_06007BB8, &D_06007DB8, 0x20, 0x00000040);
    ...
    case 4:
        ...
        if (gGamestate != 9) {
            ...
            do {
                ...
                temp_v0_6->unk_0D5 = (s8) temp_t1;
                temp_v0_6->unk_084[0xD] = temp_t5;
                temp_v0_6->unk18 = temp_f0_3;
                temp_v0_6->unkC = temp_f0_3;
                temp_v0_6->unk_084[0xC] = (s16) (s32) temp_f4;
    ...
    case 5:
        ...
        if (gGamestate != 9) {
            ...
            do {
                ...
                temp_s0_7 = *var_s1_6;
                temp_v0_7->unk10 = (f32) ((f32) var_v1_2->unk0 * D_8018D01C);
                temp_v0_7->unk18 = (f32) var_v1_2->unk4;
                temp_v0_7->unk14 = (f32) ((f64) var_v1_2->unk2 + 5.0 + 3.0);
                ...
                var_s1_6 += 4;
                var_s2_4 += 4;
                temp_v0_8->unk_0D5 = (s8) temp_t5_2;
                temp_v0_8->unk10 = temp_f4_2;
                temp_v0_8->unk14 = (f32) (temp_f8 + 3.0);
                temp_v0_8->unk18 = (f32) temp_t4;
    ...
    case 6:
        ...
        if (gGamestate != 9) {
            ...
            do {
                ...
                temp_v0_9->unk1C = (f32) (temp_f18 * temp_f2_2);
                temp_v0_9->unk18 = temp_f0_5;
                temp_v0_9->unkC = temp_f0_5;
                temp_v0_9->unk24 = (f32) temp_f8_2;
...
block_75:
            ...
            do {
                ...
                sp4C = temp_v0_12;
                temp_v0_12->unkC = (f32) var_s2_6->unk4;
                temp_v0_12->unk4 = (f32) ((f32) var_s2_6->unk0 * D_8018D01C);
...
void func_80071818(void) {
    ...
    func_8007055C();
    func_80070780();
    D_8018CA70->itemBoxX = -0x52;
    D_8018CA70->itemBoxY = 0x32;
    D_8018CA70->slideItemBoxX = 0;
    D_8018CA70->slideItemBoxY = 0;
    D_8018CA70->unk_4A = 0x50;
    D_8018CA70->unk_4C = 0x78;
    D_8018CA70->rankX = 0x32;
    D_8018CA70->rankY = 0xD2;
    D_8018CA70->slideRankX = 0;
    D_8018CA70->slideRankY = 0;
    D_8018CA70->timerX = 0x4B;
    D_8018CA70->timerY = 0x10;
    D_8018CA70->lapX = 0x67;
    D_8018CA70->lapY = 0x28;
    func_8006EE7C(D_80183E88);
...
void func_80071A20(void) {
    ...
    func_8007055C();
    func_80070780();
    D_8018CA70->itemBoxY = 0x22;
    D_8018CA70->itemBoxX = -0x53;
    D_8018CA70->slideItemBoxX = 0;
    D_8018CA70->slideItemBoxY = 0;
    D_8018CA70->unk_4A = 0xA0;
    D_8018CA70->unk_4C = 0x3C;
    D_8018CA70->rankX = 0x34;
    D_8018CA70->rankY = 0x62;
    D_8018CA70->slideRankX = 0;
    D_8018CA70->slideRankY = 0;
    D_8018CA70->timerX = 0xEA;
    D_8018CA70->timerY = 0x10;
    D_8018CA70->lapX = 0x101;
    D_8018CA70->lapY = 0x6A;
