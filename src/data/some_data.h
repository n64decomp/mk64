...
extern StarCloudData gLuigiRacewayClouds[];
extern StarCloudData gYoshiValleyMooMooFarmClouds[];
extern StarCloudData gKoopaTroopaBeachClouds[];
extern StarCloudData gRoyalRacewayClouds[];
extern StarCloudData gSherbetLandClouds[];
extern StarCloudData gKalimariDesertClouds[];
extern StarCloudData gToadsTurnpikeRainbowRoadStars[];
extern StarCloudData gWarioStadiumStars[];
