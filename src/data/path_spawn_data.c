...
struct _struct_D_800DD9D0_0x10 D_800DD9D0[] = {
    { 0x0258, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_MARIO_RACEWAY
    { 0x02bc, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_CHOCO_MOUNTAIN
    { 0x030c, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_BOWSER_CASTLE
    { 0x02ee, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_BANSHEE_BOARDWALK
    { 0x02b2, 0x02a8, 0x02b2, 0x0320, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_YOSHI_VALLEY
    { 0x02ee, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_FRAPPE_SNOWLAND
    { 0x02bc, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_KOOPA_BEACH
    { 0x03e8, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_ROYAL_RACEWAY
    { 0x02da, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_LUIGI_RACEWAY
    { 0x0230, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_MOO_MOO_FARM
    { 0x03e8, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_TOADS_TURNPIKE
    { 0x02bc, 0x0001, 0x0001, 0x0001, 0x0226, { 0x0000, 0x0000, 0x0000}}, // COURSE_KALAMARI_DESERT
    { 0x02bc, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_SHERBET_LAND
    { 0x076c, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_RAINBOW_ROAD
    { 0x0640, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_WARIO_STADIUM
    { 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_BLOCK_FORT
    { 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_SKYSCRAPER
    { 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_DOUBLE_DECK
    { 0x0370, 0x0001, 0x0001, 0x0001, 0x01f4, { 0x0000, 0x0000, 0x0000}}, // COURSE_DK_JUNGLE
    { 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_BIG_DONUT
    { 0x01f4, 0x01f4, 0x01f4, 0x01f4, 0x0001, { 0x0000, 0x0000, 0x0000}}, // COURSE_AWARD_CEREMONY
};
