...
void func_8004ED40(s32 arg0) {
    func_8004A2F4(playerHUD[arg0].speedometerX, playerHUD[arg0].speedometerY, 0U, 1.0f, D_8018D300, D_8018D308,
                  D_8018D310, 0xFF, common_texture_speedometer, D_0D0064B0, 0x40, 0x60, 0x40, 0x30);
...
void func_80055164(s32 objectIndex) {
    if (gObjectList[objectIndex].state >= 2) {
        ...
        rsp_set_matrix_transformation(gObjectList[objectIndex].pos, gObjectList[objectIndex].direction_angle,
                                      gObjectList[objectIndex].sizeScaling);
        if (gIsGamePaused == 0) {
            gObjectList[objectIndex].unk_0A2 = func_80004DFC((animation_type_1*) gObjectList[objectIndex].model,
                                                             (animation_type_2**) gObjectList[objectIndex].vertex, 0,
                                                             gObjectList[objectIndex].unk_0A2);
        } else {
            func_80004DFC((animation_type_1*) gObjectList[objectIndex].model,
                          (animation_type_2**) gObjectList[objectIndex].vertex, 0, gObjectList[objectIndex].unk_0A2);
        }
    }
}
...
void func_800557B4(s32 objectIndex, u32 arg1, u32 arg2) {
    ...
    if (object->state >= 2) {
            ...
            if (func_80072320(objectIndex, 4) != 0) {
                if (arg2 >= arg1) {
                    ...
                    rsp_set_matrix_transformation_inverted_x_y_orientation(sp34, object->orientation,
                                                                           object->sizeScaling);
                    gSPDisplayList(gDisplayListHead++, D_0D0077D0);
                    func_80004DFC((animation_type_1*) object->model, (animation_type_2**) object->vertex,
        ...
        rsp_set_matrix_transformation(object->pos, object->orientation, object->sizeScaling);
        gSPDisplayList(gDisplayListHead++, D_0D0077D0);
        func_80004DFC((animation_type_1*) object->model, (animation_type_2**) object->vertex, (s16) object->unk_0D8,
