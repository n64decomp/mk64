...
? func_802B53C8(? *, s32 *, Gfx **);                /* extern */
? func_802B5520(? *, f32 *, Gfx **);                /* extern */
...
void render_luigi_raceway(void *arg0) {
    ...
    temp_v0_9->words.w0 = 0xFC127E24;
    temp_v0_10 = gDisplayListHead;
    gDisplayListHead = temp_v0_10 + 8;
    temp_v0_10->words.w0 = 0xB900031D;
    temp_v0_10->words.w1 = 0x553078;
    temp_v0_11 = gDisplayListHead;
    gDisplayListHead = temp_v0_11 + 8;
    temp_v0_11->words.w1 = 0x70000E0;
    temp_v0_11->words.w0 = 0x6000000;
    temp_v0_12 = gDisplayListHead;
    gDisplayListHead = temp_v0_12 + 8;
    temp_v0_12->words.w1 = 0x7000068;
    temp_v0_12->words.w0 = 0x6000000;
    D_800DC5DC = 0x58;
    D_800DC5E0 = 0x48;
    if ((D_800DC52C == 0) && (sp22 >= 0xA) && (sp22 < 0x11)) {
        temp_v0_13 = sRenderedFramebuffer - 1;
        phi_v0 = temp_v0_13;
        if (temp_v0_13 < 0) {
            phi_v0 = 2;
        } else if (temp_v0_13 >= 3) {
            phi_v0 = 0;
        }
        D_802B87D8 += 1;
        if (D_802B87D8 >= 6) {
        ...
        switch (D_802B87D8) {
        case 0:
            func_802A7658(D_800DC5DC, D_800DC5E0, 0x40, 0x20, gPhysicalFramebuffers[phi_v0] | 0x80000000, (*(gSegmentTable + 0x14) + 0xF800) | 0x80000000);
            return;
        case 1:
            func_802A7658(D_800DC5DC + 0x40, D_800DC5E0, 0x40, 0x20, gPhysicalFramebuffers[phi_v0] | 0x80000000, (*(gSegmentTable + 0x14) + 0x10800) | 0x80000000);
            return;
        case 2:
            func_802A7658(D_800DC5DC, D_800DC5E0 + 0x20, 0x40, 0x20, gPhysicalFramebuffers[phi_v0] | 0x80000000, (*(gSegmentTable + 0x14) + 0x11800) | 0x80000000);
            return;
        case 3:
            func_802A7658(D_800DC5DC + 0x40, D_800DC5E0 + 0x20, 0x40, 0x20, gPhysicalFramebuffers[phi_v0] | 0x80000000, (*(gSegmentTable + 0x14) + 0x12800) | 0x80000000);
            return;
        case 4:
            func_802A7658(D_800DC5DC, D_800DC5E0 + 0x40, 0x40, 0x20, gPhysicalFramebuffers[phi_v0] | 0x80000000, (*(gSegmentTable + 0x14) + 0x13800) | 0x80000000);
            return;
        case 5:
            func_802A7658(D_800DC5DC + 0x40, D_800DC5E0 + 0x40, 0x40, 0x20, gPhysicalFramebuffers[phi_v0] | 0x80000000, (*(gSegmentTable + 0x14) + 0x14800) | 0x80000000);
...
void func_8029569C(void) {
    ...
    case 0:
        ...
        temp_v0->words.w1 = &D_06009348;
        return;
    case 1:
        temp_v0_2 = gDisplayListHead;
        gDisplayListHead = temp_v0_2 + 8;
        temp_v0_2->words.w0 = 0x6000000;
        temp_v0_2->words.w1 = &D_060071B0;
        return;
    case 2:
        temp_v0_3 = gDisplayListHead;
        gDisplayListHead = temp_v0_3 + 8;
        temp_v0_3->words.w0 = 0x6000000;
        temp_v0_3->words.w1 = &D_06009148;
        return;
    case 3:
        temp_v0_4 = gDisplayListHead;
        gDisplayListHead = temp_v0_4 + 8;
        temp_v0_4->words.w0 = 0x6000000;
        temp_v0_4->words.w1 = &D_0600B308;
        return;
    case 4:
        temp_v0_5 = gDisplayListHead;
        gDisplayListHead = temp_v0_5 + 8;
        temp_v0_5->words.w0 = 0x6000000;
        temp_v0_5->words.w1 = &D_06018020;
        return;
    case 5:
        temp_v0_6 = gDisplayListHead;
        gDisplayListHead = temp_v0_6 + 8;
        temp_v0_6->words.w0 = 0x6000000;
        temp_v0_6->words.w1 = &D_060076A0;
        return;
    case 6:
        temp_v0_7 = gDisplayListHead;
        gDisplayListHead = temp_v0_7 + 8;
        temp_v0_7->words.w0 = 0x6000000;
        temp_v0_7->words.w1 = &D_06018D68;
        return;
    case 7:
        temp_v0_8 = gDisplayListHead;
        gDisplayListHead = temp_v0_8 + 8;
        temp_v0_8->words.w0 = 0x6000000;
        temp_v0_8->words.w1 = &D_0600D8E8;
        return;
    case 8:
        temp_v0_9 = gDisplayListHead;
        gDisplayListHead = temp_v0_9 + 8;
        temp_v0_9->words.w0 = 0x6000000;
        temp_v0_9->words.w1 = &D_0600FD40;
        return;
    case 9:
        temp_v0_10 = gDisplayListHead;
        gDisplayListHead = temp_v0_10 + 8;
        temp_v0_10->words.w0 = 0x6000000;
        temp_v0_10->words.w1 = &D_06014088;
        return;
    case 10:
        temp_v0_11 = gDisplayListHead;
        gDisplayListHead = temp_v0_11 + 8;
        temp_v0_11->words.w0 = 0x6000000;
        temp_v0_11->words.w1 = &D_06023930;
        return;
    case 11:
        temp_v0_12 = gDisplayListHead;
        gDisplayListHead = temp_v0_12 + 8;
        temp_v0_12->words.w0 = 0x6000000;
        temp_v0_12->words.w1 = &D_06022E00;
        return;
    case 12:
        temp_v0_13 = gDisplayListHead;
        gDisplayListHead = temp_v0_13 + 8;
        temp_v0_13->words.w0 = 0x6000000;
        temp_v0_13->words.w1 = &D_06009AE8;
        return;
    case 13:
        temp_v0_14 = gDisplayListHead;
        gDisplayListHead = temp_v0_14 + 8;
        temp_v0_14->words.w0 = 0x6000000;
        temp_v0_14->words.w1 = &D_06016220;
        return;
    case 14:
        temp_v0_15 = gDisplayListHead;
        gDisplayListHead = temp_v0_15 + 8;
        temp_v0_15->words.w0 = 0x6000000;
        temp_v0_15->words.w1 = &D_0600CA78;
        return;
    case 15:
        temp_v0_16 = gDisplayListHead;
        gDisplayListHead = temp_v0_16 + 8;
        temp_v0_16->words.w0 = 0x6000000;
        temp_v0_16->words.w1 = 0x6000000;
        return;
    case 16:
        temp_v0_17 = gDisplayListHead;
        gDisplayListHead = temp_v0_17 + 8;
        temp_v0_17->words.w0 = 0x6000000;
        temp_v0_17->words.w1 = 0x6000000;
        return;
    case 17:
        temp_v0_18 = gDisplayListHead;
        gDisplayListHead = temp_v0_18 + 8;
        temp_v0_18->words.w0 = 0x6000000;
        temp_v0_18->words.w1 = 0x6000000;
        return;
    case 18:
        temp_v0_19 = gDisplayListHead;
        gDisplayListHead = temp_v0_19 + 8;
        temp_v0_19->words.w0 = 0x6000000;
        temp_v0_19->words.w1 = &D_06013C30;
        return;
    case 19:
        temp_v0_20 = gDisplayListHead;
        gDisplayListHead = temp_v0_20 + 8;
        temp_v0_20->words.w0 = 0x6000000;
        temp_v0_20->words.w1 = 0x6000000;
        /* fallthrough */
    default:
        return;
    }
...
block_29:
    ...
    case 1:
        ...
        D_802B87D4 = 0x71C;
        D_802B87D0 = 0xE38;
        if ((gCCSelection != 0) && (gModeSelection != 1)) {
