...
void update_obj_falling_rocks(struct FallingRock *rock) {
    ...
    rock->rot[2] += (s32) ((rock->velocity[0] * D_802B9758) / 20.0f);
    ...
    func_802ADDC8(rock->velocity[0], D_802B9758, &rock->unk30, 10.0f, rock->pos[0], rock->pos[1], rock->pos[2]);
    temp_f2 = ;
    phi_f12 = 0.0f;
    if (rock->unk30.unk44 < 0.0f) {
        ...
        func_802AC114(0.0f, &sp44, rock->unk30.unk44, rock->velocity, 0x40000000);
        rock->velocity[1] = D_802B9768 * sp3C;
        func_800C98B8(rock->pos, rock->velocity, 0x1900800F);
    }
...
#ifdef MIPS_TO_C
//generated by m2c commit a8f43e46d33dcb7e04d9cdc44a10b3daf4c92c3b
static f32 D_802B989C = 0.8f;

s32 func_8029F1F8(Player *player, struct Actor *actor) {
    u16 temp_v0;

    if (func_8029EEB8(player, actor->pos, 7.0f, 200.0f, D_802B989C) == 1) {
        ...
        if ((temp_v0 & 0x4000) != 0) {
            ...
            if ((temp_v0 & 0x100) == 0) {
                func_800C9060((Player *) (((s32) (player - gPlayerOne) / 3544) & 0xFF), 0x1900701A);
            }
            goto block_6;
        }
block_6:
...
s32 func_8029F2FC(Player *player, struct PiranhaPlant *plant) {
    ...
    temp_f0 = plant->boundingBoxSize;
    if (func_8029EEB8(player, plant->pos, temp_f0, temp_f0, 2.5f) == 1) {
        temp_v0 = player->unk_000;
        if ((temp_v0 & 0x4000) != 0) {
            if ((player->unk_0BC & 0x200) != 0) {
                plant->flags |= 0x400;
            ...
            if ((temp_v0 & 0x100) == 0) {
                func_800C9060((Player *) (((s32) (player - gPlayerOne) / 3544) & 0xFF), 0x1900A052);
            }
            goto block_6;
        }
block_6:
...
void func_802A0450(Player *player, struct Actor *actor) {
                ...
                if ((temp_v0->unk_000 & 0x4000) != 0) {
                    if ((actor->flags & 0xF) != 0) {
                        if ((s16) temp_lo != temp_v1) {
                            func_800C90F4((Player *) (temp_v1 & 0xFF), (temp_v0->characterId * 0x10) + 0x29008006);
                        }
                    } else {
    ...
    case ACTOR_GREEN_SHELL:
        if (((player->unk_0BC & 0x80000400) == 0) && ((player->unk_00C & 4) == 0) && ((temp_v1_2 = actor->rot[2], ((s16) temp_lo != temp_v1_2)) || ((actor->flags & 0x1000) == 0))) {
            ...
            if (func_8029FB80(player, actor) == 1) {
                ...
                if (((temp_v0_2->unk_000 & 0x4000) != 0) && ((s16) temp_lo != temp_v1_2)) {
                    func_800C90F4((Player *) (temp_v1_2 & 0xFF), (temp_v0_2->characterId * 0x10) + 0x29008006);
                }
                func_8029FDC8(actor);
                return;
            }
        ...
        break;
    case ACTOR_BLUE_SPINY_SHELL:
        if (((player->unk_00C & 2) == 0) && ((temp_v1_3 = actor->rot[2], ((s16) temp_lo != temp_v1_3)) || ((actor->flags & 0x1000) == 0)) && (sp36 = temp_v1_3, sp42 = (s16) temp_lo, (func_8029FB80(player, actor) == 1))) {
            ...
            if (((temp_v0_3->unk_000 & 0x4000) != 0) && ((s16) temp_lo != temp_v1_3)) {
                sp42 = (s16) temp_lo;
                func_800C90F4((Player *) (temp_v1_3 & 0xFF), (temp_v0_3->characterId * 0x10) + 0x29008006);
            }
            if ((s16) temp_lo == actor->unk_04) {
                func_8029FDC8(actor);
                return;
            }
        }
        ...
        if (((player->unk_0BC << 7) >= 0) && ((player->unk_00C & 2) == 0) && ((temp_v1_4 = actor->rot[2], ((s16) temp_lo != temp_v1_4)) || ((actor->flags & 0x1000) == 0))) {
            ...
            if (func_8029FB80(player, actor) == 1) {
                ...
                if (((temp_v0_4->unk_000 & 0x4000) != 0) && ((s16) temp_lo != temp_v1_4)) {
                    func_800C90F4((Player *) (temp_v1_4 & 0xFF), (temp_v0_4->characterId * 0x10) + 0x29008006);
                }
                func_8029FDC8(actor);
                return;
            }
                ...
                if ((temp_v0_5->unk_000 & 0x4000) != 0) {
                    if ((actor->flags & 0xF) != 0) {
                        if ((s16) temp_lo != (s16) temp_f16) {
                            sp24 = temp_v0_5;
                            func_800C90F4((Player *) ((s16) temp_f16 & 0xFF), (temp_v0_5->characterId * 0x10) + 0x29008006);
                            phi_v0 = sp24;
                        }
                    } else {
