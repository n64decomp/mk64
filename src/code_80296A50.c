...
//
// void func_8029794C(Vec3f, Vec3f, f32);
...
// UNUSED func_8029ABD4() 
GLOBAL_ASM("asm/non_matchings/code_actors/unused_unk.s")
...
void func_8029AE1C(Camera *, Mat4, struct Actor*, u16);            /* extern */
...
void func_802A3008(struct UnkStruct_800DC5EC *arg0) {
    ...
    f32 sp48 = sins((temp_s1->rotX[1] - 0x8000) & 0xFFFF); // unk26;
    f32 temp_f0 = coss((temp_s1->rotX[1] - 0x8000) & 0xFFFF);
