...
void update_obj_yoshi_valley_egg(struct yv_egg *egg) {
    egg->pathRot += 0x5B;
...
#ifdef MIPS_TO_C
//generated by m2c commit 685418adfeb3794409e47b45ac5cab60b17d23fd
? func_800C9060(f32, f32, s32, ?, struct kiwano_fruit *, Player **); /* extern */
...
void update_obj_kiwano_fruit(struct kiwano_fruit *fruit) {
    Player *sp24;
    f32 sp20;
    f32 sp1C;
    f32 sp18;
    ...
    s16 temp_t6;
    s32 temp_v0_2;
    struct kiwano_fruit *temp_a2;
    void *temp_v0;
    s16 phi_a0;
    struct kiwano_fruit *phi_a2;
    struct kiwano_fruit *phi_a2_2;
...
void update_obj_paddle_wheel(struct paddle_wheel_boat *boat) {
    boat->wheelRot += 0x38E;
}
...
// wheels
void update_obj_train_engine(struct train_car *arg0) {
    arg0->wheelRot -= 0x666;
...
// wheels
void update_obj_train_car1(struct train_car *arg0) {
    arg0->wheelRot -= 0x4FA;
}

// wheels
void update_obj_train_car2(struct train_car *arg0) {
    arg0->wheelRot -= 0x666;
}
...
void func_80298328(Camera *camera, Mat4 arg1, struct piranha_plant *actor) {
    s16 sp36;
    f32 sp2C;
    Gfx *temp_v0;
    Gfx *temp_v0_2;
...
void func_8029A3AC(Camera *camera, Mat4 arg1, struct shell_actor *shell) {
    ...
    if (shell->type == ACTOR_BLUE_SHELL) {
        phi_t3 = D_802BA054;
    } else {
        phi_t3 = D_802BA050;
    }
...
void func_8029A8F4(Camera *arg0, Mat4 arg1, struct banana_actor *arg2) {
    s32 pad[3];
    Vec3s sp7C;
    Mat4 sp3C;
    ...
    if (arg2->state == 5) {
        func_802B5F74(sp3C, arg2->pos, arg2->ids);
    } else {
        sp7C[0] = 0;
        sp7C[1] = 0;
        sp7C[2] = 0;
 ...
 **/
void update_obj_railroad_crossing(struct railroad_crossing *arg0) {
    // If train close?
...
void func_8029AE1C(Camera *arg0, struct paddle_wheel_boat *boat, Mat4 arg2, u16 arg3) {
    s32 pad[3];
    Vec3f sp120;
    Mat4 spE0;
    Mat4 spA0;
...
void func_8029B8E8(Camera *camera, struct train_car *actor) {
    f32 sp160;
    f32 sp9C;
    f32 *sp30;
    Gfx *temp_v0;
...
void func_8029CA90(Camera *camera, struct falling_rock *rock) {
    s16 sp9C;
    s16 sp9A;
    s16 sp98;
    f32 sp94;
...
//generated by m2c commit 685418adfeb3794409e47b45ac5cab60b17d23fd
? func_800C98B8(f32 *, f32 *, ?);                   /* extern */
? func_8029CF0C(? *, struct falling_rock *);        /* extern */
...
void update_obj_falling_rocks(struct falling_rock *rock) {
    f32 sp4C;
    f32 sp48;
    f32 sp44;
    f32 sp3C;
...
void func_8029FDC8(struct Actor *actor) {
    ...
    case ACTOR_GREEN_SHELL:                                         /* switch 4 */
        ...
        break;
    case ACTOR_BLUE_SHELL:                                        /* switch 4 */
...
void func_802A0350(struct Actor *arg0, struct Actor *arg1) {
    if (func_8029FCA4(arg0, arg1) == 1) {
        if ((arg0->type == ACTOR_BLUE_SHELL) && (arg1->type == ACTOR_BLUE_SHELL)) {
            func_8029FDC8(arg0);
            func_8029FDC8(arg1);
            arg0->flags |= 256;
            func_800C98B8(arg0->pos, arg0->velocity, 0x19018010);
...
void func_802A27A0(Camera *arg0, Mat4 arg1, struct yv_egg *egg, u16 arg3) {
    Mat4 sp60;
    Vec3s sp5C;
    Vec3f sp54;
    f32 temp_f0;
...
void func_802A27A0(Camera*, Mat4, struct yv_egg*, u16);
...
void func_8029A8F4(Camera *, Mat4, struct banana_actor*);                  /* extern */
