...
#ifdef MIPS_TO_C
//generated by m2c commit b52d92c2340f6f4ba1aafb464188bb698752fbb0 on Jul-17-2023
// Decently close, something's up with the handling of all the `if` statements
extern s32 D_8018D158;
s32 func_80089B50(s32 objectIndex) {
    ...
    u16 test;
    if (func_8007223C(objectIndex, 0x00000200) != 0) {
        for (var_s2 = 0; var_s2 < D_8018D158; thing++) {
            if ((D_80165C18[objectIndex].unk_0A6 != 0) && !(player->unk_0BC & 0x81000000)) {
                if (!((player->unk_000) & 0x8000)) continue;
                if (!(player->unk_000 & 0x100) && func_80088D18(objectIndex, player)) {
                    sp40 = 1;
                    if (!(player->unk_0BC & 0x200)) {
                        player->statusEffects |= 0x400000;
                        if (func_8007223C(objectIndex, 0x04000000)) {
                            func_80072180();
                        }
                    } else {
                        func_800C9060(thing, 0x19018010U);
                    }
                }
            }
            var_s2++, player++;
