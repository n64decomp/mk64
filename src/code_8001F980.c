...
void func_800212B4(void) {
    ...
    sp3C.unk0 = (s32) D_800DDB68.unk0;
    sp3C.unk4 = (s32) D_800DDB68.unk4;
    sp3C.unkC = (s32) D_800DDB68.unkC;
    sp3C.unk8 = (s32) D_800DDB68.unk8;
    sp3C.unk10 = (s32) D_800DDB68.unk10;
    sp3C.unk14 = (s32) D_800DDB68.unk14;
    sp3C.unk1C = (s32) D_800DDB68.unk1C;
    sp3C.unk18 = (s32) D_800DDB68.unk18;
    sp1C.unk0 = (s32) D_800DDB88.unk0;
    sp1C.unk4 = (s32) D_800DDB88.unk4;
    sp1C.unk8 = (s32) D_800DDB88.unk8;
    sp1C.unkC = (s32) D_800DDB88.unkC;
    sp1C.unk10 = (s32) D_800DDB88.unk10;
    sp1C.unk14 = (s32) D_800DDB88.unk14;
    sp1C.unk18 = (s32) D_800DDB88.unk18;
    sp1C.unk1C = (s32) D_800DDB88.unk1C;
    *D_800DDB58 = NULL;
...
void func_80024374(Player *player, s8 arg1, s8 arg2) {
    ...
    spCC = (coss(temp_s0 & 0xFFFF) * spAC) + (spB0 * sp30) + player->pos[0];
    sp30 = coss(temp_s0 & 0xFFFF);
    spD4 = ((spB0 * sp30) - (sins(temp_s0 & 0xFFFF) * temp_f18)) + player->pos[2];
    spD0 = (sp + (arg1 * 4))->unk94 + *(&D_80165C20 + (D_80183EA0[arg1] * 0xE0));
    ...
    temp_v0_2->words.w1 = (s32) (&gGfxPool->mtxPool[arg1] + temp_s0_2 + 0xEAC0) & 0x1FFFFFFF;
...
static ? gKartBowserWheels0;                        /* unable to generate initializer */
static ? gKartBowserWheels1;                        /* unable to generate initializer */
static ? gKartDKWheels0;                            /* unable to generate initializer */
static ? gKartDKWheels1;                            /* unable to generate initializer */
static ? gKartLuigiWheels0;                         /* unable to generate initializer */
static ? gKartLuigiWheels1;                         /* unable to generate initializer */
static ? gKartMarioWheels0;                         /* unable to generate initializer */
static ? gKartMarioWheels1;                         /* unable to generate initializer */
static ? gKartPeachWheels0;                         /* unable to generate initializer */
static ? gKartPeachWheels1;                         /* unable to generate initializer */
static ? gKartToadWheels0;                          /* unable to generate initializer */
static ? gKartToadWheels1;                          /* unable to generate initializer */
static ? gKartWarioWheels0;                         /* unable to generate initializer */
static ? gKartWarioWheels1;                         /* unable to generate initializer */
static ? gKartYoshiWheels0;                         /* unable to generate initializer */
static ? gKartYoshiWheels1;                         /* unable to generate initializer */
...
void func_80026B4C(Player *player, s8 arg1, s8 arg2, s8 arg3) {
    ...
    if (((temp_v1 & 0x4000) == 0x4000) && !(player->unk_000 & 0x2000)) {
        if (((temp_v1 & 0x80) != 0x80) && ((temp_v1 & 0x40) != 0x40) && ((temp_v1 & 0x20000) != 0x20000) && ((temp_v1 & 0x80000) != 0x80000) && ((temp_v1 & 0x800000) != 0x800000) && !(player->unk_044 & 0x800)) {
            if (temp_t0 < 0x15) {
                func_80027C74(player, *(D_800DDE34[player->characterId] + (temp_t1 * 4)) + (temp_t0 << 9) + ((temp_t2 >> 8) << 7), (arg3 << 0xE) + (arg2 << 0xC) + (arg1 << 9) + 0x180 + D_802F1F80, 0x0080U);
                return;
            }
            func_80027C74(player, *(D_800DDE54[player->characterId] + (temp_t1 * 4)) + (((temp_t0 << 8) - 0x1500) * 2) + ((temp_t2 >> 8) << 7) + 0xC00, (arg3 << 0xE) + (arg2 << 0xC) + (arg1 << 9) + 0x180 + D_802F1F80, 0x0080U);
            return;
        }
        if (temp_t0 == 0) {
            func_80027C74(player, *(D_800DDE34[player->characterId] + (temp_t1 * 4)) + (temp_t0 << 9) + ((temp_t2 >> 8) << 7), (arg3 << 0xE) + (arg2 << 0xC) + (arg1 << 9) + 0x180 + D_802F1F80, 0x0080U);
        ...
        func_80027C74(player, *(D_800DDE54[player->characterId] + (temp_t1 * 4)) + (temp_t0 << 9) + ((temp_t2 >> 8) << 7), (arg3 << 0xE) + (arg2 << 0xC) + (arg1 << 9) + 0x180 + D_802F1F80, 0x0080U);
        return;
    }
