...
#else
GLOBAL_ASM("asm/non_matchings/code_8001F980/func_8001F980.s")
#endif
...
void func_80020524(void) {
    ...
    func_8006E5AC(D_800DC4FC, 0, 0);
    func_8006E5AC(D_800DC4E0, 1, 0);
    func_8006E5AC(D_800DC4E4, 2, 0);
    func_8006E5AC(D_800DC4E8, 3, 0);
    if (D_800DC52C != 3) {
        func_8006E5AC(D_800DC4EC, 4, 0);
        func_8006E5AC(D_800DC4F0, 5, 0);
...
void func_8002088C(void) {
    ...
    temp_v0 = D_80164AB0;
    func_80027560(D_80164AD0, temp_v0, temp_v1, temp_v1, *(&D_801651D0[temp_v1] + (temp_v0 * 2)));
    func_8006E634(D_800DC4FC, 0, 1);
    func_8006E634(D_800DC4E0, 1, 1);
    func_8006E634(D_800DC4E4, 2, 1);
    func_8006E634(D_800DC4E8, 3, 1);
    if (D_800DC52C != 3) {
        func_8006E634(D_800DC4EC, 4, 1);
        func_8006E634(D_800DC4F0, 5, 1);
...
void func_80021244(Player *arg0, s8 arg1, s8 arg2) {
    ...
    if (((temp_v0 & 0x8000) == 0x8000) && ((temp_v0 & 0x40) == 0)) {
        temp_v0_2 = 2 << (arg2 * 4);
...
void func_800212B4(void) {
    ...
    func_80021244(D_800DC4E4, 2, 0);
    func_80021244(D_800DC4E8, 3, 0);
    if (D_800DC52C != 3) {
        func_80021244(D_800DC4EC, 4, 0);
        func_80021244(D_800DC4F0, 5, 0);
        func_80021244(D_800DC4F4, 6, 0);
        func_80021244(D_800DC4F8, 7, 0);
    }
    if (D_800DDB58 != 0) {
        func_80020524(&D_800DC4FC, 0, 0);
    } else {
        func_8006E5AC(D_800DC4FC, 0, 0);
        func_8006E5AC(D_800DC4E0, 1, 0);
        func_8006E5AC(D_800DC4E4, 2, 0);
...
void func_800215DC(void) {
    ...
    func_80021244(D_800DC4E4, 2, 1);
    func_80021244(D_800DC4E8, 3, 1);
    if (D_800DC52C != 3) {
        func_80021244(D_800DC4EC, 4, 1);
        func_80021244(D_800DC4F0, 5, 1);
        func_80021244(D_800DC4F4, 6, 1);
        func_80021244(D_800DC4F8, 7, 1);
    }
    if (D_800DDB58 != 0) {
        func_8002088C(&D_800DC4FC, 0, 1);
    } else {
        func_8006E634(D_800DC4FC, 0, 1);
        func_8006E634(D_800DC4E0, 1, 1);
        func_8006E634(D_800DC4E4, 2, 1);
...
void func_8002186C(void) {
    ...
    func_80021244(D_800DC4E8, 3, 2);
    if (D_800DDB58 != 0) {
        func_80020BF4(&D_800DC4FC, 0, 2);
    } else {
        func_8006E6BC(D_800DC4FC, 0, 2);
        func_8006E6BC(D_800DC4E0, 1, 2);
        func_8006E6BC(D_800DC4E4, 2, 2);
...
void func_800219BC(void) {
    ...
    func_80021244(D_800DC4E8, 3, 3);
    if (D_800DDB58 != 0) {
        func_80020F1C(&D_800DC4FC, 0, 3);
    } else {
        func_8006E744(D_800DC4FC, 0, 3);
        func_8006E744(D_800DC4E0, 1, 3);
        func_8006E744(D_800DC4E4, 2, 3);
...
void func_80021B0C(void) {
    ...
    func_8006E7CC(D_800DC4FC, 0, 0);
    func_8006E7CC(D_800DC4E0, 1, 0);
    func_8006E7CC(D_800DC4E4, 2, 0);
    func_8006E7CC(D_800DC4E8, 3, 0);
    if (D_800DC52C != 3) {
        func_8006E7CC(D_800DC4EC, 4, 0);
        func_8006E7CC(D_800DC4F0, 5, 0);
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
? func_8006E848(Player *, ?, ?); // extern

void func_80021C78(void) {
    func_8006E848(D_800DC4FC, 0, 1);
    func_8006E848(D_800DC4E0, 1, 1);
    func_8006E848(D_800DC4E4, 2, 1);
    func_8006E848(D_800DC4E8, 3, 1);
    if (D_800DC52C != 3) {
        func_8006E848(D_800DC4EC, 4, 1);
        func_8006E848(D_800DC4F0, 5, 1);
        func_8006E848(D_800DC4F4, 6, 1);
        func_8006E848(D_800DC4F8, 7, 1);
    }
}
#else
GLOBAL_ASM("asm/non_matchings/code_8001F980/func_80021C78.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
? func_8006E8C4(Player *, ?, ?); // extern

void func_80021D40(void) {
    func_8006E8C4(D_800DC4FC, 0, 2);
    func_8006E8C4(D_800DC4E0, 1, 2);
    func_8006E8C4(D_800DC4E4, 2, 2);
    func_8006E8C4(D_800DC4E8, 3, 2);
}
#else
GLOBAL_ASM("asm/non_matchings/code_8001F980/func_80021D40.s")
#endif
...
void func_80021DA8(void) {
    func_8006E940(D_800DC4FC, 0, 3);
    func_8006E940(D_800DC4E0, 1, 3);
    func_8006E940(D_800DC4E4, 2, 3);
    func_8006E940(D_800DC4E8, 3, 3);
}
#else
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
void func_80022598(s32 *arg0, s32 arg1, f32 arg2) {
    s32 temp_v0;

    temp_v0 = *arg0;
    *arg0 = temp_v0 - ((temp_v0 - arg1) * arg2);
}
#else
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
void func_80022634(s16 *arg0, s16 arg1, f32 arg2) {
    s16 temp_v0;
...
#else
GLOBAL_ASM("asm/non_matchings/code_8001F980/func_80022634.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
void func_80022674(u16 *arg0, s16 arg1, f32 arg2) {
    u16 temp_v0;
...
#else
GLOBAL_ASM("asm/non_matchings/code_8001F980/func_80022674.s")
#endif
...
void func_8002276C(void) {
    ...
    if (temp_v0 != 0) {
        ...
        func_80022A98(D_800DC4E4, 2);
        func_80022A98(D_800DC4E8, 3);
        func_80022A98(D_800DC4EC, 4);
        func_80022A98(D_800DC4F0, 5);
        func_80022A98(D_800DC4F4, 6);
        func_80022A98(D_800DC4F8, 7);
        return;
    }
    ...
    if (temp_v0_4 != 0) {
        ...
        func_80022A98(D_800DC4DC, 0);
        temp_a0 = D_800DC4E0;
        if ((temp_a0->unk_000 & 0x100) == 0x100) {
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
? func_80022674(void *, s16, s32, s8); // extern
extern ? D_80164B40;
extern ? D_80164B50;
extern ? D_80164B60;
...
void func_80023038(s32 arg0, s8 arg1, s32 arg2, s32 arg3) {
    ...
    temp_v0 = arg1 * 2;
    sp1C = temp_v0;
    func_80022674(temp_v0 + &D_80164B40, (arg2 >> 0x10) & 0xFF, arg3, arg1);
    func_80022674(sp1C + &D_80164B50, (arg2 >> 8) & 0xFF, arg3);
    func_80022674(sp1C + &D_80164B60, arg2 & 0xFF, arg3);
}
#else
...
void func_800235AC(void *arg0, s8 arg1) {
    ...
    if (((arg0->unk0 & 0x100) == 0x100) && (arg0 == D_800DC4E4)) {
