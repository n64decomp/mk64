...
void func_80007FA4(s32 playerId, Player* player, f32 arg2) {
    ...
    if (playerId == 3) {
        if ((dist < 25.0f) && (D_80163410[playerId] < 5)) {
            ...
            (arg2 < ((2.0 * 18.0) / 216.0)) ? func_80038BE4(player, 1) : player_slope_decelerate(player, 1.0f);
        } else if ((dist < 3600.0f) && (D_80163410[playerId] < 4)) {
            D_80163410[playerId] = 3;
            (arg2 < ((5.0 * 18.0) / 216.0)) ? func_80038BE4(player, 1) : player_slope_decelerate(player, 5.0f);
        } else {
            (arg2 < ((20.0 * 18.0) / 216.0)) ? func_80038BE4(player, 10) : player_slope_decelerate(player, 1.0f);
        }
    } else {
        if ((dist < 25.0f) && (D_80163410[playerId] < 5)) {
            D_80163410[playerId] = 4;
            test = 2;
            (arg2 < ((test * 18.0) / 216.0)) ? func_80038BE4(player, 1) : player_slope_decelerate(player, 1.0f);
        } else if ((dist < 4900.0f) && (D_80163410[playerId] < 4)) {
            D_80163410[playerId] = 3;
            test = 5;
            (arg2 < ((test * 18.0) / 216.0)) ? func_80038BE4(player, 1) : player_slope_decelerate(player, 15.0f);
        } else if ((dist < 22500.0f) && (D_80163410[playerId] < 3)) {
            D_80163410[playerId] = 2;
            test = 20;
            (arg2 < ((test * 18.0) / 216.0)) ? func_80038BE4(player, 5) : player_slope_decelerate(player, 1.0f);
        } else if ((dist < 90000.0f) && (D_80163410[playerId] < 2)) {
            D_80163410[playerId] = 1;
            test = 30;
            (arg2 < ((test * 18.0) / 216.0)) ? func_80038BE4(player, 6) : player_slope_decelerate(player, 1.0f);
        } else if (D_80163410[playerId] == 0) {
            test = 35;
            (arg2 < (((test ^ 0) * 18.0) / 216.0)) ? func_80038BE4(player, 2) : player_slope_decelerate(player, 1.0f);
        } else {
            player_slope_decelerate(player, 1.0f);
        }
    }
