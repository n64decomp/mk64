...
void render_boos(s32);
void render_bat(s32);
void render_trash_bin(s32);
void func_8005285C(s32);
void func_800528EC(s32);
void render_ice_block(s32);
void func_80052D70(s32);
void func_80052E30(s32);
void render_snowman_list_2(s32);

void render_snowman_list_1(s32);
void render_snowman(s32);
void render_lakitu(s32);
void func_800534A4(s32);
void func_800534E8(s32);
void render_twomps_model(s32);
void render_twomps(s32);
void func_80053D74(s32, s32, s32);
void func_80053E6C(s32);

void render_object_for_player_smoke_train(s32, s32);
void render_train_smoke(s32);
void render_ferry_smoke_particules(s32, s32);
void render_ferries_smoke(s32);
void render_bowser_flame_particle(s32, s32);
void render_bowser_flame(s32);
void func_8005477C(s32, u8, Vec3f);
void render_smoke_particlue(s32);
