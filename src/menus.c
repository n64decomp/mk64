...
// va course order
const s16 gVACourseOrder[4][4] = {
    // mushroom cup
    { COURSE_WARIO_STADIUM, COURSE_MOO_MOO_FARM, COURSE_KOOPA_BEACH, COURSE_KALAMARI_DESERT },
    // special cup
    { COURSE_DK_JUNGLE, COURSE_YOSHI_VALLEY, COURSE_BANSHEE_BOARDWALK, COURSE_RAINBOW_ROAD },
    // star cup
    { COURSE_LUIGI_RACEWAY, COURSE_SHERBET_LAND, COURSE_ROYAL_RACEWAY, COURSE_BOWSER_CASTLE },
    // flower cup
    { COURSE_TOADS_TURNPIKE, COURSE_FRAPPE_SNOWLAND, COURSE_CHOCO_MOUNTAIN, COURSE_MARIO_RACEWAY }
};

// KA course order
const s16 gKACourseOrder[4][4] = {
    // mushroom cup
    { COURSE_LUIGI_RACEWAY, COURSE_MOO_MOO_FARM, COURSE_KOOPA_BEACH, COURSE_KALAMARI_DESERT },
    // flower cup
    { COURSE_TOADS_TURNPIKE, COURSE_FRAPPE_SNOWLAND, COURSE_CHOCO_MOUNTAIN, COURSE_MARIO_RACEWAY },
...
// KA mmf course order
const s16 gKAMMFCourseOrder[4][4] = {
    // mushroom cup
    { COURSE_LUIGI_RACEWAY, COURSE_MOO_MOO_FARM, COURSE_KOOPA_BEACH, COURSE_KALAMARI_DESERT },
    // flower cup
    { COURSE_TOADS_TURNPIKE, COURSE_FRAPPE_SNOWLAND, COURSE_CHOCO_MOUNTAIN, COURSE_MARIO_RACEWAY },
    // star cup
    { COURSE_WARIO_STADIUM, COURSE_SHERBET_LAND, COURSE_ROYAL_RACEWAY, COURSE_BOWSER_CASTLE },
    // special cup modified 
    { COURSE_DK_JUNGLE, COURSE_YOSHI_VALLEY, COURSE_BANSHEE_BOARDWALK, COURSE_MOO_MOO_FARM }
};

s16 get_course_id_for_tournament_cursor(s32 cupSelection, s32 courseIndexInCup) {
    s32 cup = cupSelection;
    s32 course = courseIndexInCup;
    ...
    if (cup == 4) {
        return gCupCourseOrder[4][course];
    }
    ...
    switch (gTournamentCourseMode) {
        case 0:
            return gVACourseOrder[cup][course];
        case 1:
            return gKACourseOrder[cup][course];
        case 2:
            return gKAMMFCourseOrder[cup][course];
        default:
            return gCupCourseOrder[cup][course];
    }
}
