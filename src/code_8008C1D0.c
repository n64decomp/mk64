...
void func_8008C8C4(void *arg0, s8 arg1) {
    ...
    if ((gModeSelection == VERSUS) && ((arg0->unk0 & 0x1000) == 0x1000) && (D_800DC51C == 0) && ((arg0->unkCA & 2) == 0) && (*(&D_801643B8 + temp_v1) != 0)) {
...
void func_8008EDC0(void *arg0) {
    ...
    if ((temp_a3->unkF8 != 0xFE) && ((temp_a3->unkBC & 8) != 8)) {
        temp_a0 = temp_a3 + 0x80;
        arg0 = temp_a3;
        move_f32_towards(temp_a0, 0, 0x3F800000, temp_a3);
    } else {
        arg0 = temp_a3;
        move_f32_towards(temp_a3 + 0x80, 0x43C80000, 0x3C23D70A, temp_a3);
    }
    if (arg0->unk80 <= 1.0f) {
...
void func_8008F008(void *arg0) {
    ...
    if ((arg0->unkF8 != 0xFC) && (temp_a0 = arg0 + 0x80, ((arg0->unkBC & 8) != 8))) {
        ...
        arg0 = temp_a3;
        move_f32_towards(temp_a3 + 0x80, 0x43960000, 0x3DCCCCCD, temp_a3);
    }
    if (arg0->unk80 <= 1.0f) {
        arg0->unkBC = arg0->unkBC & ~4;
        arg0->unk80 = 0.0f;
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit bd0364fa19633bd6201f8007e2d0a7ed87825909
s32 get_player_index_for_player(u16 *);             /* extern */
...
void func_8008FC1C(u16 *arg0) {
    ...
    if ((*arg0 & 0x40) != 0) {
        arg0 = temp_a1;
        temp_a0 = get_player_index_for_player(temp_a1);
        *arg0 = 0x7000;
