...
void func_8008C73C(Player *player, s8 arg1) {
    ...
    if (((player->unk_0BC & 0x80) != 0x80) && ((player->unk_0BC & 0x40) != 0x40)) {
        ...
        D_80165190[2][arg1] = 1;
        D_80165190[3][arg1] = 1;
        D_80165280[arg1] = player->velocity;
        D_80165480[arg1] = 0;
        D_80165460[arg1] = 0;
        D_80165440[arg1] = 0;
        D_80165420[arg1] = 0;
...
void func_8008C8C4(Player* player, s8 arg1) {
    ...
    if ((D_80165460[arg1] == 1) && ((player->unk_000 & 0x4000) == 0x4000)) {
        player->velocity = (f32) (player->velocity + 100.0f);
    }
...
void func_8008D4B4(Player* arg0) {
    arg0->velocity = (f32) arg0->maxVelocity;
    if ( arg0->boostTimer > 0) {
        --arg0->boostTimer;
    }

    if (arg0->boostTimer != 0) {
        move_f32_towards(&arg0->boostVelocity, 400.0f, 0.5f);
    } else {
        move_f32_towards(&arg0->boostVelocity, 0.0f, 0.1f);
    }
    
    if (arg0->boostVelocity <= 1.0f) {
        arg0->unk_0BC &= ~0x2000;
    }
}
#else
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit bd0364fa19633bd6201f8007e2d0a7ed87825909
? move_f32_towards(void *, s32, ?, void *);            /* extern */
extern ? gKartBoundingBoxTable;
...
void func_8008E3C0(void *arg0, ? arg1) {
    ...
    temp_a3 = arg0;
    arg0 = temp_a3;
    move_f32_towards(arg0 + 0x224, 0x3F800000, 0x3DCCCCCD, temp_a3);
    move_f32_towards(arg0 + 0x70, *(&gKartBoundingBoxTable + (arg0->unk254 * 4)), 0x3DCCCCCD, arg0);
...
void func_8008EDC0(Player* player) {
    ...
    if ((*((u16*)&player->unk_0F8) != 0xFE) && ((player->unk_0BC & 8) != 8)) {
        move_f32_towards(&player->boostVelocity, 0, 1.0f);
    } else {
        move_f32_towards(&player->boostVelocity, 400.0f, 0.01f);
    }
    if (player->boostVelocity <= 1.0f) {
        player->unk_0BC &= ~0x00100000;
        player->boostVelocity = 0.0f;
        if (player->unk_0C2 >= 0x33) {
            temp_f0 = D_800EF5A0;
            player->velocity = (player->velocity * temp_f0);
...
void func_8008F008(Player* arg0) {
    arg0->velocity = D_800E261C.unk_00[0][arg0->characterId];

    if ( ( *((u16*) arg0->unk_0F8) != 0xFC) && ((arg0->unk_0BC & 8) != 8)) {
        move_f32_towards(&arg0->boostVelocity, 0, 1.0f);
    } else {
        move_f32_towards(&arg0->boostVelocity, 300.0f, 0.1f);
    }
    
    if (arg0->boostVelocity <= 1.0f) {
        arg0->unk_0BC &= ~0x4;
        arg0->boostVelocity = 0.0f;
        arg0->velocity /= 2;
        arg0->unk_08C /= 2;
    }
}
...
void func_8008FD4C(Player* arg0, UNUSED s8 arg1) {
    s16 temp_v0;
    
    arg0->unk_00C |= 0x04000000;
    arg0->unk_044 |= 0x200;

    for (temp_v0 = 0; temp_v0 < 10; ++temp_v0) {
        *((s16*) &arg0->unk_258[28 + temp_v0 * 0x48]) = 0;
        *((s16*) &arg0->unk_258[30 + temp_v0 * 0x48]) = 0;
        *((s16*) &arg0->unk_258[18 + temp_v0 * 0x48]) = 0;
    }
}
