...
void func_800AF9E4(Vtx *arg0, s32 arg1, s32 arg2, s32 arg3, s16 arg4, s16 arg5, s32 arg6, s32 arg7) {
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (i % 2 == 0) {
            (arg0 + i)->v.ob[1] += (f32)(arg1 * arg1) * -0.07f;
        } else {
            (arg0 + i)->v.ob[1] += (f32)((arg1 + 1) * (arg1 + 1)) * -0.07f;
        }
...
#define SQ(x) ((x) * (x))
// guess on Vtx type?
void func_800AFC54(Vtx *arg0, s32 arg1, s32 arg2, s32 arg3, Vtx *arg4) {
    Vtx *a1, *a2, *a3;
    ...
    arg4->v.ob[0] = f14 * (f32)(1.0 / res) * 120.0f;
    arg4->v.ob[1] = f16 * (f32)(1.0 / res) * 120.0f;
    arg4->v.ob[2] = f18 * (f32)(1.0 / res) * 120.0f;
}
#else
