...
extern s8 gGameTypeRowSelectionForNumPlayers[5]; // 0-4 players, game type row selected for each player amount
extern s8 gGameTypeSubMenuRowSelectionForNumPlayers[4][3]; // 1-4 players, 3 possible game types per player amouunt
extern s32 gGameModeFromNumPlayersAndGameTypeRowSelection[4][3]; // 1-4 players, 3 possible game types per player amount
...
void func_800B1C40(struct Controller *arg0, s32 arg1) {
