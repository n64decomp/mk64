...
void func_8000F628(void) {
    ...
    //do {
        ...
        *var_t1 = 0;
        ...
        spE0 = var_t4;
        spDC = D_80163178[i];
        D_80163028[i] = *segmented_to_virtual_dupe_2(D_0D009418[gCurrentCourseId][gCCSelection]);
        D_801630E8[i] = 0;
        D_80163100[i] = 0;
        D_80163178[i] = 0.0f;
        D_801631A0[i] = 0.0f;
        ...
        if (gModeSelection == GRAND_PRIX) {
            //temp_v0_2 = D_80165270[var_fp];
            gGPCurrentRaceRankByPlayerId[i] = (s32) D_80165270[var_fp];
            D_801643E0[i] = (s32) D_80165270[var_fp];
        } else {
        ...
        *spA8 = -0x00000014;
        *spA4 = -0x00000014;
        D_80164478[var_s1->characterId] = (s16) i;
        *sp9C = 0.0f;
        *sp98 = 0.0f;
        spD8 = var_ra;
        spDC = var_t5;
