...
block_63:
                    ...
                    *(&D_801630E8 + sp34) = 0;
                    ...
                    if ((temp_v0_9 > 0) && (temp_v0_9 < 3) && (*(&D_80163330 + sp34) == 1) && ((s32) *(&D_8016334C + sp34) < *(gPlayerPositions + sp38))) {
                        ...
                        *var_t0 = 0x41055555;
                        ...
                        sp30 = temp_v1_3;
                        var_t0 = sp38 + &D_80163210;
                        *var_t0 = *segmented_to_virtual_dupe_dupe_2((gCurrentCourseId * 0x10) + (gCCSelection * 4) + &D_0D0096B8);
                        temp_v1_3->unk4 = -0.5f;
                    } else if (D_801645E0[D_80162FCE] > 0) {
                        var_t0 = sp38 + &D_80163210;
                        *var_t0 = *segmented_to_virtual_dupe_dupe_2((gCurrentCourseId * 0x10) + (gCCSelection * 4) + &D_0D009418);
                    } else {
                        var_t0 = sp38 + &D_80163210;
                        *var_t0 = *segmented_to_virtual_dupe_dupe_2((gCurrentCourseId * 0x10) + (gCCSelection * 4) + &D_0D009568);
                    }
                    sp3C = var_t0;
                    func_800131DC(arg0);
                    func_8000D3B8(arg0);
                ...
                *var_v0_2 = var_a1_2;
                if (((bitwise s32) *sp28 == 1) || (temp_v0_20 = (s16) *sp2C, (temp_v0_20 == 1)) || (temp_v0_20 == -1) || ((sp40->unk_0BC & 0x1000000C) != 0)) {
                    ...
                    *var_v1_3 = *segmented_to_virtual_dupe_dupe_2((gCurrentCourseId * 0x10) + (gCCSelection * 4) + &D_0D009418);
                } else {
                    sp20 = temp_t0_2;
                    var_v1_3 = sp38 + &D_80163028;
                    *var_v1_3 = *segmented_to_virtual_dupe_dupe_2((gCurrentCourseId * 0x10) + (gCCSelection * 4) + &D_0D009568);
                }
                temp_f0_5 = *temp_t0_2;
                if ((temp_f0_5 > 0.9f) || (temp_f0_5 < -0.9f)) {
                    sp34 = var_v1_3;
                    *var_v1_3 = *segmented_to_virtual_dupe_dupe_2((gCurrentCourseId * 0x10) + (gCCSelection * 4) + &D_0D009808);
                }
                if (D_80162FD0 == 1) {
                    sp34 = var_v1_3;
                    *var_v1_3 = *segmented_to_virtual_dupe_dupe_2((gCurrentCourseId * 0x10) + (gCCSelection * 4) + &D_0D0096B8);
                }
                temp_v0_21 = (s16) *sp2C;
...
void func_8000F628(void) {
    ...
    do {
        ...
        *var_t1 = 0;
        ...
        spE0 = var_t4;
        spDC = var_t5;
        *var_t2 = *segmented_to_virtual_dupe_dupe_2((gCurrentCourseId * 0x10) + (gCCSelection * 4) + &D_0D009418);
        *var_t3 = 0;
        *var_t4 = 0;
        *var_t5 = 0.0f;
        *var_ra = 0.0f;
...
void func_800100F0(s32 pathIndex) {
    ...
    if ((s32) D_800DCA4C[temp_v0] >= 0) {
        ...
        if (temp_v0 != 0x0014) {
            var_v0 = process_path_data(sp30, segmented_to_virtual_dupe_dupe_2(*(&D_800DC8D0 + ((temp_v0 * 0x10) + temp_t9))));
            var_at = &gWaypointCountByPathIndex[pathIndex];
            goto block_9;
        }
        sp1A = 1;
        temp_v0_2 = segmented_to_virtual_dupe_dupe_2(*(&gCoursePathTable + ((temp_v0 * 0x10) + temp_t9)));
        sp2C = temp_v0_2;
        var_a0 = temp_v0_2;
        var_a2 = 1;
        var_v1 = 0;
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
void *segmented_to_virtual_dupe_dupe_2(void*); // extern
...
void func_80011A5C(void) {
    ...
    do {
        temp_s0 = phi_s0 + 4;
        temp_s0->unk-4 = segmented_to_virtual_dupe_dupe_2(*phi_s1);
        phi_s1 += 4;
        phi_s0 = temp_s0;
