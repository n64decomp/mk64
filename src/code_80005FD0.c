        ...
        if ((sp4C != 0) && (sp4C != 4)) {
            if (gCurrentCourseId == 0x0014) {
                ...
                if (var_v1 > 0) {
                    ...
                    do {
                        var_a0 += 1;
                        if ((var_v0->unk_0BC & 0x80000000) == 0) {
...
#ifdef MIPS_TO_C
//generated by m2c commit bece1d6db17040749f77dbbd090363cc6fb926f9
s16 func_8000DBAC(f32 *, ? *, s32);                 /* extern */
? func_80012220(? *);                               /* extern */
extern ? D_801635A0;
extern f32 D_801635A4;
extern f32 D_801635B0;
extern ? D_801635BC;
extern ? D_801637C0;
extern ? D_801637C8;
extern ? D_801637EC;
extern ? D_80163818;
extern f32 D_8016381C;
extern f32 D_80163828;
extern s16 D_80163840;
extern ? D_80163988;
extern f32 D_8016398C;
extern ? D_80163994;
extern f32 D_80163998;
extern s16 D_801639B0;
extern ? D_80163AF8;
extern f32 D_80163AFC;
extern ? D_80163B04;
extern f32 D_80163B08;
extern s16 D_80163B20;
extern ? D_80163C68;
extern f32 D_80163C6C;
extern ? D_80163C74;
extern f32 D_80163C78;
extern s16 D_80163C90;
extern ? D_80163DE4;
s16 gCurrentCourseId;                               /* unable to generate initializer */
...
void func_800122D8(void) {
    ...
    case 11:
        ...
        sp54 = &D_801635B0;
        do {
            temp_f20 = var_s6->unk4;
            temp_f22 = var_s6->unkC;
            temp_a2 = func_8000DBAC(sp74, sp70, var_s6->unkFC);
            var_s6->unk10 = (f32) (var_s6->unk4 - temp_f20);
            var_s6->unk18 = (f32) (var_s6->unkC - temp_f22);
            vec3s_set(&spAC, 0, temp_a2, 0);
            temp_s0 = var_s6 + 0x24;
            var_s6->unk1E = func_8029EC88(sp74, &spAC, sp54, 0x000F);
            temp_s1 = temp_s0 + 4;
            if (var_s6->unk24 == 1) {
                temp_f20_2 = temp_s0->unk4;
                temp_f22_2 = temp_s0->unkC;
                temp_a2_2 = func_8000DBAC(temp_s1, temp_s0 + 0x1C, var_s6->unkFC);
                temp_s0->unk10 = (f32) (temp_s0->unk4 - temp_f20_2);
                temp_s0->unk18 = (f32) (temp_s0->unkC - temp_f22_2);
                vec3s_set(&spAC, 0, temp_a2_2, 0);
                temp_s0->unk1E = func_8029EC88(temp_s1, &spAC, temp_s0 + 0x10, 0x0010);
            }
            var_s3 = 0;
            var_s2 = sp68;
loop_8:
            temp_s0_2 = var_s2 + 0x48;
            temp_s1_2 = temp_s0_2 + 4;
            if (var_s2->unk48 == 1) {
                temp_f20_3 = temp_s0_2->unk4;
                temp_f22_3 = temp_s0_2->unkC;
                temp_a2_3 = func_8000DBAC(temp_s1_2, temp_s0_2 + 0x1C, var_s6->unkFC);
                temp_s0_2->unk10 = (f32) (temp_s0_2->unk4 - temp_f20_3);
                temp_s0_2->unk18 = (f32) (temp_s0_2->unkC - temp_f22_3);
                vec3s_set(&spAC, 0, temp_a2_3, 0);
                temp_s0_2->unk1E = func_8029EC88(temp_s1_2, &spAC, temp_s0_2 + 0x10, 0x0011);
            }
            var_s3 += 0x24;
            var_s2 += 0x24;
            if (var_s3 != 0xB4) {
    ...
    case 18:
        ...
        do {
            temp_s1_3 = var_s0 + 4;
            if (var_s0->unk0 == 1) {
                temp_f20_4 = var_s0->unk4;
                temp_f22_4 = var_s0->unkC;
                var_s0->unk24 = func_8000DBAC(temp_s1_3, var_s0 + 0x1C, var_s0->unk20);
                var_s0->unk10 = (f32) (var_s0->unk4 - temp_f20_4);
                var_s0->unk18 = (f32) (var_s0->unkC - temp_f22_4);
                vec3s_set(&sp90, 0, var_s0->unk24, 0);
                var_s0->unk1E = func_8029EC88(temp_s1_3, &sp90, var_s0 + 0x10, 0x0026);
            }
            var_s0 += 0x2C;
    ...
    case 10:
        ...
        do {
            temp_s4 = var_s0_2;
            func_80012220(var_s0_2);
            temp_v0_2 = func_8029EC88(var_s2_2, var_s3_2, var_s1, 0x0025);
            var_s1 += 0x34;
            var_s0_2 += 0x34;
            var_s2_2 += 0x34;
            var_s3_2 += 0x34;
            temp_s4->unk1E = temp_v0_2;
        } while ((u32) var_s1 < (u32) &D_80163994);
        var_s1_2 = &D_80163998;
        var_s3_3 = &D_801639B0;
        var_s2_3 = &D_8016398C;
        var_s0_3 = &D_80163988;
        do {
            temp_s4_2 = var_s0_3;
            func_80012220(var_s0_3);
            temp_v0_3 = func_8029EC88(var_s2_3, var_s3_3, var_s1_2, 0x0028);
            var_s1_2 += 0x34;
            var_s0_3 += 0x34;
            var_s2_3 += 0x34;
            var_s3_3 += 0x34;
            temp_s4_2->unk1E = temp_v0_3;
        } while ((u32) var_s1_2 < (u32) &D_80163B04);
        var_s1_3 = &D_80163B08;
        var_s3_4 = &D_80163B20;
        var_s2_4 = &D_80163AFC;
        var_s0_4 = &D_80163AF8;
        do {
            temp_s4_3 = var_s0_4;
            func_80012220(var_s0_4);
            temp_v0_4 = func_8029EC88(var_s2_4, var_s3_4, var_s1_3, 0x0029);
            var_s1_3 += 0x34;
            var_s0_4 += 0x34;
            var_s2_4 += 0x34;
            var_s3_4 += 0x34;
            temp_s4_3->unk1E = temp_v0_4;
        } while ((u32) var_s1_3 < (u32) &D_80163C74);
        var_s1_4 = &D_80163C78;
        var_s3_5 = &D_80163C90;
        var_s2_5 = &D_80163C6C;
        var_s0_5 = &D_80163C68;
        do {
            temp_s4_4 = var_s0_5;
            func_80012220(var_s0_5);
            temp_v0_5 = func_8029EC88(var_s2_5, var_s3_5, var_s1_4, 0x002C);
            var_s1_4 += 0x34;
            var_s0_5 += 0x34;
            var_s2_5 += 0x34;
            var_s3_5 += 0x34;
            temp_s4_4->unk1E = temp_v0_5;
        } while (var_s1_4 != &D_80163DE4);
        return;
    }
}
#else
...
void func_80012AC0(void) {
    ...
    var_s7 = 0;
    do {
        temp_s0 = var_s3->unk1C;
        temp_f20 = var_s3->unk4;
        temp_f22 = var_s3->unkC;
        temp_v0 = func_8000DBAC(var_s6, var_fp, var_s3->unkFC);
        temp_t0 = temp_v0;
        temp_s1 = temp_v0;
        var_s3->unk10 = (f32) (var_s3->unk4 - temp_f20);
        var_s3->unk18 = (f32) (var_s3->unkC - temp_f22);
        func_80012A48(var_s3, temp_t0);
        temp_v0_2 = var_s3->unk1C;
        if ((temp_s0 != temp_v0_2) && ((temp_v0_2 == 0x00BE) || (temp_v0_2 == 0x0140))) {
            func_800C98B8(var_s6, var_s3 + 0x10, 0x1901800EU);
        } else if (random_int(0x0064U) == 0) {
            func_800C98B8(var_s6, var_s3 + 0x10, 0x1901800DU);
        }
        temp_v0_3 = func_800061DC(var_s6, 2000.0f, var_s3->unk100);
        var_s3->unk100 = temp_v0_3;
        if ((((s16) D_80162FCC % 5) == 0) && (temp_v0_3 != 0)) {
            sp90 = var_s3->unk4;
            sp94 = (f32) ((f64) var_s3->unk8 + 65.0);
            sp98 = (f32) ((f64) var_s3->unkC + 25.0);
            func_80006114(&sp90, var_s6, temp_s1);
            func_800755FC(var_s7, &sp90, 1.1f);
        }
        temp_s0_2 = var_s3 + 0x24;
        if (var_s3->unk24 == 1) {
            temp_f20_2 = temp_s0_2->unk4;
            temp_f22_2 = temp_s0_2->unkC;
            temp_a1 = func_8000DBAC(temp_s0_2 + 4, temp_s0_2 + 0x1C, var_s3->unkFC);
            temp_s0_2->unk10 = (f32) (temp_s0_2->unk4 - temp_f20_2);
            temp_s0_2->unk18 = (f32) (temp_s0_2->unkC - temp_f22_2);
            func_80012A48(temp_s0_2, temp_a1);
        }
        var_s2 = 0;
        var_s1 = sp7C;
loop_13:
        temp_s0_3 = var_s1 + 0x48;
        if (var_s1->unk48 == 1) {
            temp_f20_3 = temp_s0_3->unk4;
            temp_f22_3 = temp_s0_3->unkC;
            temp_a1_2 = func_8000DBAC(temp_s0_3 + 4, temp_s0_3 + 0x1C, var_s3->unkFC);
            temp_s0_3->unk10 = (f32) (temp_s0_3->unk4 - temp_f20_3);
            temp_s0_3->unk18 = (f32) (temp_s0_3->unkC - temp_f22_3);
...
void func_80012DC0(s32 playerId, Player *player) {
    ...
    if (*(&D_801631E0 + (playerId * 2)) != 1) {
        ...
        if ((player->unk_0BC << 7) >= 0) {
            ...
            do {
                temp_f16 = var_s6->unk4;
                temp_f14 = var_s6->unkC;
                sp84 = temp_f16;
                ...
                if ((temp_f0 > -100.0) && (temp_f0 < 100.0)) {
                    ...
                    if ((temp_f0_2 > -100.0) && (temp_f0_2 < 100.0)) {
                        if (func_80006018(sp84, temp_f14, var_s6->unk10, var_s6->unk18, 60.0f, 20.0f, temp_f24, temp_f26) == (s32) 1U) {
                            player->unk_00C |= 0x400000;
                        }
                        temp_v0 = var_s6 + 0x24;
                        if ((var_s6->unk24 == (s16) 1U) && (func_80006018(temp_v0->unk4, temp_v0->unkC, temp_v0->unk10, temp_v0->unk18, 30.0f, 20.0f, temp_f24, temp_f26) == (s32) 1U)) {
                            player->unk_00C |= 0x400000;
                        }
                    }
                }
                ...
                var_s0 = var_s7;
loop_13:
                if (var_s0->unk48 == (s16) 1U) {
                    temp_f0_3 = (f64) (temp_f24 - var_s0->unk4C);
                    if ((temp_f0_3 > -100.0) && (temp_f0_3 < 100.0)) {
                        temp_f0_4 = (f64) (temp_f26 - var_s0->unk54);
                        if (temp_f0_4 > -100.0) {
                            temp_v0_2 = var_s0 + 0x48;
                            if ((temp_f0_4 < 100.0) && (func_80006018(temp_v0_2->unk4, temp_v0_2->unkC, temp_v0_2->unk10, temp_v0_2->unk18, 30.0f, 20.0f, temp_f24, temp_f26) == (s32) 1U)) {
                                player->unk_00C |= 0x400000;
                            }
                        }
                    }
...
#ifdef MIPS_TO_C
//generated by m2c commit bece1d6db17040749f77dbbd090363cc6fb926f9
? func_8000DBAC(f32 *, void *, f32);                /* extern */
...
void func_800133C4(void) {
    ...
    do {
        temp_s2 = var_s0 + 4;
        if (var_s0->unk0 == 1) {
            temp_f26 = var_s0->unk4;
            temp_f28 = var_s0->unk8;
            temp_f30 = var_s0->unkC;
            func_8000DBAC(temp_s2, var_s0 + 0x1C, var_s0->unk20);
            temp_v0 = func_800061DC(temp_s2, 2000.0f, var_s0->unk28);
            var_s0->unk28 = temp_v0;
            if ((((s16) D_801630FC % 10) == 0) && (temp_v0 != 0)) {
                sp78 = (f32) ((f64) var_s0->unk4 - 30.0);
                sp7C = (f32) ((f64) var_s0->unk8 + 180.0);
                sp80 = (f32) ((f64) var_s0->unkC + 45.0);
                func_80006114(&sp78, temp_s2, var_s0->unk24);
            ...
            sp98 = temp_f28;
            sp9C = temp_f30;
            temp_v0_2 = (((s32) (var_s0->unk1C + 5) % (s32) D_8016359C) * 4) + D_80163598;
            sp88 = (f32) temp_v0_2->unk0;
            sp8C = (f32) D_80162EB0;
            sp90 = (f32) temp_v0_2->unk2;
            temp_a1 = func_80005FD0(&sp94, &sp88) - var_s0->unk24;
            var_v1 = temp_a1;
            if (temp_a1 < 0) {
                var_v1 = temp_a1 * -1;
            }
            if (var_v1 >= 0x1771) {
                temp_f0 = (f64) var_s0->unk20;
                if (temp_f0 > 0.2) {
                    var_s0->unk20 = (f32) (temp_f0 - 0.04);
                }
                if (var_v1 >= 0x3D) {
                    var_v1 = 0x003C;
                }
            } else {
                temp_f0_2 = (f64) var_s0->unk20;
                if (temp_f0_2 < 2.0) {
                    var_s0->unk20 = (f32) (temp_f0_2 + 0.02);
                }
                if (var_v1 >= 0x1F) {
                    var_v1 = 0x001E;
                }
            ...
            if (temp_a1 >= 0x8000) {
                var_s0->unk24 = (s16) (var_s0->unk24 - var_v1);
            } else if (temp_a1 > 0) {
                var_s0->unk24 = (s16) (var_s0->unk24 + var_v1);
            ...
            temp_f0_3 = var_s0->unk4;
            var_s0->unk10 = (f32) (temp_f0_3 - temp_f26);
            var_s0->unk14 = (f32) (var_s0->unk8 - temp_f28);
            var_s0->unk18 = (f32) (var_s0->unkC - temp_f30);
            temp_v0_3 = &gActorList[var_s0->unk1E];
            temp_v0_3->pos[0] = temp_f0_3;
            temp_v0_3->pos[1] = var_s0->unk8;
            temp_v0_3->pos[2] = var_s0->unkC;
            if (gIsMirrorMode != 0) {
                temp_v0_3->rot[1] = -var_s0->unk24;
            } else {
                temp_v0_3->rot[1] = var_s0->unk24;
            }
            temp_v0_3->velocity[0] = var_s0->unk10;
            temp_v0_3->velocity[1] = var_s0->unk14;
            temp_v0_3->velocity[2] = var_s0->unk18;
        }
        var_s3 += 1;
        var_s0 += 0x2C;
    } while (var_s3 != 1);
...
void func_80013854(Player *player) {
    ...
    if (((temp_v0 << 7) >= 0) && ((temp_v0 << 6) >= 0)) {
        ...
        do {
            if (var_s0->unk0 == 1) {
                temp_f12 = var_s0->unk4;
                temp_f14 = var_s0->unkC;
                temp_f24 = var_f18 - var_s0->unk8;
                ...
                if ((temp_f0 > -300.0) && (temp_f0 < 300.0)) {
                    ...
                    if ((temp_f0_2 > -300.0) && (temp_f0_2 < 300.0)) {
                        sp70 = var_f18;
                        if ((func_80006018(temp_f12, temp_f14, var_s0->unk10, var_s0->unk18, 200.0f, 60.0f, temp_f26, temp_f28) == (s32) 1) && ((f64) temp_f24 < 60.0)) {
...
void func_80013D20(void *arg0) {
    ...
    if (temp_f2 < temp_f0_2) {
        arg0->unk24 = (f32) ((f64) temp_f2 + 0.06);
        if (temp_f0_2 < arg0->unk24) {
            arg0->unk24 = temp_f0_2;
        }
    }
    if (temp_f0_2 < arg0->unk24) {
        arg0->unk24 = (f32) ((f64) arg0->unk24 - 0.06);
        if (arg0->unk24 < temp_f0_2) {
            arg0->unk24 = temp_f0_2;
        }
    }
    if (D_8016347A == 0) {
        var_a1 = func_8000D6D0(arg0 + 4, arg0 + 0x1C, arg0->unk20, arg0->unk24, 0, 3);
    } else {
        var_a1 = func_8000D940(arg0 + 4, arg0 + 0x1C, arg0->unk20, arg0->unk24, 0);
    }
    func_800224F0(arg0 + 0x2A, var_a1, 0x64);
    temp_f0_3 = arg0->unk4 - sp5C;
    temp_f2_2 = arg0->unkC - sp54;
    sp34 = arg0->unk8;
    sp38 = 0.0f;
    sp3C = sqrtf((temp_f0_3 * temp_f0_3) + (temp_f2_2 * temp_f2_2));
    func_800224F0(arg0 + 0x28, (s16) (func_802B5224(&sp40, &sp34) * -1), 0x64);
    temp_f0_4 = arg0->unk4;
    arg0->unk10 = (f32) (temp_f0_4 - sp5C);
    temp_v1 = &gActorList[arg0->unk1E];
    arg0->unk14 = (f32) (arg0->unk8 - sp58);
    arg0->unk18 = (f32) (arg0->unkC - sp54);
    temp_v1->pos[0] = temp_f0_4;
    temp_v1->pos[1] = arg0->unk8;
    temp_v1->pos[2] = arg0->unkC;
    temp_v1->rot[0] = arg0->unk28;
    if (gIsMirrorMode != 0) {
        temp_v1->rot[1] = -arg0->unk2A;
    } else {
        temp_v1->rot[1] = arg0->unk2A;
    }
    temp_v1->rot[2] = arg0->unk2C;
    temp_v1->velocity[0] = arg0->unk10;
    temp_v1->velocity[1] = arg0->unk14;
    temp_v1->velocity[2] = arg0->unk18;
}
#else
...
void func_80013F7C(s32 playerId, Player *player, void *arg2, f32 arg3, f32 arg4, s32 arg5, u32 arg6) {
    ...
    temp_s7 = playerId * 2;
    var_s0 = arg2;
    if (((*(&D_801631E0 + temp_s7) != 1) || ((temp_v0 = player->unk_000, ((temp_v0 & 0x4000) != 0)) && ((temp_v0 & 0x1000) == 0))) && ((player->unk_0BC << 7) >= 0)) {
        spC4 = player->pos[0];
        var_fp = 0;
        spC0 = player->pos[1];
        spBC = player->pos[2];
            ...
            do {
                ...
                if ((temp_f20 > -100.0) && (temp_f20 < 100.0)) {
                    ...
                    if ((temp_f0 > -20.0) && (temp_f0 < 20.0)) {
                        ...
                        if ((temp_f0_2 > -100.0) && (temp_f0_2 < 100.0) && (func_80006018(temp_f12, temp_f14, var_s0->unk10, var_s0->unk18, arg3, arg4, spC4, spBC) == (s32) 1U)) {
                            player->unk_00C |= 0x400000;
                        }
                    }
                }
                ...
                if (((temp_v0_2 & 0x4000) != 0) && ((temp_v0_2 & 0x1000) == 0)) {
                    ...
                    if ((temp_f20 > -300.0) && (temp_f20 < 300.0) && (temp_f0_3 = (f64) temp_f22, (temp_f0_3 > -20.0)) && (temp_f0_3 < 20.0) && (temp_f0_4 = (f64) temp_f24, (temp_f0_4 > -300.0)) && (temp_f0_4 < 300.0)) {
                        ...
                        if ((temp_v0_3 > 0) && (var_s0->unk30 == 0)) {
                            D_801631C8 = temp_v0_3 - 1;
                            var_s0->unk30 = (s8) (var_s0->unk30 | temp_s2);
                            func_800C9D80(var_s0 + 4, var_s0 + 0x10, arg6);
                        }
                    } else {
                        temp_v0_4 = var_s0->unk30;
                        if (temp_v0_4 != 0) {
                            var_s0->unk30 = (s8) (temp_v0_4 & ~temp_s2);
                            if (var_s0->unk30 == 0) {
                                D_801631C8 += 1;
                                func_800C9EF4(var_s0 + 4, arg6);
                            }
                        }
                    }
                    if ((temp_f20 > -200.0) && (temp_f20 < 200.0) && (temp_f0_5 = (f64) temp_f22, (temp_f0_5 > -20.0)) && (temp_f0_5 < 20.0) && (temp_f0_6 = (f64) temp_f24, (temp_f0_6 > -200.0)) && (temp_f0_6 < 200.0)) {
                        if ((var_s0->unk31 & temp_s2) == 0) {
                            ...
                            case 0:
                                ...
                                temp_v0_6 = func_80007BF8(var_s0->unk1C, gNearestWaypointByPlayerId[playerId], 0x000AU, 0U, (u16) (s32) temp_v0_5);
                                temp_v1_2 = *sp9C;
                                if ((temp_v1_2 == 0) && (temp_v0_6 > 0) && (player->unk_094 < var_s0->unk20)) {
                                    var_s1 = 1;
                                }
                                ...
                                break;
                            case 1:
                                if (func_80007BF8(var_s0->unk1C, gNearestWaypointByPlayerId[playerId], 0U, 0x000AU, (u16) (s32) temp_v0_5) > 0) {
                                    if (random_int(2U) == 0) {
                                        temp_v1_3 = *(&D_80163270 + temp_s7);
                                        if (temp_v1_3 == 0) {
                                            var_s1 = 1;
                                        }
                                        if ((temp_v1_3 == 1) && (player->unk_094 < var_s0->unk20)) {
                                            var_s1 = 1;
                                        }
                                    } else {
                                        var_s0->unk31 = (s8) (var_s0->unk31 | temp_s2);
                                    }
                                }
                                break;
                            }
                            if (var_s1 == 1) {
                                ...
                                var_s0->unk31 = (s8) (var_s0->unk31 | temp_s2);
                                func_800C98B8(var_s0 + 4, sp84, var_a2);
                            }
                        }
                    } else {
                        temp_v0_7 = var_s0->unk31;
                        if ((temp_v0_7 & temp_s2) != 0) {
                            var_s0->unk31 = (s8) (temp_v0_7 & ~temp_s2);
                        }
                    }
                }
                var_fp += 1;
...
void func_800146B8(s32 playerId, s32 arg1, void *arg2) {
    s16 var_v1;
    s32 var_a2;
    s32 var_v0;
    u16 temp_a1;
...
loop_3:
        temp_a1 = var_s0->unk1C;
        var_v0 = 0;
        var_v1 = D_80162FCE;
loop_4:
        var_v0 += 3;
        if (temp_a1 == (var_v1 % (s32) *gWaypointCountByPathIndex)) {
            *(&D_801634FC + (playerId * 0x10)) = func_800145A8(var_s0->unk2E, D_80163068[playerId], (s16) temp_a1);
            return;
        }
        var_v1 += 3;
        if (var_v0 == 0x18) {
...
void func_80014D30(s32 cameraId, s32 pathIndex) {
    ...
    temp_v0 = &D_80164550[wayPointIndex][*(&D_80164668 + (cameraId * 2))];
    func_802ADDC8((cameraId * 0xB8) + 0x54 + cameras, 10.0f, (f32) temp_v0->wayPointX, (f32) temp_v0->wayPointY + 30.0f, (f32) temp_v0->wayPointZ);
}
#else
...
extern ? D_80164638;
extern ? D_80164648;
extern ? gNearestWaypointByCameraId;
extern ? D_80164688;
extern ? cameras;
...
void func_80015544(s32 arg0, f32 arg1, s32 arg2, s16 arg3) {
    ...
    temp_t7 = arg2 * 4;
    temp_hi = (*(&gNearestWaypointByPlayerId + (arg0 * 2)) + 0xA) % *(&gWaypointCountByPathIndex + (arg3 * 2));
    *(&D_80164688 + temp_t7) = arg1;
    temp_v1 = (arg2 * 2) + &gNearestWaypointByCameraId;
    *temp_v1 = temp_hi;
    sp28 = temp_v1;
    sp2C = temp_t7;
...
void func_8001577C(void *arg0, ? arg1, ? arg2, s32 arg3) {
    ...
    temp_v1 = arg0->unkAE;
    temp_t1 = temp_v1 * 2;
    temp_a1 = *(&gPathIndexByPlayerId + temp_t1);
    temp_v0 = arg3 * 2;
    temp_t0 = temp_v0 + &gNearestWaypointByCameraId;
    sp34 = temp_t0;
    sp38 = temp_v0;
    sp3C = temp_t1;
    sp74 = temp_v1;
    ...
    *temp_t0 = func_8000D33C(arg0->unk0, arg0->unk4, temp_a1, arg0->unk8, *temp_t0, temp_a1);
    temp_t2 = *(&gNearestWaypointByPlayerId + temp_t1);
    temp_t3 = *temp_t0;
    sp8C = temp_t2;
    sp8E = temp_t3;
    if (func_80007BF8(temp_t2 & 0xFFFF, temp_t3 & 0xFFFF, 0x32, 0xF, *(&gWaypointCountByPathIndex + (sp44 * 2))) <= 0) {
        temp_v1_2 = arg3 * 4;
        sp3C = temp_v1_2;
...
void func_80015A9C(s32 arg0, f32 arg1, s32 arg2, s16 arg3) {
    ...
    *temp_v1 = *(&gNearestWaypointByPlayerId + (arg0 * 2)) + 0xA;
    temp_t3 = *temp_v1 % *(&gWaypointCountByPathIndex + (temp_a3 * 2));
    *temp_v1 = temp_t3;
    temp_a2 = temp_a3;
    sp20 = temp_t8;
    sp1C = temp_v1;
...
void func_80015C94(void *arg0, ? arg1, ? arg2, s32 arg3) {
    ...
    D_80163238 = temp_v1;
    temp_s1 = temp_v1 * 2;
    temp_t1 = *(&gPathIndexByPlayerId + temp_s1);
    temp_v0 = arg3 * 2;
    temp_a1 = temp_v0 + &gNearestWaypointByCameraId;
    ...
    *sp58 = func_8000D33C(arg0->unk0, arg0->unk4, temp_a1, arg0->unk8, *temp_a1, temp_t1);
    temp_t2 = (sp68 * 2) + &gWaypointCountByPathIndex;
    sp54 = temp_t2;
    if (func_80007BF8(*(&gNearestWaypointByPlayerId + temp_s1) & 0xFFFF, *sp58 & 0xFFFF, 0x32, 0xF, *temp_t2) <= 0) {
        temp_s1_2 = arg3 * 4;
...
void func_800162CC(s32 arg0, f32 arg1, s32 arg2, s16 arg3) {
    ...
    temp_t8 = arg2 * 4;
    temp_a3 = arg3;
    temp_t0 = (arg2 * 2) + &gNearestWaypointByCameraId;
    *(&D_80164688 + temp_t8) = arg1;
    *temp_t0 = *(&gNearestWaypointByPlayerId + (arg0 * 2));
    temp_t9 = *temp_t0 % *(&gWaypointCountByPathIndex + (arg3 * 2));
    *temp_t0 = temp_t9;
    temp_a2 = temp_a3;
    sp1C = temp_t0;
    sp20 = temp_t8;
...
void func_80016494(void *arg0, u16 *arg1, s8 arg2, s32 arg3) {
    ...
    *temp_t5 = temp_f2 + ((*temp_t4 - temp_f2) * 0.5f);
    ...
    temp_t0 = temp_v1 * 2;
    temp_t3 = *(&gPathIndexByPlayerId + temp_t0);
    temp_ra = temp_v1 * 0xDD8;
    temp_v0 = arg3 * 2;
    temp_t1 = temp_v0 + &gNearestWaypointByCameraId;
    sp4C = temp_ra;
    ...
    *sp44 = func_8000D33C(arg0->unk0, arg0->unk4, temp_a1, arg0->unk8, *temp_t1, (s32) temp_t3);
    ...
    temp_t3_2 = *sp44;
    temp_t7 = (sp68 * 2) + &gWaypointCountByPathIndex;
    temp_f2_3 = temp_f2_2 * temp_f2_2;
    sp38 = temp_t7;
    temp_t2 = *(&gNearestWaypointByPlayerId + temp_t0);
    sp3C = temp_t5_2;
    sp64 = temp_f2_3;
    sp40 = temp_t1_2;
    spB6 = temp_t3_2;
...
void func_80016C3C(s32 arg0, ? arg1, s32 arg2) {
    ...
    *temp_v1 = 0;
    ...
    temp_s1 = (arg2 * 2) + &gNearestWaypointByCameraId;
    temp_s0 = *(&gWaypointCountByPathIndex + (*(phi_a3 + &D_80163DD8) * 2));
...
void func_80017054(void *arg0, ? arg1, ? arg2, s32 arg3) {
    ...
    *temp_t1 = temp_f2 + ((*(&D_80164658 + temp_t6) - temp_f2) * 0.5f);
    temp_t0 = (arg3 * 2) + &gNearestWaypointByCameraId;
    D_80163238 = arg0->unkAE;
    temp_a3 = *temp_t0;
    sp58 = *(&gWaypointCountByPathIndex + (temp_t2 * 2));
    sp56 = temp_a3;
    sp48 = temp_t1;
    sp40 = temp_t0;
    sp44 = temp_a1;
...
void func_80017720(s32 arg0, ? arg1, s32 arg2, s16 arg3) {
    ...
    *temp_t0 = *(&gNearestWaypointByPlayerId + (arg0 * 2)) + 3;
    temp_t3 = *temp_t0 % *(&gWaypointCountByPathIndex + (temp_a3 * 2));
    *temp_t0 = temp_t3;
    temp_a2 = temp_a3;
    sp18 = temp_t0;
    sp1C = temp_t8;
...
void func_800178F4(void *arg0, u16 *arg1, s8 arg2, s32 arg3) {
    ...
    *temp_t6 = temp_f16 + ((*temp_v1 - temp_f16) * 0.5f);
    temp_ra = *(&gPathIndexByPlayerId + temp_t2);
    D_80163238 = (s32) temp_v0;
    sp4C = (s32) *(&gWaypointCountByPathIndex + (temp_ra * 2));
    temp_t8 = arg3 * 2;
    temp_t1 = temp_t8 + &gNearestWaypointByCameraId;
    sp50 = (s32) temp_ra;
    ...
    *sp28 = func_8000D33C(arg0->unk0, arg0->unk4, temp_a1, arg0->unk8, *temp_t1, (s32) temp_ra);
    temp_t1_2 = *sp28;
    temp_hi = (s32) (*(&gNearestWaypointByPlayerId + temp_t2) + 3) % sp4C;
    sp9C = (s16) temp_hi;
    sp9E = temp_t1_2;
...
void func_80017F10(s32 arg0, ? arg1, s32 arg2, s16 arg3) {
    ...
    temp_a3 = arg3;
    temp_v0 = *(&gWaypointCountByPathIndex + (arg3 * 2));
    temp_f0 = *(&D_80163068 + (arg0 * 4));
    temp_t9 = arg2 * 4;
    temp_t0 = (arg2 * 2) + &gNearestWaypointByCameraId;
    *(&D_80164688 + temp_t9) = temp_f0;
    *temp_t0 = (*(&gNearestWaypointByPlayerId + (arg0 * 2)) + temp_v0) - 2;
...
void func_800180F0(void *arg0, u16 *arg1, s8 arg2, s32 arg3) {
    ...
    *temp_t6 = temp_f16 + ((*temp_v1 - temp_f16) * 0.5f);
    D_80163238 = (s32) temp_v0;
    temp_ra = *(&gPathIndexByPlayerId + temp_t2);
    temp_t4 = &gWaypointCountByPathIndex + (temp_ra * 2);
    temp_t4_2 = *temp_t4;
    temp_t6_2 = arg3 * 2;
    temp_t3 = temp_v0 * 0xDD8;
    temp_t1 = temp_t6_2 + &gNearestWaypointByCameraId;
    sp50 = (s32) temp_ra;
    sp28 = temp_t1;
    sp30 = temp_t3;
    sp2C = temp_t6_2;
    ...
    *sp28 = func_8000D33C(arg0->unk0, arg0->unk4, temp_a1, arg0->unk8, *temp_t1, (s32) temp_ra);
    temp_t1_2 = *sp28;
    temp_hi = (s32) ((*(&gNearestWaypointByPlayerId + temp_t2) + temp_t4_2) - 2) % (s32) temp_t4_2;
    sp9C = (s16) temp_hi;
    sp9E = temp_t1_2;
...
void func_80018718(s32 arg0, ? arg1, s32 arg2, s16 arg3) {
    ...
    temp_f0 = *(&D_80163068 + (arg0 * 4));
    temp_t9 = arg2 * 4;
    temp_hi = ((*(&gNearestWaypointByPlayerId + (arg0 * 2)) + temp_v0) - 5) % temp_v0;
    *(&D_80164688 + temp_t9) = temp_f0;
    temp_t0 = (arg2 * 2) + &gNearestWaypointByCameraId;
    *temp_t0 = temp_hi;
    sp18 = temp_t0;
...
void func_800188F4(void *arg0, ? arg1, ? arg2, s32 arg3) {
    ...
    temp_a1 = arg0->unkAE;
    temp_v0 = temp_a1 * 2;
    temp_t7 = *(&gPathIndexByPlayerId + temp_v0);
    sp68 = temp_t7;
    temp_f12 = *(&gPlayers + 0x94 + (temp_a1 * 0xDD8));
    temp_t2 = &gWaypointCountByPathIndex + (temp_t7 * 2);
    temp_t4 = arg3 * 4;
    temp_t2_2 = *temp_t2;
    temp_t5 = temp_t4 + &D_80164648;
    *temp_t5 = temp_f12;
    if (D_8016448C == 0) {
        temp_t8 = temp_v0 + &gNearestWaypointByPlayerId;
        temp_t9 = arg3 * 2;
        temp_t3 = temp_t9 + &gNearestWaypointByCameraId;
        sp3C = temp_t8;
        temp_a3 = *temp_t3;
        phi_ra = temp_t9;
        phi_t3 = temp_t3;
        ...
        temp_t8_2 = temp_v0 + &gNearestWaypointByPlayerId;
        temp_t9_2 = arg3 * 2;
        temp_t3_2 = temp_t9_2 + &gNearestWaypointByCameraId;
        sp3C = temp_t8_2;
        temp_t0 = *temp_t3_2;
        phi_ra = temp_t9_2;
        phi_t3 = temp_t3_2;
...
void func_80019118(s32 arg0, f32 arg1, s32 arg2, ? arg3) {
    ...
    temp_t6 = arg2 * 4;
    temp_v0 = (arg2 * 2) + &gNearestWaypointByCameraId;
    *(&D_80164688 + temp_t6) = arg1;
    *temp_v0 = *(&gNearestWaypointByPlayerId + (arg0 * 2)) + 0xC;
    temp_t5 = *temp_v0 % gWaypointCountByPathIndex;
    *temp_v0 = temp_t5;
    sp2C = temp_t6;
    sp28 = temp_v0;
...
void func_8001933C(void *arg0, ? arg1, ? arg2, s32 arg3) {
    ...
    temp_v1 = arg0->unkAE;
    temp_t2 = temp_v1 * 2;
    temp_a1 = *(&gPathIndexByPlayerId + temp_t2);
    sp44 = *(&gWaypointCountByPathIndex + (temp_a1 * 2));
    temp_v0 = arg3 * 2;
    temp_t0 = temp_v0 + &gNearestWaypointByCameraId;
    sp34 = temp_t0;
    sp38 = temp_v0;
    ...
    *temp_t0 = func_8000D33C(arg0->unk0, arg0->unk4, temp_a1, arg0->unk8, *temp_t0, 0);
    temp_t3 = *temp_t0;
    sp96 = temp_t3;
    if (func_80007BF8(*(&gNearestWaypointByPlayerId + temp_t2) & 0xFFFF, temp_t3 & 0xFFFF, 0x32, 0x14, sp44) <= 0) {
        temp_v1_2 = arg3 * 4;
        sp3C = temp_v1_2;
...
void func_8001969C(s32 arg0, ? arg1, s32 arg2, ? arg3) {
    ...
    temp_v0 = arg2 * 2;
    temp_v1 = temp_v0 + &gNearestWaypointByCameraId;
...
void func_80019760(void *arg0, ? arg1, ? arg2, s32 arg3) {
    ...
    temp_v1 = (*(&gNearestWaypointByCameraId + (arg3 * 2)) * 8) + D_80164550;
...
void func_80019890(s16 arg0, s32 cameraId) {
    ...
    *(&D_801646C0 + temp_t0) = 0;
    ...
    sp20 = temp_t4;
    temp_t5 = *temp_t4;
    temp_s1 = *(&gPathIndexByPlayerId + (arg0 * 2));
    switch (temp_t5) {
    case 0:
    ...
    *(&gNearestWaypointByCameraId + sp24) = func_8000BD94(sp28->unk0, sp28->unk4, sp28->unk8, temp_s1);
    if (*sp20 == 9) {
...
void func_80019DF4(void) {
    ...
    camera1->unkAE = gGPCurrentRacePlayerIdByRank;
    D_80164678 = 1;
    D_801646CC = 2;
}
#else
...
void func_80019ED0(void) {
    ...
    gGPCurrentRacePlayerIdByRank = temp_v0_2;
...
void func_8001A348(s32 arg0, f32 arg1, ? arg2) {
    ...
    temp_a0 = *(&gNearestWaypointByCameraId + temp_v1);
    sp1C = temp_v1;
    arg0 = temp_a3;
    sp20 = temp_t7;
    *temp_at = arg1;
...
void func_8001A450(s32 arg0, s32 arg1, s32 arg2) {
    ...
    temp_a3 = arg0;
    if (((*(&gPlayers + 0xBC + (arg0 * 0xDD8)) & 0x1000000C) == 0) && ((temp_t9 = arg1 * 2, temp_a2 = temp_t9 + &D_80164680, temp_v1 = *temp_a2, sp18 = temp_a2, arg0 = temp_a3, sp24 = temp_v1, temp_v0 = func_8001A310(*(&gNearestWaypointByCameraId + temp_t9), (temp_v1 + 1) % 0xA, temp_a2, temp_a3), (temp_v0 != temp_v1)) || (arg2 != arg0))) {
        *temp_a2 = temp_v0;
...
block_194:
        ...
        case 1:                                     /* switch 1 */
            if ((gLapCountByPlayerId[playerId] > 0) && (temp_v1_2 = D_80163478, temp_a0 = *(&gPlayerPositions + (temp_v1_2 * 4)), ((temp_a0 < *(&gPlayerPositions + (playerId * 4))) != 0)) && (temp_a0 == 0)) {
                ...
                if (temp_v0_2 != 4) {
                    if (temp_v0_2 != 6) {
                        if (func_80007BF8(*(&gNearestWaypointByPlayerId + (playerId * 2)), *(&gNearestWaypointByPlayerId + (temp_v1_2 * 2)), 0xA, 2, D_80164430) > 0) {
                            temp_s0->unk0 = 0x22;
                        }
                    } else if (func_80007BF8(*(&gNearestWaypointByPlayerId + (playerId * 2)), *(&gNearestWaypointByPlayerId + (temp_v1_2 * 2)), 4, 2, D_80164430) > 0) {
                        temp_s0->unk0 = 0x22;
                    }
                } else if (func_80007BF8(*(&gNearestWaypointByPlayerId + (playerId * 2)), *(&gNearestWaypointByPlayerId + (temp_v1_2 * 2)), 0x28, 2, D_80164430) > 0) {
                    temp_s0->unk0 = 0x22;
                }
            } else if (temp_a1 == 1) {
        ...
        case 34:                                    /* switch 1 */
            ...
            if ((temp_v1_4 >= 0) && (temp_v1_4 < 0x64)) {
                ...
                temp_a2 = D_80163478;
                temp_t7 = temp_a2 * 2;
                temp_v0_3 = (((*(&gNearestWaypointByPlayerId + temp_t7) + 0x1E) % *(&gWaypointCountByPathIndex + ((&gPathIndexByPlayerId)[temp_a2] * 2))) * 8) + *(&D_80164550 + (gPathIndexByPlayerId * 4));
...
extern s16 gPathIndexByPlayerId;
...
void func_8001BE78(void) {
    ...
    phi_s5 = 0;
    phi_s2 = 0;
    phi_s6 = &gPathIndexByPlayerId;
    phi_s4 = &D_801634F8;
    phi_s3 = &gNearestWaypointByPlayerId;
    phi_s7 = &D_80164550;
    phi_v0 = &D_80163410;
    phi_fp = &D_80164590;
    do {
