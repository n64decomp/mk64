...
void set_places(void) {
    ...
    for (var_t3 = 0; var_t3 < var_t4 - 1; var_t3++) {
        if ((gPlayers[gGPCurrentRacePlayerIdByRank[var_t3]].unk_000 & 0x800)) continue;
        ...
        for (var_t1_3 = var_t3 + 1; var_t1_3 < var_t4; var_t1_3++) {
            if (gCourseCompletionPercentByRank[var_t3] < gCourseCompletionPercentByRank[var_t1_3]) {
                if (!(gPlayers[gGPCurrentRacePlayerIdByRank[var_t1_3]].unk_000 & 0x800)) {
                    temp_s2 = sp80[var_t3];
        ...
        case 2:
            if (gModeSelection != 0) {
                for (i = 0; i < NUM_TRAINS; i++) {
                    ...
                    sTrains[i].numCars = NUM_2P_PASSENGER_CARS;
                }
            }
            break;
...
void func_80019890(s32 playerId, s32 cameraId) {
    ...
    switch (D_80164680[cameraId]) {
        case 0:
            ...
            break;
        case 2:
            func_80015544(playerId, -1.0f, cameraId, temp_s1);
            break;
        case 3:
            func_80015544(playerId, 1.0f, cameraId, temp_s1);
            break;
        case 6:
            func_80015A9C(playerId, -0.6f, cameraId, (s16) temp_s1);
            break;
        case 7:
            func_80015A9C(playerId, 0.6f, cameraId, (s16) temp_s1);
            break;
        case 4:
            func_800162CC(playerId, -1.0f, cameraId, (s16) temp_s1);
            break;
        case 5:
            func_800162CC(playerId, 1.0f, cameraId, (s16) temp_s1);
            break;
        case 9:
            ...
            break;
        case 1:
            func_80017720(playerId, 0.0f, cameraId, (s16) temp_s1);
            break;
        case 14:
            func_80017F10(playerId, 0.0f, cameraId, (s16) temp_s1);
            break;
        case 8:
            func_80018718(playerId, 0.0f, cameraId, (s16) temp_s1);
            break;
        case 12:
            func_80019118(playerId, -1.0f, cameraId, (s16) temp_s1);
            break;
        case 13:
            func_80019118(playerId, 1.0f, cameraId, (s16) temp_s1);
            break;
        case 15:
            func_8001969C(playerId, -1.0f, cameraId, (s16) temp_s1);
            break;
        case 16:
            func_8001969C(playerId, 1.0f, cameraId, (s16) temp_s1);
            break;
    ...
    gNearestWaypointByCameraId[cameraId] = func_8000BD94(camera->pos[0], camera->pos[1], camera->pos[2], (s32) temp_s1);
    if ((s16) D_80164680[cameraId] == 9) {
        D_80163DD8[cameraId] = (s32) temp_s1;
    }
}
