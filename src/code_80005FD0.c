...
//extern s32 D_80163984;
extern somestruct D_80163818[];
...
void func_800139E4(f32 arg0, f32 arg1, s32 arg2, f32 arg3, somestruct *arg4, struct TrackWayPoint *arg5);
...
void func_80013D20(void*); // extern

void func_8001487C(void) {
    s32 loopIndex;
    for(loopIndex = 0; loopIndex < 7; loopIndex++) {
        func_80013D20(&D_80163818[loopIndex]);
    }
}
...
extern somestruct D_80163988[];

void func_800149D0(void) {
    s32 i;

    for (i = 0; i < 7; i++) {
        func_80013D20(&D_80163988[i]);
    }
}
...
extern somestruct D_80163AF8[];

void func_80014B24(void) {
    s32 i;

    for (i = 0; i < 7; i++) {
        func_80013D20(&D_80163AF8[i]);
    }
}
...
extern somestruct D_80163C68[];

void func_80014C78(void) {
    s32 i;

    for (i = 0; i < 7; i++) {
        func_80013D20(&D_80163C68[i]);
    }
}
...
void func_80015390(Camera *camera, s32 arg1, s32 arg2) {
    ...
    if (!(temp_v0_2 & 0x80) && !(temp_v0_2 & 0x40)) {
        func_800224F0(&camera->unk_2C, temp_s1->unk_02E, var_a2);
    }
