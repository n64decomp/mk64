...
char *D_800EC594 = "�����ȥ����Ȥ����ͤ��ޤ���������  (%d)\n";
char *D_800EC5C0 = "<<< ITEM OBJ NUMBER ERR !! >>> item %d  obj_num %d \n";
// <<< BANANA SET HOUSE >>> obj_num %d zure %f
char *D_800EC5F8 = "<<< BANANA SET ���� >>> obj_num %d   zure %f \n";
// BANANA Caught in owner check. (num %d)
char *D_800EC628 = "BANANA ��ͭ�ԥ����å��˰��óݤ���ޤ�����(num %d)\n";
// Reason: EXISTOBJ
char *D_800EC65C = "��ͳ: EXISTOBJ \n";
// Reason: category
char *D_800EC670 = "��ͳ: category \n";
// Reason: sparam
char *D_800EC684 = "��ͳ: sparam \n";
// Reason: num
char *D_800EC694 = "��ͳ: num \n";
char *D_800EC6A0 = "BANANA HOLD (num %d  time %d   hold_time %d)\n";
// Installation Caught in BANANA owner check. (num %d)
char *D_800EC6D0 = "���� BANANA ��ͭ�ԥ����å��˰��óݤ���ޤ�����(num %d)\n";
// Reason: EXISTOBJ
char *D_800EC708 = "��ͳ: EXISTOBJ \n";
// Reason: category
char *D_800EC71C = "��ͳ: category \n";
// Reason: sparam
char *D_800EC730 = "��ͳ: sparam \n";
// Reason: num
char *D_800EC740 = "��ͳ: num \n";
// I put BANANA. (num %d)
char *D_800EC74C = "BANANA �֤��ޤ����� (num %d)\n";
// <<< BANANA NAGE SET failed >>> obj_num %d
char *D_800EC76C = "<<< BANANA NAGE SET ���� >>> obj_num %d \n";
// BANANA NAGE MOVE Caught in owner check. (num %d)
char *D_800EC798 = "BANANA NAGE MOVE ��ͭ�ԥ����å��˰��óݤ���ޤ�����(num %d)\n";
// Reason: EXISTOBJ
char *D_800EC7D8 = "��ͳ: EXISTOBJ \n";
// Reason: category
char *D_800EC7EC = "��ͳ: category \n";
// Reason: sparam
char *D_800EC800 = "��ͳ: sparam \n";
// Reason: num
char *D_800EC810 = "��ͳ: num \n";
char *D_800EC81C = "BANANA NAGE END ��ͭ�ԥ����å��˰��óݤ���ޤ�����(num %d)\n";
// Reason: EXISTOBJ
char *D_800EC858 = "��ͳ: EXISTOBJ \n";
// Reason: category
char *D_800EC86C = "��ͳ: category \n";
// Reason: sparam
char *D_800EC880 = "��ͳ: sparam \n";
// Reason: num
char *D_800EC890 = "��ͳ: num \n";
char *D_800EC89C = "G_SHELL HOLD (num %d  time %d   hold_time %d)\n";
// <<< G_SHELL SET failed >>> obj_num %d
char *D_800EC8CC = "<<< G_SHELL SET ���� >>> obj_num %d \n";
// <<< G_SHELL SET failed >>> object_count %d
char *D_800EC8F4 = "<<< G_SHELL SET ���� >>> object_count %d \n";
// G_SHELL Caught in owner check. (num %d)
char *D_800EC920 = "G_SHELL ��ͭ�ԥ����å��˰��óݤ���ޤ�����(num %d)\n";
// Reason: EXISTOBJ
char *D_800EC954 = "��ͳ: EXISTOBJ \n";
// Reason: category
char *D_800EC968 = "��ͳ: category \n";
// Reason: sparam
char *D_800EC97C = "��ͳ: sparam \n";
// Reason: num
char *D_800EC98C = "��ͳ: num \n";
// Just before launch G_SHELL Caught in owner check. (num %d)
char *D_800EC998 = "ȯ��ľ�� G_SHELL ��ͭ�ԥ����å��˰��óݤ���ޤ�����(num %d)\n";
// Reason: EXISTOBJ
char *D_800EC9D8 = "��ͳ: EXISTOBJ \n";
// Reason: category
char *D_800EC9EC = "��ͳ: category \n";
// Reason: sparam
char *D_800ECA00 = "��ͳ: sparam \n";
// Reason: num
char *D_800ECA10 = "��ͳ: num \n";
// G_SHELL firing (num %d)
char *D_800ECA1C = "G_SHELL ȯ�� (num %d)\n";
char *D_800ECA34 = "R_SHELL HOLD (num %d  time %d   hold_time %d  obj_num %d)\n";
// <<< R_SHELL SET failed >>> obj_num %d
char *D_800ECA70 = "<<< R_SHELL SET ���� >>> obj_num %d \n";
// <<< R_SHELL SET failed >>> object_count %d
char *D_800ECA98 = "<<< R_SHELL SET ���� >>> object_count %d \n";
// R_SHELL Caught in owner check. (num %d)
char *D_800ECAC4 = "R_SHELL ��ͭ�ԥ����å��˰��óݤ���ޤ�����(num %d)\n";
// Reason: EXISTOBJ
char *D_800ECAF8 = "��ͳ: EXISTOBJ \n";
// Reason: category
char *D_800ECB0C = "��ͳ: category \n";
// Reason: sparam
char *D_800ECB20 = "��ͳ: sparam \n";
// Reason: num
char *D_800ECB30 = "��ͳ: num \n";
char *D_800ECB3C = "R_SHELL SHOOT (num %d  time %d   hold_time %d  obj_num %d)\n";
// Just before launch R_SHELL Caught in owner check. (num %d)
char *D_800ECB78 = "ȯ��ľ�� R_SHELL ��ͭ�ԥ����å��˰��óݤ���ޤ�����(num %d)\n";
// Reason: EXISTOBJ
char *D_800ECBB8 = "��ͳ: EXISTOBJ \n";
// Reason: category
char *D_800ECBCC = "��ͳ: category \n";
// Reason: sparam
char *D_800ECBE0 = "��ͳ: sparam \n";
// Reason: num
char *D_800ECBF0 = "��ͳ: num \n";
// R_SHELL firing (num %d)
char *D_800ECBFC = "R_SHELL ȯ�� (num %d)\n";
char *D_800ECC14 = "S_BANANA HOLD (num %d  time %d   hold_time %d)\n";
// <<< SUPER_BANANA SET failed >>> obj_num %d
char *D_800ECC44 = "<<< SUPER_BANANA SET ���� >>> obj_num %d \n";
// <<< SUPER_BANANA SET failed >>> object_count %d
char *D_800ECC70 = "<<< SUPER_BANANA SET ���� >>> object_count %d \n";
// S_BANANA Caught in owner check. (num %d)
char *D_800ECCA0 = "S_BANANA ��ͭ�ԥ����å��˰��óݤ���ޤ�����(num %d)\n";
// Reason: category
char *D_800ECCD8 = "��ͳ: category \n";
// Reason: sparam
char *D_800ECCEC = "��ͳ: sparam \n";
// Reason: sb_ok
char *D_800ECCFC = "��ͳ: sb_ok \n";
char *D_800ECD0C = "S_BANANA RELEASE (num %d  time %d )\n";
// <<< FAKE IBOX SET failed >>> obj_num %d
char *D_800ECD34 = "<<< FAKE IBOX SET ���� >>> obj_num %d \n";
// IBOX Caught in owner check. (num %d)
char *D_800ECD5C = "IBOX ��ͭ�ԥ����å��˰��óݤ���ޤ�����(num %d)\n";
// Reason: EXISTOBJ
char *D_800ECD90 = "��ͳ: EXISTOBJ \n";
// Reason: category
char *D_800ECDA4 = "��ͳ: category \n";
// Reason: sparam
char *D_800ECDB8 = "��ͳ: sparam \n";
// Reason: num
char *D_800ECDC8 = "��ͳ: num \n";
char *D_800ECDD4 = "FBOX HOLD (num %d  time %d   hold_time %d)\n";
// Installation IBOX owner check failed. (num %d)
char *D_800ECE00 = "���� IBOX ��ͭ�ԥ����å��˰��óݤ���ޤ�����(num %d)\n";
// Reason: EXISTOBJ
char *D_800ECE38 = "��ͳ: EXISTOBJ \n";
// Reason: category
char *D_800ECE4C = "��ͳ: category \n";
// Reason: sparam
char *D_800ECE60 = "��ͳ: sparam \n";
// Reason: num
char *D_800ECE70 = "��ͳ: num \n";
// Ray START (%d)
...
char *D_800ECEB4 = "map_number = %d - > 20 �񤭴����档\n";
// OGA Recognition move begins
char *D_800ECEDC = "OGA ɽ�� move ����\n";
// I called the display of the 4th place person.
char *D_800ECEF0 = "���̤οͤ�ɽ���򥳡��뤷�ޤ�����\n";
...
char *D_800ECF30 = "ƻϩ������\n";
// 4th place finished
char *D_800ECF3C = "���̤οͽ�λ\n";
// OGA commendation move end
char *D_800ECF4C = "OGA ɽ�� move ��λ\n";
