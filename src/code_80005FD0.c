...
s16 func_80005FD0(Vec3f arg0, Vec3f arg1) {
    ...
    temp_ret = get_angle_between_cooridates(arg0, arg1);
    phi_v1 = temp_ret;
    if (gIsMirrorMode != 0) {
        phi_v1 = -temp_ret;
    }
...
block_63:
                    ...
                    *(&D_801630E8 + sp34) = 0;
                    ...
                    if (!(temp_v0_10 & 0x80) && !(temp_v0_10 & 0x40) && !(temp_v0_10 & 0x800)) {
                        if (((temp_f0 * temp_f0) + (temp_f2 * temp_f2)) > 6400.0f) {
                            ...
                            sp3C = var_t0_2;
                            sp40->unk_02E = -get_angle_between_cooridates(sp40->pos, &D_80162FA0);
                        } else {
                ...
                if (var_v0 != 0) {
                    ...
                    *temp_v1_4 = -get_angle_between_cooridates(&sp40->rotX, sp40->pos);
                ...
                *temp_v1_7 = D_80162FA0.unk8;
                ...
                temp_v1_8 = -get_angle_between_cooridates(sp1C, &D_80162FA0) - sp40->unk_02E;
...
void func_8000DF8C(s32 arg0) {
    ...
    if ((temp_t2 != 0) && (((u16) temp_s0->unk_4A != 1) || (gCurrentCourseId == 0x0014))) {
        ...
        case 1:
            ...
            spC2 = (u16) ((s32) (get_angle_between_cooridates(&D_80162FB0, &D_80162FC0) * 0xFFFF) / 65520);
            break;
        case 2:
...
s16 func_80010CB0(s32 pathIndex, s32 wayPointIndex) {
    ...
    ret = get_angle_between_cooridates(sp30, sp24);
    return -ret;
}
...
void func_80013D20(VehicleStuff *vehicle) {
    ...
    thing = get_angle_between_cooridates(sp40, sp34);
