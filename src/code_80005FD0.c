...
block_25:
    ...
    *(&D_80163450 + (playerId * 4)) = sp44;
    if ((gCurrentCourseId == 4) && (D_801630E2 == 1) && ((func_80009000(playerId), temp_v0_4 = player->type, ((temp_v0_4 & 0x4000) == 0)) || ((temp_v0_4 & 0x1000) != 0))) {
        func_800090F0(playerId, player);
    }
    temp_v0_5 = player->type;
...
void func_800098FC(u8 arg0, Player *player) {
    ...
    if ((*temp_a2 >= 0xB) && ((temp_v0 = player->effects, ((temp_v0 & 0x80) != 0)) || ((temp_v0 & 0x40) != 0) || (temp_v0 & 0x20000))) {
        sp1C = temp_v1;
        sp18 = temp_a2;
    ...
    if ((*temp_a2_2 >= 0xB) && ((temp_v0_2 = player->statusEffects, ((temp_v0_2 << 9) < 0)) || ((temp_v0_2 << 7) < 0) || ((temp_v0_2 & 2) != 0) || ((temp_v0_2 & 4) != 0) || (player->effects & 0x04000000))) {
        sp18 = temp_a2_2;
        ...
        if (!(temp_v0_3 & 2) && !(temp_v0_3 & 8)) {
            ...
            if (sp40->type & 0x1000) {
                ...
                *temp_a1 = 0;
                ...
                if ((D_801646CC == 1) || (sp40->type & 0x800) || (temp_v0_6 == 0x0014)) {
                    if (temp_v0_6 != 0x000A) {
...
block_63:
                ...
                *var_v0_2 = var_a1_2;
                if (((bitwise s32) *sp28 == 1) || (temp_v0_20 = (s16) *sp2C, (temp_v0_20 == 1)) || (temp_v0_20 == -1) || (sp40->effects & 0x1000000C)) {
                    sp20 = temp_t0_2;
...
void func_8000BA14(u16 arg0, f32 arg1, f32 arg2, s16 arg3) {
    f32 sp54;
    f32 sp50;
    f32 sp4C;
    f32 sp48;
...
void func_80013D20(VehicleStuff *vehicle) {
    ...
    move_to_reach_angle(&vehicle->rotation[1], var_a1, 100);
    ...
    move_to_reach_angle(&vehicle->rotation[0], -thing, 100);
...
void func_80013F7C(s32 playerId, Player *player, VehicleStuff *vehicle, f32 arg3, f32 arg4, s32 arg5, u32 arg6) {
    ...
    temp_s7 = playerId * 2;
    var_s0 = vehicle;
    if (((*(&D_801631E0 + temp_s7) != 1) || ((temp_v0 = player->type, ((temp_v0 & 0x4000) != 0)) && !(temp_v0 & 0x1000))) && ((player->effects << 7) >= 0)) {
        spC4 = player->pos[0];
        var_fp = 0;
        spC0 = player->pos[1];
        spBC = player->pos[2];
...
void func_80015390(Camera *camera, UNUSED Player *player, UNUSED s32 arg2) {
    ...
    */
    ...
    if (!((temp_s1->effects & 0x80) || (temp_s1->effects & 0x40))) {
        move_to_reach_angle(&camera->unk_2C, temp_s1->unk_02C[1], var_a2);
    }
...
void func_80019DF4(void) {
    // unrolled loop?
    D_80164670 = D_80164678[3];
    D_80164670 = D_80164678[2];
    D_80164670 = D_80164678[1];
    D_80164670 = D_80164678[0];
...
void func_8001A348(s32 cameraId, f32 arg1, s32 arg2) {
    ...
    //temp_v1 = cameraId * 2;
    //sp1C = temp_v1;
    //sp20 = (s32) cameras[1].playerId; // + (cameraId * 0xB8));
    D_80164688[cameraId] = arg1;
    D_80164680[cameraId] = func_8001A310(arg1, gNearestWaypointByCameraId[cameraId]);
    func_80019890(cameras[0].playerId, cameraId);
}
#else
...
void func_8001A450(s32 playerId, s32 arg1, s32 arg2) {
    ...
    if (!(*(&gPlayers->effects + (playerId * 0xDD8)) & 0x1000000C) && ((temp_a2 = (arg1 * 2) + &D_80164680, temp_v1 = *temp_a2, sp18 = temp_a2, sp24 = (s32) temp_v1, temp_v0 = func_8001A310(gNearestWaypointByCameraId[arg1], (s32) (temp_v1 + 1) % 10, temp_a2, playerId), (temp_v0 != temp_v1)) || (arg2 != playerId))) {
        *temp_a2 = temp_v0;
...
void func_8001AC10(s32 playerId) {
    ...
    sp2C = temp_t9;
    if ((gModeSelection != (s32) 1) && (D_801646CC != (u16) 1) && !(temp_t9->type & 0x800)) {
        ...
        case 1:                                     /* switch 1 */
            if ((gLapCountByPlayerId[playerId] > 0) && (temp_v1_2 = D_80163478, temp_a0 = gGPCurrentRaceRankByPlayerId[temp_v1_2], ((temp_a0 < gGPCurrentRaceRankByPlayerId[playerId]) != 0)) && (temp_a0 == 0)) {
                ...
                temp_s0->ffff = use_banana_item(sp2C);
        ...
        case 4:                                     /* switch 1 */
            if ((s32) gNumActors < 0x50) {
                temp_s0->ffff = use_green_shell_item(sp2C);
...
block_71:
        ...
        case 7:                                     /* switch 1 */
            if ((s32) gNumActors < 0x50) {
                temp_s0->ffff = use_red_shell_item(sp2C);
...
block_92:
        ...
        case 10:                                    /* switch 1 */
            if ((s32) gNumActors < 0x50) {
                temp_s0->ffff = use_banana_bunch_item(sp2C);
...
block_146:
            ...
            break;
        case 13:                                    /* switch 1 */
            temp_s0->ffff = use_fake_itembox_item(sp2C);
        ...
        if ((temp_v1 & 0x2000) == 0) {
            ...
            if ((f64) ((temp_f0 * temp_f0) + (temp_f2 * temp_f2)) < 1.0) {
                if (var_s1 != 3) {
                    ...
                    if (((gPlayerOne->type & 0x2000) != 0) && ((gPlayerTwo->type & 0x2000) != 0) && ((gPlayerThree->type & 0x2000) != 0)) {
                        D_8016347C = 1;
                        D_80163480 = 0;
                    }
                } else if (D_8016347E == 0) {
                    if ((temp_s0->effects & 0x01000000) == 0) {
                        temp_s0->type = temp_v1 | 0x2000;
                    }
                    D_8016347E = 1;
                    D_80163484 = 0;
                } else if ((temp_s0->effects & 0x01000000) == 0) {
                    temp_s0->type = temp_v1 | 0x2000;
                }
            }
        }
