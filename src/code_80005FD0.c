...
void func_80008424(s32 arg0, f32 arg1, Player *player) {
    ...
    if (!(temp_v1 & 0x80) && !(temp_v1 & 0x40) && !(temp_v1 & 0x20000) && (temp_v0 = player->statusEffects, !(temp_v0 & 0x400000)) && !(temp_v0 & 0x01000000) && !(temp_v0 & 2) && !(temp_v0 & 4)) {
        if (gCurrentCourseId == 0x0014) {
            func_80007FA4(arg0, player, temp_f2);
            return;
        }
        temp_t5 = arg0 * 2;
        if ((D_801634D8[arg0] == (s16) 1) && !(temp_v1 & 0x80000200)) {
            ...
            if ((D_801631E0[arg0] == (u16) 1) && (D_80163330[arg0] != (u16) 1)) {
                temp_v0_2 = arg0 * 4;
                if (func_800088D8(var_f12, arg0, *(&D_80164392 + temp_v0_2), *(&D_8016440A + temp_v0_2), player) == 1) {
                    player->effects |= 0x200000;
                    player_speed(player);
                    return;
                }
            ...
            if (var_a1 != 1) {
                if (temp_f2 < var_f12) {
                    if ((gDemoMode == (u16) 1) && (gCurrentCourseId != 0x0014)) {
                        player_speed(player);
                        return;
                    }
                    temp_v0_4 = arg0 * 4;
                    ...
                    if (func_800088D8(var_f12, arg0, *(&D_80164392 + temp_v0_4), *(&D_8016440A + temp_v0_4), player) == 1) {
                        player->effects |= 0x200000;
                        player_speed(player);
                        return;
                    }
...
#ifdef MIPS_TO_C
//generated by m2c commit beb457dabfc7a01ec6540a5404a6a05097a13602 on Nov-27-2023
...
void func_800099EC(s32 playerId, s32 unused) {
    s32 var_s0;
...
#ifdef MIPS_TO_C
//generated by m2c commit beb457dabfc7a01ec6540a5404a6a05097a13602 on Nov-28-2023
? func_80008424(s32, f32, Player *);                /* extern */
        ...
        *temp_v0_2 = 0;
        ...
        if (!(temp_v0_3 & 2) && !(temp_v0_3 & 8)) {
            ...
            if (sp40->type & 0x1000) {
                ...
                func_800099EC(playerId, (s32) sp40);
                D_80162FD0 = 0;
...
s16 func_8000D6D0(Vec3f arg0, s16 *waypointIndex, f32 arg2, f32 arg3, s16 pathIndex, s16 arg5) {
    ...
    *waypointIndex = temp_v0;
    ...
    xdiff = ((pad3 + D_80162FA0[0]) * 0.5f) - temp_f20;
    zdiff = ((pad4 + D_80162FA0[2]) * 0.5f) - temp_f24;
...
extern UnkStruct_46D0 D_801646D0[]; // size of 8

void func_80014DE4(s32 arg0) {
    UnkStruct_46D0 *temp_v1;
  //  s32 temp_v0;
    //temp_v0 = arg0 * 2;
    D_801646CC = 0;
    ...
    for (i = 0 ; i < i++) {
        gNearestWaypointByCameraId[i] = 0;
    }
}
#else
