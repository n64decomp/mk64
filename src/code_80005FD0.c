...
extern struct TrackWayPoint d_course_dks_jungle_parkway_unknown_waypoints2[];

void func_80012190(void) {
    struct TrackWayPoint *waypoint = (struct TrackWayPoint *) VIRTUAL_TO_PHYSICAL2(
        gSegmentTable[SEGMENT_NUMBER2(&d_course_dks_jungle_parkway_unknown_waypoints2)]
                    + SEGMENT_OFFSET(&d_course_dks_jungle_parkway_unknown_waypoints2));
    s32 i;
    ...
    D_8016359C = func_8001168C(D_80163598, waypoint, i - 1);
    D_80162EB2 = -0x28;
}
...
void func_800132F4(void) {
    ...
    for (i = 0; i < 1; i++) {
        ...
        var_a1->position[2] = (f32) temp_a2->wayPointZ;
        var_a1->wayPointIndex = temp;
        var_a1->actorIndex = -1;
        if (D_8018EDF3 >= 3) {
            var_a1->isActive = 0;
        } else {
