...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 792017ad9d422c2467bd42686f383a5c41f41c75
? func_800413B8(f32 *, f32, ?32);                   /* extern */
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 792017ad9d422c2467bd42686f383a5c41f41c75
? func_80041288(s16 *, ?, ?, s32);                  /* extern */
? func_800413B8(f32 *, ?, ?, s32);                  /* extern */
...
void func_8005CB60(s32 playerId, s32 arg1) {
    ...
    if ((s32) temp_s0->lapCount < D_8018D320) {
        ...
        playerId = temp_a3;
        func_800413B8(&temp_s0->rankScaling, 0x3F800000, 0x3E000000, temp_a3);
        temp_v0_6 = gScreenModeSelection;
        switch (temp_v0_6) {                        /* irregular */
        case 0:
            func_80041288(&temp_s0->slideRankX, 0x1C, 7, playerId);
            if (D_8018D1FC != 0) {
                func_80041288(&temp_s0->slideRankY, -0x28, 1);
            } else {
                func_80041288(&temp_s0->slideRankY, -0x10, 4);
            }
            break;
        case 2:
            func_80041288(&temp_s0->slideRankX, 0x1C, 7, playerId);
        ...
        case 1:
            func_80041288(&temp_s0->slideRankX, 0x1C, 7, playerId);
            func_80041288(&temp_s0->slideRankY, -0x10, 4);
            func_80041288(&temp_s0->lap1CompletionTimeX, 0xE4, 0x10);
            func_80041288(&temp_s0->lap2CompletionTimeX, 0xE4, 0x10);
            func_80041288(&temp_s0->lap3CompletionTimeX, 0xE4, 0x10);
            func_80041288(&temp_s0->totalTimeX, 0xE4, 0x10);
            break;
        case 3:
            if ((playerId & 1) == 1) {
                func_80041288(&temp_s0->slideRankX, -8, 2, playerId);
            } else {
                func_80041288(&temp_s0->slideRankX, 8, 2, playerId);
            }
            func_80041288(&temp_s0->slideRankY, -0x10, 4);
...
loop_2:
        ...
        if ((temp_a0 != 4) && (temp_a0 != 0)) {
            temp_a1 = phi_a2->unk42 - *(&D_80164438 + (playerId * 2));
