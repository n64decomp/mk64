...
#ifdef MIPS_TO_C
//generated by m2c commit b52d92c2340f6f4ba1aafb464188bb698752fbb0 on Aug-05-2023
...
void func_8005C980(void) {
    ...
    do {
        temp_v1 = *var_a0;
        if (D_80165590 == 0) {
            D_8018CF98[var_v0] = (s16) temp_v1;
        }
        *(&D_8018CF28 + (temp_v1 * 4)) = &gPlayerOne[sp0];
        if (sp0 == 0) {
    ...
    do {
        ...
        var_t0->unk0 = temp_v0;
        if (D_80165590 == 0) {
            *(gGPCurrentRaceCharacterIdByRank + var_v1) = gPlayerOne[temp_v0].characterId;
        }
        temp_a2 = var_a0_2->unk2;
        var_t0->unk2 = temp_a2;
        if (D_80165590 == 0) {
            (gGPCurrentRaceCharacterIdByRank + var_v1)->unk2 = (u16) gPlayerOne[temp_a2].characterId;
        }
        temp_a2_2 = var_a0_2->unk4;
        var_t0->unk4 = temp_a2_2;
        if (D_80165590 == 0) {
            (gGPCurrentRaceCharacterIdByRank + var_v1)->unk4 = (u16) gPlayerOne[temp_a2_2].characterId;
        }
        temp_a2_3 = var_a0_2->unk6;
        var_a0_2 += 8;
        var_t0->unk6 = temp_a2_3;
        if (D_80165590 == 0) {
            (gGPCurrentRaceCharacterIdByRank + var_v1)->unk6 = (u16) gPlayerOne[temp_a2_3].characterId;
        }
        var_t0 += 8;
        var_v1 += 8;
    ...
    D_8018D314 = temp_t4;
    if (temp_t4 <= 0) {
        temp_v1_2 = &D_800E55D0[D_8018D3F8];
        D_8018D314 = D_8018D3F4;
        D_8018D3E4 = (s32) temp_v1_2->unk0;
        temp_t6 = D_8018D3F8 + 1;
...
extern u16 D_800E483E;                              /* unable to generate initializer */
...
void func_8005DAF4(Player *player, s16 arg1, s32 arg2, s32 arg3) {
    ...
    f32 var_f14;
    s32 temp_v0;
    static s16 test = 8; // D_800E483E may be a static variable? I can't tell
...
#ifdef NEEDS_RODATA
// data/data_code_80071F00.s
extern u16 D_800E4842;                              /* unable to generate initializer */
...
void func_8005EA94(Player *player, s16 arg1, s32 arg2, s8 arg3) {
    ...
    f32 var_f12;
    f32 var_f14;
    static s16 test = 10; // I think D_800E4842 is a  variable static?
...
#ifdef NEEDS_RODATA
// data/data_code_80071F00.s
extern u16 D_800E4846;                              /* unable to generate initializer */
...
void func_8005ED48(Player *player, s16 arg1, s32 arg2, s32 arg3) {
    ...
    f32 var_f2;
    f32 var_f12;
    static s16 test = 8; // I think D_800E4846 is a static variable?
...
#ifdef NEEDS_RODATA
// data/data_code_80071F00.s
extern s32 D_800E48B8[2];                                /* unable to generate initializer */
extern s32 D_800E48C0[2];                                /* unable to generate initializer */

void func_8006538C(Player *player, s8 arg1, s16 arg2, s8 arg3) {
    Vec3f spB4;
    Vec3s spAC;
    s32 spA4[] = { 0x00fbfffb, 0x00fffb86 };
    s32 sp9C[] = { 0x0089628f, 0x00fe0109 };
    s16 primRed;
    s16 primGreen;
    s16 primBlue;
    s16 primAlpha;
    ...
    if (player->unk_258[arg2].unk_01C == 1) {
        ...
        if ((player->unk_0BC & 0x200) && (((s32) gCourseTimer - D_8018D930[arg1]) < 9)) {
            primRed = (spA4[1] >> 0x10) & 0xFF;
            primGreen = (spA4[1] >> 8) & 0xFF;
            primBlue = spA4[1] & 0xFF;
            envRed = (sp9C[1] >> 0x10) & 0xFF;
            envGreen = (sp9C[1] >> 8) & 0xFF;
            envBlue = sp9C[1] & 0xFF;
            ...
            primRed = (spA4[player->unk_258[arg2].unk_038] >> 0x10) & 0xFF;
            primGreen = (spA4[player->unk_258[arg2].unk_038] >> 8) & 0xFF;
            primBlue = spA4[player->unk_258[arg2].unk_038] & 0xFF;
            envRed = (sp9C[player->unk_258[arg2].unk_038] >> 0x10) & 0xFF;
            envGreen = (sp9C[player->unk_258[arg2].unk_038] >> 8) & 0xFF;
            envBlue = sp9C[player->unk_258[arg2].unk_038] & 0xFF;
            primAlpha = player->unk_258[arg2].unk_03E;
...
#ifdef NEEDS_RODATA
// data/code_80071F00.s
extern f32 D_800E48D4[8];
...
#ifdef NEEDS_RODATA
// data/data_code_80071F00.s
extern s32 D_800E4974[];                                /* unable to generate initializer */
extern s32 D_800E4994[];                                /* unable to generate initializer */
...
void func_8006BB34(Vec3f arg0, f32 arg1, s16 arg2, s16 arg3) {
    ...
    s16 envGreen;
    s16 envBlue;
    s32 spC4[] = { 0x00c80100, 0x00007001, 0x00107951, 0x00005970, 0x00705500, 0x007a7e00, 0x00772c24, 0x00301458 };
    s32 spA4[] = { 0x00dc0000, 0x00008c06, 0x00000051, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000 };

    primRed   = (spC4[arg3] >> 0x10) & 0xFF;
    primGreen = (spC4[arg3] >> 0x08) & 0xFF;
    primBlue  = (spC4[arg3] >> 0x00) & 0xFF;
    envRed    = (spA4[arg3] >> 0x10) & 0xFF;
    envGreen  = (spA4[arg3] >> 0x08) & 0xFF;
    envBlue   = (spA4[arg3] >> 0x00) & 0xFF;
    spFC[0] = arg0[0];
    spFC[1] = arg0[1];
    spFC[2] = arg0[2];
    spF4[0] = 0;
...
#ifdef MIPS_TO_C
//generated by m2c commit b52d92c2340f6f4ba1aafb464188bb698752fbb0 on Aug-04-2023
...
void func_8006CEC0(Player *player, s16 arg1, s8 arg2, s8 arg3) {
    ...
    if (player->unk_258[arg1].unk_01C == 1) {
        ...
        switch (temp_t1) {
        case 1:
            func_80062C74(player, arg1, (s32) arg2, (s32) arg3);
            return;
        case 3:
        ...
        if ((player->unk_044 & 0x200) && (player->unk_000 & 0x4000)) {
            func_80061224(player, arg1, sp20, arg2, (s8) (s32) arg3);
            return;
        }
        ...
        if (temp_t1_2 == 0x4000) {
            ...
            if ((temp_v0_2 & 2) || (temp_v0_2 & 1)) {
                func_80060B14(player, arg1, sp20, arg2, (s8) (s32) arg3);
                return;
            }
            goto block_22;
        }
block_22:
        ...
        case 0:                                     /* switch 1 */
            if (((temp_v1 & 0x04000000) != 0x04000000) && ((temp_v1 & 0x400) != 0x400) && ((temp_v1 & 0x01000000) != 0x01000000)) {
                ...
                if (((temp_v0_3 & 2) != 2) && ((temp_v0_3 & 0x10) != 0x10) && !(temp_v0_3 & 0x100)) {
