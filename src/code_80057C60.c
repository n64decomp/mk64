...
void func_800615AC(Player* player, s16 arg1, UNUSED s32 arg2, UNUSED s8 arg3, UNUSED s8 arg4) {
    ...
    f32 temp_f0;
    f32 sp28[10] = { (f32) -DEGREES(1), (f32) DEGREES(1), (f32) DEGREES(2), (f32) -DEGREES(2), DEGREES(3),
                     -DEGREES(3),       DEGREES(4),       -DEGREES(4),      DEGREES(5),        -DEGREES(5) };
...
void func_80061D4C(Player* player, s16 arg1, UNUSED s32 arg2, UNUSED s8 arg3, UNUSED s8 arg4) {
    ...
    f32 sp20[10] = { (f32) -DEGREES(1), (f32) DEGREES(1), (f32) DEGREES(2), (f32) -DEGREES(2), DEGREES(3),
                     -DEGREES(3),       DEGREES(4),       -DEGREES(4),      DEGREES(5),        -DEGREES(5) };
