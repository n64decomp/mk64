...
void func_8005D898(Player* arg0, s16 arg1, UNUSED s8 arg2, UNUSED s8 arg3) {
    s32 temp_lo;

    if (arg0->unk_0C0 >= 0) {
        func_8005D794(arg0, &arg0->unk_258[10 + arg1], arg0->unk_1C8, arg0->unk_1D8 + 2.0f, arg0->unk_1D0, arg0->backLeftTyreSurface, 1);
    } else {
        func_8005D794(arg0, &arg0->unk_258[10 + arg1], arg0->unk_1E0, arg0->unk_1F0 + 2.0f, arg0->unk_1E8, arg0->backRightTyreSurface, 0);
    }

    temp_lo = arg0->unk_0C0 / 182;
    if ((temp_lo >= 7) || (temp_lo < -6)) {
        func_8005D7D8(&arg0->unk_258[10 + arg1], 1, 0.35f);
        if (arg0->unk_22A == 0) {
            func_8005D800(&arg0->unk_258[10 + arg1], 0xFFFFFF, 0x70);
        }

        if (arg0->unk_22A == 1) {
            func_8005D800(&arg0->unk_258[10 + arg1], 0xFFFF00, 0x70);
  
        }

        if (arg0->unk_22A >= 2) {
            func_8005D800(&arg0->unk_258[10 + arg1], 0xFF9600, 0x70);
        }
 
        if (arg0->unk_22A >= 2) {
            // Why not put this in previous if statement?
            arg0->unk_258[10 + arg1].unk_040 = 2;
            return;
        }

        arg0->unk_258[10 + arg1].unk_040 = arg0->unk_22A;
    }
}
...
void func_8006BA94(Player* arg0, s8 playerIndex, s8 arg2) {
    ...
    if (gPlayerBalloonStatus[playerIndex][1] != BALLOON_STATUS_GONE) {
        func_8006AFD0(arg0, playerIndex, 1, arg2);
    }
    if (gPlayerBalloonStatus[playerIndex][2] != BALLOON_STATUS_GONE) {
        func_8006AFD0(arg0, playerIndex, 2, arg2);
    }
}
