...
// maybe struct_80165C18_entry (same size)
// However, unk_000 needs to be s32. Could be an onion?
struct struct_8007223C {
    s32 s32;
    s8 unk4[0xDC];
}; // Size 0xE0

extern struct struct_8007223C D_80165C6C[];
s32 func_8007223C(s32 arg0, s32 arg1) {
    s32 phi_v1 = 0;
    if ((D_80165C6C[arg0].s32 & arg1) != 0) {
        phi_v1 = 1;
    }
    return phi_v1;
}
...
extern struct struct_8007223C D_80165C70[];

s32 func_80072320(s32 arg0, s32 arg1) {
    s32 phi_v1 = 0;
    if ((D_80165C70[arg0].s32 & arg1) != 0) {
        phi_v1 = 1;
    }
    return phi_v1;
}
...
extern struct struct_E0 D_80165CE3[];

/**
 * The s8's in this file are possibly just one big array
...
extern struct struct_E0 D_80165CBE[];
...
extern struct struct_E0 D_80165CF4[];
...
extern struct struct_E0 D_80165CF3[];
...
void func_800747F0(s32 arg0) {
    ...
    if (temp_v0 != temp_v1->unkD3) {
        ...
        func_80074574(sp24, func_80074790(), temp_v1->unkD9, func_80074574->unkDA);
...
void func_80075714(s32 arg0) {
    ...
    case 2:
        ...
        f32_step_up_towards(&D_80165C18[arg0].unk_028[1], 100.0f, D_80165C18[arg0].unk_03C);
...
void func_8007BD04(s32 arg0) {
    ...
    if (*(&D_80165CBE + (temp_t6 * 0xE0)) == 0) {
        temp_v0 = *(&gNearestWaypointByPlayerId + (arg0 * 2));
...
void func_8007CA70(void) {
    ...
    if (D_8018CFF0 == 0) {
        ...
        temp_v1 = *(&gNearestWaypointByPlayerId + (temp_v0 * 2));
        D_8018D018 = temp_v0;
    ...
    if (D_8018CFF0 != 0) {
        temp_a1 = D_8018D018;
        temp_v1_2 = (temp_a1 * 2) + &gNearestWaypointByPlayerId;
        temp_v0_2 = *temp_v1_2;
        phi_v0 = temp_v0_2;
    ...
    if (D_8018D048 == 0) {
        ...
        temp_v1_3 = *(&gNearestWaypointByPlayerId + (temp_v0_3 * 2));
    ...
    if (D_8018D048 != 0) {
        ...
        temp_v1_4 = (temp_a1_2 * 2) + &gNearestWaypointByPlayerId;
        temp_v0_4 = *temp_v1_4;
        phi_v0_2 = temp_v0_4;
