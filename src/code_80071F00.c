...
void func_8007DF20(s32 objectIndex) {
    D_80165C18[objectIndex].unk_000 = 1.0f;
    ...
    func_8008B8BC(objectIndex, 0U, 0U, 0U);
    if (gIsMirrorMode != 0) {
        D_80165C18[objectIndex].unk_004[0] = 1765.0f;
        D_80165C18[objectIndex].unk_004[2] = 195.0f;
        D_80165C18[objectIndex].unk_0B2[1] = 0x8000;
    } else {
        D_80165C18[objectIndex].unk_004[0] = -1765.0f;
        D_80165C18[objectIndex].unk_004[2] = 70.0f;
    }
    D_80165C18[objectIndex].unk_004[1] = 45.0f;
...
void func_80080408(s32 objectIndex) {
    ...
    case 2:
        ...
        if (func_8007223C(objectIndex, 0x00040000) != 0) {
            func_800C98B8(D_80165C18[objectIndex].unk_004, D_80165C18[objectIndex].unk_038, 0x19018045U);
            func_80072488(objectIndex);
        }
        break;
    case 3:
...
void func_80081080(s32 objectIndex) {
    ...
    temp_v0 = &D_80165C18[objectIndex];
    temp_v0->unk_064 = D_8018D490;
    temp_v0->unk_06C = D_8018D490;
    temp_v0->unk_0A0 = 0x00FF;
    temp_v0->unk_0BE[1] = 0;
    temp_v0->unk_0B2[0] = 0;
    temp_v0->unk_0B2[2] = 0;
...
void func_800810F4(s32 objectIndex) {
    ...
    case 2:
        ...
        func_8007415C(objectIndex, &D_80165C18[objectIndex].unk_000, 0.25f, 0.75f, 0.025f, 1, 0);
...
void func_8008153C(s32 objectIndex) {
    ...
    for (var_s7 = 0; var_s7 < sp70; var_s7++) {
        for (var_s1 = 0; var_s1 < D_8018C3F0_SIZE; var_s1++) {
            ...
            D_80165C18[loopObjectIndex].unk_060 = D_06013670;
            D_80165C18[loopObjectIndex].unk_068 = D_06013670;
            D_80165C18[loopObjectIndex].unk_000 = 0.15f;
...
void func_80081D34(s32 objectIndex) {
    ...
    if (var_s5 != 0) {
        ...
        func_800721E8(objectIndex, 0x00000200);
        func_80086F60(objectIndex);
        func_8008B7D4(objectIndex, temp_s0->unk_004[0], temp_s0->unk_004[1], temp_s0->unk_004[2]);
        func_8008B80C(objectIndex, 0.0f, 0.0f, 0.0f);
...
void func_8008275C(s32 objectIndex) {
    ...
    case 2:
        func_8008B78C(objectIndex);
        func_80040EC4(D_80165C18[objectIndex].unk_01C, D_80165C18[objectIndex].unk_004);
        ...
        func_8008BF18(objectIndex);
        D_80165C18[objectIndex].unk_0BE[1] = func_802B5224(D_80165C18[objectIndex].unk_01C, D_80165C18[objectIndex].unk_004);
        break;
    }
...
void func_80083538(s32 objectIndex, Vec3f arg1, s32 arg2, s32 arg3) {
    ...
    temp_s0->unk_06C = d_course_frappe_snowland_snow;
    temp_s0->unk_060 = d_course_frappe_snowland_snow_tlut;
    temp_s0->unk_068 = d_course_frappe_snowland_snow_tlut;
    temp_s0->unk_000 = random_int(0x0064U);
    temp_s0->unk_000 = (temp_s0->unk_000 * 0.001) + 0.05;
...
void func_80084D2C(s32 objectIndex, s32 arg1) {
    ...
    switch (temp_t8) {
    case 1:
        temp_v0 = func_800417B4(temp_s0->unk_0BE[1], temp_s0->unk_0C6);
        temp_s0->unk_0BE[1] = temp_v0;
        if ((temp_v0 & 0xFFFF) == temp_s0->unk_0C6) {
            temp_s0->unk_09C = 4;
    ...
    case 2:
        ...
        if (func_80087060(objectIndex, 0x0000000F) != 0) {
            ...
            temp_s0->unk_0D8 = 1;
            temp_s0->unk_0D2 = 0;
            temp_s0->unk_0A4 = func_80004EAC(&D_06009AC8, 1U & 0xFF);
            func_800726CC(objectIndex, 3);
            func_80086FD4(objectIndex);
            if (func_80072354(objectIndex, 0x00000020) != 0) {
                func_800722A4(objectIndex, 0x00000080);
    ...
    case 5:
        ...
        if (func_80087060(objectIndex, 0x0000000A) != 0) {
            ...
            temp_s0->unk_0D8 = 2;
            temp_s0->unk_0D2 = 0;
            temp_s0->unk_0A4 = func_80004EAC(&D_06009AC8, 2U & 0xFF);
            func_800726CC(objectIndex, 3);
            func_80086FD4(objectIndex);
        }
        break;
...
void func_800857C0(void) {
    ...
    if (D_80165C18[objectIndex].unk_0A6 != 0) {
        ...
        func_8008BF18(objectIndex);
        if (D_80165C18[objectIndex].unk_0A6 >= 2) {
            D_802BA05C->pos[0] = D_80165C18[objectIndex].unk_004[0];
            D_802BA05C->pos[1] = D_80165C18[objectIndex].unk_004[1] - 10.0;
            D_802BA05C->pos[2] = D_80165C18[objectIndex].unk_004[2];
        }
    }
}
...
void func_80086C6C(s32 objectIndex) {
    ...
    sp24[0] = (D_80165C18[objectIndex].unk_004[0] - 5.0f) + random_int(0x000AU);
    sp24[2] = (D_80165C18[objectIndex].unk_004[2] - 5.0f) + random_int(0x000AU);
    if (D_801658F4 != 0) {
        sp24[1] = D_80165C18[objectIndex].unk_004[1] + 14.0;
    } else {
        sp24[1] = D_80165C18[objectIndex].unk_004[1] - 2.0;
    }
