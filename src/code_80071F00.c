...
void func_8008275C(s32 objectIndex) {
    ...
    case 2:
        ...
        func_8008BF18(objectIndex);
        D_80165C18[objectIndex].unk_0BE[1] = get_angle_two_point(D_80165C18[objectIndex].unk_01C, D_80165C18[objectIndex].pos);
        break;
    }
...
void func_80085AA8(void) {
    ...
    for (var_s4 = 0; var_s4 < 3; var_s4++) {
        ...
        if (temp_s0->unk_0A6 != 0) {
            ...
            temp_s0->unk_0BE[1] = get_angle_two_point(temp_s0->unk_01C, temp_s0->unk_028);
