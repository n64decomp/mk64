...
#ifdef MIPS_TO_C
//generated by m2c commit d9d3d6575355663122de59f6b2882d8f174e2355 on Dec-25-2022
s16 D_800E5740[0][3];                               /* unable to generate initializer */
s16 D_800E579C[0][3];                               /* unable to generate initializer */
s16 D_800E57F8[0][3];                               /* unable to generate initializer */
...
void func_80076884(s32 arg0) {
    ...
    default:
        ...
        break;
    case 0:
        var_s2 = D_800E5740[temp_v0];
        break;
    case 1:
        var_s2 = D_800E579C[temp_v0];
        break;
    case 2:
        var_s2 = D_800E57F8[temp_v0];
        break;
    }
    var_s0 = 0;
loop_8:
...
#ifdef NON_MATCHING
// Non matching due to some register differences surrounding the accessing of D_800E6788
extern Vec3s D_800E6788[8];                               /* unable to generate initializer */
...
void func_80076FEC(s32 objectIndex, s32 flameIndex) {
    ...
    temp_v0->unk_010[0] = D_800E6788[flameIndex][0] * D_8018D01C;
    temp_v0->unk_010[1] = D_800E6788[flameIndex][1];
    temp_v0->unk_010[2] = D_800E6788[flameIndex][2];
    temp_v0->unk_034 = 0.0f;
    temp_v0->unk_0A4 = 0x00FF;
    temp_v0->unk_0A2 = 0x00FF;
    temp_v0->unk_0A0 = 0x00FF;
    func_8008B8BC(objectIndex, 0U, 0U, 0U);
    // The permuter found this slightly better match, but still no full match
    //func_8008B8BC(objectIndex ^ 0, 0U, 0U, 0U);
    func_8008B80C(objectIndex, 0.0f, 0.0f, 0.0f);
}
#else
