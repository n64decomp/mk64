...
void func_8007B254(s32 objectIndex, u8 arg1) {
    ...
    temp_v0->unk_0A6 = 2;
    temp_v0->unk_0A4 = 0;
    temp_v0->tlutList = &gTLUTItemWindowNone;
    temp_v0->textureList = (s32) &gTextureItemWindowNone;
...
void func_80083FD0(s32 objectIndex, s32 arg1, s16 playerId) {
    ...
    temp_s0->sizeScaling = (f32) (((f64) (f32) random_int(0x01F4U) * 0.0002) + 0.04);
    temp_v0 = random_int(0x0032U);
    var_f16 = (f32) temp_v0;
    if (temp_v0 < 0) {
...
void func_80086700(s32 objectIndex) {
    ...
    var_v0->sizeScaling = 0.005f;
    temp_v1 = &D_80165C18[*D_80183F28];
    sp20 = var_v0;
    func_8008B7D4(objectIndex, temp_v1->pos[0], (f32) ((f64) temp_v1->pos[1] + 16.0), temp_v1->pos[2]);
    func_8008B80C(objectIndex, 0.0f, 0.0f, 0.0f);
    func_8008B888(objectIndex, 0U, 0U, 0U);
