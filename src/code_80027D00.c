...
void func_8002D268(Player *player, s32 arg1, s8 arg2, s8 arg3) {
    ...
    func_802AD950(&player->unk_110, player->boundingBox, spFC, spF8, spF4, player->rotX, player->rotY, player->rotZ);
    player->unk_058 = 0.0f;
    player->unk_060 = 0.0f;
    player->unk_05C = 1.0f;
...
void func_8002E4C4(Player *player) {
    ...
    player->kartHopAcceleration = 0.0f;
    player->kartHopVelocity = 0.0f;
    player->pos[1] = func_802AE1C0(player->pos[0], D_80164510[player_index] + 10.0f, player->pos[2]) + player->boundingBox;
