...
void func_80029B4C(void *arg0, ? arg1, f32 arg2, ? arg3) {
    ...
    if ((arg0->unkBC & 8) == 0) {
        move_f32_towards(arg0 + 0x230, (arg0->unk1A8 + arg0->unk1D8) / 2.0f, 0x3F000000);
        move_f32_towards(arg0 + 0x23C, (arg0->unk1C0 + arg0->unk1F0) / 2.0f, 0x3F000000);
        move_f32_towards(arg0 + 0x1FC, (arg0->unk1A8 + arg0->unk1C0) / 2.0f, 0x3F000000);
        move_f32_towards(arg0 + 0x1F8, (arg0->unk1D8 + arg0->unk1F0) / 2.0f, 0x3F000000);
    }
    ...
    if (phi_v0 != 8) {
        move_s16_towards(arg0 + 0xC4, func_802B7C40((arg0->unk1F8 - arg0->unk1FC) / temp_f2_3), 0x3F000000);
    } else {
        ...
        move_s16_towards(arg0 + 0xC4, phi_a1, 0x3F000000);
    }
...
void func_8002A194(void *arg0, f32 arg1, f32 arg2, f32 arg3) {
    ...
    if ((arg0->unkBC & 8) != 8) {
        move_s16_towards(arg0 + 0xC4, func_802B7C40((arg0->unk1F8 - arg0->unk1FC) / temp_f20), 0x3F000000);
    } else {
        temp_f0_2 = arg0->unk24 - arg2;
        sp30 = temp_f0_2;
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 3c3b0cede1a99430bfd3edf8d385802b94f91307
? move_f32_towards(void *, f32, void *, f32, ?, void *); // extern
...
block_44:
        ...
        if (temp_a2 != 0) {
            ...
            sp24 = phi_f0;
            arg0 = temp_a3;
            move_f32_towards(phi_f12, 0.0f, temp_a3 + 0xA0, temp_f18, 0x3E19999A, temp_a3);
            phi_a3 = arg0;
            phi_f0_2 = phi_f0;
        } else {
            arg0 = temp_a3;
            sp24 = phi_f0;
            move_f32_towards(phi_f12, 0.0f, temp_a3 + 0xA0, 0.0f, 0x3DCCCCCD, temp_a3);
            phi_a3 = arg0;
            phi_f0_2 = phi_f0;
        }
    } else {
    ...
    if (temp_t5 != 0x4000) {
        if ((phi_a3->unkBC & 0x200000) == 0x200000) {
            arg0 = phi_a3;
            sp24 = phi_f0_2;
            move_f32_towards(phi_a3 + 0xE8, 380.0f, 0x3F000000, (bitwise f32) phi_a3);
            phi_v0_2 = arg0->unk0 & 0x4000;
            phi_a3_2 = arg0;
        } else {
            arg0 = phi_a3;
            sp24 = phi_f0_2;
            move_f32_towards(phi_a3 + 0xE8, 0.0f, 0x3DCCCCCD, (bitwise f32) phi_a3);
            phi_v0_2 = arg0->unk0 & 0x4000;
            phi_a3_2 = arg0;
        }
    }
    ...
    if (phi_v0_2 == 0x4000) {
        ...
        if (((temp_a1_2 & 0x100) == 0x100) && ((temp_a1_2 & 0x10) != 0x10)) {
            arg0 = phi_a3_2;
            sp24 = phi_f0_2;
            move_f32_towards(temp_a0, 580.0f, 0x3E4CCCCD, (bitwise f32) phi_a3_2);
        } else {
            arg0 = phi_a3_2;
            sp24 = phi_f0_2;
            move_f32_towards(temp_a0, phi_f14, 0x3C23D70A, (bitwise f32) phi_a3_2);
        }
        if ((arg0->unkBC & 0x200000) == 0x200000) {
            arg0 = arg0;
            sp24 = sp24;
            move_f32_towards(arg0 + 0xE4, 580.0f, 0x3C23D70A, (bitwise f32) arg0);
        } else {
            arg0 = arg0;
            sp24 = sp24;
            move_f32_towards(arg0 + 0xE4, 0.0f, 0x3C23D70A, (bitwise f32) arg0);
        }
        phi_a3_3 = arg0;
        phi_f0_3 = sp24;
    }
    arg0 = phi_a3_3;
    move_f32_towards(phi_a3_3 + 0x104, phi_f0_3, (bitwise void *) (*(&gKartTurnSpeedReductionTable1 + (phi_a3_3->unk254 * 4)) + D_800ED9B0), (bitwise f32) phi_a3_3);
