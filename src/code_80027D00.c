...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 792017ad9d422c2467bd42686f383a5c41f41c75
f32 func_802AE1C0(f32, f32, Player *, f32);         /* extern */
...
void func_8002E4C4(Player *player) {
    ...
    player->kartHopAcceleration = 0.0f;
    player->kartHopVelocity = 0.0f;
    temp_f2 = func_802AE1C0(player->posX, D_80164510[temp_v0] + 10.0f, player, player->posZ) + player->unk_070;
    player->posY = temp_f2;
    temp_f12 = D_80164510[sp1C];
    if (((temp_f2 - temp_f12) > 1200.0f) || ((player->posY - temp_f12) < -1200.0f)) {
