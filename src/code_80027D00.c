...
void func_800382DC(void) {
    ...
    if (temp_v0 != 0) {
        if ((temp_v0 != 1) && (temp_v0 != 2)) {
            ...
            func_800381AC(gPlayerOne, D_800DC4BC, 0);
            func_800381AC(gPlayerTwo, D_800DC4C0, 1);
            func_800381AC(gPlayerThree, D_800DC4C4, 2);
            if (gPlayerCountSelection1 == 4) {
                func_800381AC(gPlayerFour, D_800DC4C8, 3);
            }
