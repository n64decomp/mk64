...
void func_8002AB70(void *arg0) {
    ...
    if (((arg0->unkBC & 8) != 8) && (arg0->unk8C > 0.0f)) {
        ...
        if ((temp_lo < -1) && (temp_lo >= -0x14) && (((arg0->unk94 / 18.0f) * 216.0f) >= 20.0f)) {
            move_f32_towards(arg0 + 0x100, 500.0f, 0x3F800000);
            temp_a0 = arg0 + 0xDAC;
            sp20 = temp_a0;
            move_f32_towards(temp_a0, 3.0f, 0x3D4CCCCD);
        } else {
            move_f32_towards(arg0 + 0x100, gKartGravityTable[arg0->unk254], 0x3DCCCCCD);
            temp_a0_2 = arg0 + 0xDAC;
            sp20 = temp_a0_2;
            move_f32_towards(temp_a0_2, 1.0f, 0x3D8F5C29);
        }
    } else {
        if (arg0->unk124 >= 50.0f) {
            arg0->unkDAC = 2.0f;
        }
        move_f32_towards(arg0 + 0x100, gKartGravityTable[arg0->unk254], 0x3CA3D70A);
        temp_a0_3 = arg0 + 0xDAC;
        if ((arg0->unkBC & 2) == 2) {
            temp_a0_4 = arg0 + 0xDAC;
            sp20 = temp_a0_4;
            move_f32_towards(temp_a0_4, 1.0f, 0x3D8F5C29);
        } else {
            sp20 = temp_a0_3;
            move_f32_towards(temp_a0_3, 1.0f, 0x3D8F5C29);
        }
    }
    if ((arg0->unkBC & 0x100000) == 0x100000) {
        move_f32_towards(sp20, 20.0f, 0x3F800000);
        arg0->unk100 = D_800ED7B8;
    }
    phi_v0 = arg0->unkBC;
    if ((arg0->unkBC & 4) == 4) {
        move_f32_towards(sp20, 25.0f, 0x3F800000);
        arg0->unk100 = 1800.0f;
        phi_v0 = arg0->unkBC;
    }
    phi_v0_2 = phi_v0;
