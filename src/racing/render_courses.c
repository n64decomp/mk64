...
void render_course_segments(uintptr_t addr, struct UnkStruct_800DC5EC *arg1) {
    ...
    if (D_80152300[camera - camera1] == 1) {
        sp1E = get_track_segment(camera->unk_54.collisionMeshIndex);
        temp_v0_3 = get_track_segment(player->unk_110.collisionMeshIndex);
        ...
        index = get_track_segment(camera->unk_54.collisionMeshIndex);
