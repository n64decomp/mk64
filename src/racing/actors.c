...
void func_80297760(struct Actor *arg0, Vec3f arg1) {
    ...
    arg1[1] = arg0->pos[1];
    arg1[2] = arg0->pos[2];
    arg1[1] = func_802ABE30(arg1[0], arg1[1], arg1[2], arg0->unk30.collisionMeshIndex);
}
...
void evaluate_collision_players_palm_trees(void) {
    ...
    for (index = 0; index < 4; index++){
        ...
        if (((gPlayers[index].type & 0xC000) != 0) && (((get_surface_type(gPlayers[index].unk_110.collisionMeshIndex) << 24) >> 24) == GRASS)) {
    ...
    while (var_s3->pos[0] != END_OF_SPAWN_DATA) {
        ...
        if (gGamestate == CREDITS_SEQUENCE) {
            ...
            if (temp_s0->unk30.unk3C[2] < 0.0f) {
                temp_s0->pos[1] = func_802ABE30(temp_s0->pos[0], temp_s0->pos[1], temp_s0->pos[2], temp_s0->unk30.collisionMeshIndex);
            }
