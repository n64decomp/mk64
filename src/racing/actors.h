...
void actor_not_render_on_a_camera(Camera*, struct Actor*);
void actor_render_on_a_camera(Camera*, struct Actor*);
...
s32  collide_tree(Player*, struct Actor*);
s32  is_collision_between_item_player(Player*, struct Actor*);
s32  is_two_actor_collide(struct Actor*, struct Actor*);
void destroy_destructable_actor(struct Actor*);
void make_sound_between_two_destroyables_collide(struct Actor*, struct Actor*);
void evaluate_actor_collision_between_two_destroyables(struct Actor*, struct Actor*);
...
void render_item_boxs(struct UnkStruct_800DC5EC*);
