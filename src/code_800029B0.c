...
void vec3f_set_alternate(f32 *, f32, f32, f32);
...
void func_80002DAC(void) {
    switch (gCurrentCourseId) {
        case COURSE_MARIO_RACEWAY:
            vec3f_set_alternate(&D_8015F748, -223.0f, 94.0f, -155.0f);
            func_800C9D80(&D_8015F748, &D_802B91C8, 0x5103700B);
            break;
        case COURSE_ROYAL_RACEWAY:
            vec3f_set_alternate(&D_8015F748, 177.0f, 87.0f, -393.0f);
            func_800C9D80(&D_8015F748, &D_802B91C8, 0x5103700B);
            break;
        case COURSE_LUIGI_RACEWAY:
            vec3f_set_alternate(&D_8015F748, 85.0f, 21.0f, -219.0f);
            func_800C9D80(&D_8015F748, &D_802B91C8, 0x5103700B);
            break;
        case COURSE_WARIO_STADIUM:
            vec3f_set_alternate(&D_8015F748, 298.0f, 202.0f, -850.0f);
            func_800C9D80(&D_8015F748, &D_802B91C8, 0x5103700B);
            vec3f_set_alternate(&D_8015F758, -1600.0f, 202.0f, -2430.0f);
            func_800C9D80(&D_8015F758, &D_802B91C8, 0x5103700B);
            vec3f_set_alternate(&D_8015F768, -2708.0f, 202.0f, 1762.0f);
            func_800C9D80(&D_8015F768, &D_802B91C8, 0x5103700B);
            vec3f_set_alternate(&D_8015F778, -775.0f, 202.0f, 1930.0f);
            func_800C9D80(&D_8015F778, &D_802B91C8, 0x5103700B);
            break;
        case COURSE_KOOPA_BEACH:
            vec3f_set_alternate(&D_8015F738, 153.0f, 0.0f, 2319.0f);
            func_800C9D80(&D_8015F738, &D_802B91C8, 0x51028001);
            break;
        case COURSE_DK_JUNGLE:
            vec3f_set_alternate(&D_8015F738, -790.0f, -255.0f, -447.0f);
            func_800C9D80(&D_8015F738, &D_802B91C8, 0x51028001);
            break;
        default:
            break;
...
void func_80003040(void) {
    ...
    switch (gCurrentCourseId) {
        ...
        case COURSE_YOSHI_VALLEY:
            vec3f_set_alternate(&sp34, -2300.0f, 0.0f, 634.0f);
        ...
        case COURSE_RAINBOW_ROAD:
            ...
            break;
        case COURSE_WARIO_STADIUM:
            vec3f_set_alternate(&sp34, -131.0f, 83.0f, 286.0f);
            func_8029EC88(&sp34, &sp20, &sp28, 0x23);
            vec3f_set_alternate(&sp34, -2353.0f, 72.0f, -1608.0f);
            func_8029EC88(&sp34, &sp20, &sp28, 0x23);
            vec3f_set_alternate(&sp34, -2622.0f, 79.0f, 739.0f);
            func_8029EC88(&sp34, &sp20, &sp28, 0x23);
