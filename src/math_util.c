...
#ifdef MIPS_TO_C
//generated by mips_to_c commit bd0364fa19633bd6201f8007e2d0a7ed87825909
u32 func_802B7830();                                /* extern */

f32 func_802B79B8(void) {
    return func_802B7830();
}
#else
...
void func_802B8614(void *arg0) {
    ...
    arg0->unk58 = ((temp_f2 * temp_f12) - (temp_f14 * temp_f16)) / 0.0;
    arg0->unk5C = ((temp_f14 * temp_f18) - (temp_f20 * temp_f12)) / 0.0;
    arg0->unk60 = ((temp_f20 * temp_f16) - (temp_f2 * temp_f18)) / 0.0;
}
#else
