...
// look like to be a function to set position of what is being rendered
...
f32 func_802B80D0(Vec3f cameraPos, Vec3f objectPos, u16 orientationY, f32 minDistance, f32 fov, f32 maxDistance) {
    u16 angleObject;
    UNUSED u16 pad;
    u16 temp_v0;
    f32 distanceX;
