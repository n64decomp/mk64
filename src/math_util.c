...
u16 random_u16(void) {
    ...
    temp1 = (D_802BA290 & 0x00FF) << 8;
    temp1 = temp1 ^ D_802BA290;

    D_802BA290 = ((temp1 & 0x00FF) << 8) + ((temp1 & 0xFF00) >> 8);

    temp1 = ((temp1 & 0x00FF) << 1) ^ D_802BA290;
    ...
    if ((temp1 & 1) == 0) {
        if (temp2 == 43605) {
            ...
            D_802BA290 = temp2 ^ 0x1FF4;
        }
    } else {
        D_802BA290 = temp2 ^ 0x8180;
    }
