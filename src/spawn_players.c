...
void func_8003BE30(void) {
    ...
    spawn_player(gPlayerTwo, 1, -3691.506f, -6.822f, -6.95f, (f32) (200 * DEGREES(1)), gCharacterIdByGPOverallRank[1],
                 PLAYER_EXISTS | PLAYER_CPU | PLAYER_START_SEQUENCE);
    spawn_player(gPlayerThree, 2, -3475.028f, -998.485f, -8.059f, (f32) (250 * DEGREES(1)),
                 gCharacterIdByGPOverallRank[2], PLAYER_EXISTS | PLAYER_CPU | PLAYER_START_SEQUENCE);
    if (D_802874D8.unk1D >= 3) {
        spawn_player(gPlayerFour, 3, -3025.772f, 110.039f, -23.224f, (f32) (155 * DEGREES(1)), D_802874D8.unk1E,
                     PLAYER_EXISTS | PLAYER_CPU | PLAYER_START_SEQUENCE);
    } else {
        spawn_player(gPlayerFour, 3, -3025.772f, 110.039f, -23.224f, (f32) (155 * DEGREES(1)),
                     gCharacterIdByGPOverallRank[3], PLAYER_EXISTS | PLAYER_CPU | PLAYER_START_SEQUENCE);
    }
