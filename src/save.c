...
s32 func_800B4E24(s32 recordIndex) {
    return func_800B4DF4(
        gSaveData.allCourseTimeTrialRecords.cupRecords[(((gCupSelection * 4) + gCupSelectedCourseIndex) / 4)]
            .courseRecords[(((gCupSelection * 4) + gCupSelectedCourseIndex) % 4)]
            .records[recordIndex]);
}
...
s32 func_800B5020(u32 time, s32 charId) {
    ...
    course = gCupSelection * 4 + gCupSelectedCourseIndex;
...
s32 func_800B5218(void) {
    ...
    s32 character;
    s32 lapBitmask;
    recordIndex = (gCupSelection * 4) + gCupSelectedCourseIndex;
    recordPointer =
...
s32 func_800B6178(s32 arg0) {
    ...
    if (var_v0 != 0) {
        ...
        if (var_v0 == 0) {
            ...
            if (gGamestate == 4) {
                temp_s3->courseIndex = (gCupSelection * 4) + gCupSelectedCourseIndex;
            }
...
s32 func_800B63F0(s32 arg0) {
    ...
    phi_s3 = 0;
    if (((gCupSelection * 4) + gCupSelectedCourseIndex) != D_8018EE10[arg0].courseIndex) {
        phi_s3 = 2;
