...
void func_80297340(Camera *arg0) {
    ...
    if (is_rendered_then_set_position(sp38, 0) == 0) { return; }
...
void func_8029794C(Vec3f arg0, Vec3s arg1, f32 arg2) {
    ...
    if (is_rendered_then_set_position(sp20, 0) != 0) {
...
void render_obj_cow(Camera *camera, Mat4 arg1, struct Actor *arg2) {
    ...
    if (is_rendered_then_set_position(arg1, 0) != 0) {
        switch (arg2->state) {
        case 0:
...
void render_obj_piranha_plant(Camera *arg0, Mat4 arg1, struct PiranhaPlant *arg2) {
    ...
    if (temp & 0x800) { return; }
        ...
        arg1[3][1] = arg2->pos[1];
        arg1[3][2] = arg2->pos[2];
        if (is_rendered_then_set_position(arg1, 0) == 0) { return; }
...
void func_802986B4(Camera *camera, Mat4 arg1, UNUSED struct Actor *actor) {
    ...
    while (var_s1->pos[0] != (-0x8000)) {
        ...
        if (temp_f0 > 0.0f) {
            ...
            arg1[3][1] = sp88[1];
            arg1[3][2] = sp88[2];
            if ((gRenderedActorsCount < 0x80) && (is_rendered_then_set_position(arg1, 0) != 0)) {
...
void func_80298D7C(Camera *camera, Mat4 arg1, UNUSED struct Actor *actor) {
    ...
    while (var_s1->pos[0] != -0x8000) {
        ...
        if (test == 6) {
            ...
            is_rendered_then_set_position(sp90, 0);
            goto dummylabel;
        } else {
            arg1[3][0] = spD4[0];
            arg1[3][1] = spD4[1];
            ...
            if (gRenderedActorsCount < 0x80) {
                is_rendered_then_set_position(arg1, 0);
dummylabel:
...
void render_obj_shell(Camera *camera, Mat4 matrix, struct ShellActor *shell) {
    ...
    if (is_rendered_then_set_position(matrix, 0) == 0) { return; }
...
void render_obj_banana(Camera *camera, UNUSED Mat4 arg1, struct BananaActor *banana) {
    ...
    if (is_rendered_then_set_position(sp3C, 0) == 0) { return; }
...
void func_8029AE1C(Camera *arg0, struct PaddleWheelBoat *boat, UNUSED Mat4 arg2, u16 arg3) {
    ...
    if (temp < 0.0f) { return; }
        ...
        if (is_rendered_then_set_position(spE0, 1) != 0) {
            ...
            if (is_rendered_then_set_position(sp60, 3) != 0) {
...
void func_8029B06C(Camera *arg0, struct Actor *arg1) {
    ...
    if (temp_f0 < 0.0f) { return; }
        ...
        if (is_rendered_then_set_position(spD8, 0) != 0) {
...
void func_8029B2E4(Camera *arg0, struct Actor *arg1) {
    ...
    if (temp_f0 < 0.0f) { return; }
        ...
        if (is_rendered_then_set_position(spC8, 0) != 0) {
...
void func_8029B8E8(Camera *camera, struct TrainCar *actor) {
    ...
    if (is_rendered_then_set_position(sp120, 0) == 0) { return; }
    ...
    if (is_rendered_then_set_position(spA0, 3) == 0) { return; }
...
void render_obj_falling_rock(Camera *camera, struct FallingRock *rock) {
    ...
    if (temp_f0 < 250000.0f) {
        ...
        if (rock->unk30.unk34 == 1) {
            ...
            if (is_rendered_then_set_position(sp4C, 0) == 0) {
                return;
            }
...
void func_802A171C(Camera *camera, struct FakeItemBox *fakeItemBox) {
    ...
    if (fakeItemBox->state != 2) {
        ...
        if (!is_rendered_then_set_position(someMatrix2, 0)) { return; }
        ...
        if (!is_rendered_then_set_position(someMatrix3, 0)) { return; }
...
void func_802A1EA0(Camera *camera, struct ItemBox *item_box) {
    ...
    if (!(temp_f0 < 0.0f) && !(600000.0f < temp_f0)) {
        if ((item_box->state == 2) && (temp_f0 < 100000.0f)) {
            ...
            if (!is_rendered_then_set_position(someMatrix1, 0)) { return; }
...
void func_802A269C(Camera *arg0, struct Actor *arg1) {
    ...
    if (!(unk < 0.0f)) {
        ...
        if (is_rendered_then_set_position(sp38, 0) != 0) {
...
void func_802A27A0(Camera *arg0, Mat4 arg1, struct YoshiValleyEgg *egg, u16 arg3) {
    ...
    if ((arg3 > 12) && (arg3 < 20)) {
        ...
        if (is_rendered_then_set_position(sp60, 0) == 0) { return; }
...
void func_802A29BC(Camera *arg0, UNUSED Mat4 arg1, struct Actor *arg2) {
    ...
    if (!(unk < 0.0f)) {
        ...
        if (is_rendered_then_set_position(sp40, 0) != 0) {
...
void func_802A2C78(Camera *arg0, UNUSED Mat4 arg1, struct Actor *arg2) {
    ...
    if (!(temp_f0 < 0.0f)) {
        ...
        if (is_rendered_then_set_position(sp68, 0) != 0) {
