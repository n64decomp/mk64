...
void update_obj_kiwano_fruit(struct KiwanoFruit *fruit) {
    ...
    temp_v1 = &gPlayers[fruit->targetPlayer];
    phi_a2 = fruit;
    phi_a2_2 = fruit;
    ...
    case 0:
        ...
        case 1:
            temp_v0 = D_80164490 + (*(&D_80164438 + ((((s32) (temp_v1 - gPlayerOne) / 3544) & 0xFFFF) * 2)) * 8);
            temp_f2 = temp_v1->pos[0] - (f32) temp_v0->unk0;
            fruit = fruit;
            sp20 = temp_f2;
            sp24 = temp_v1;
            temp_f16 = temp_v1->pos[1] - (f32) temp_v0->unk2;
            sp1C = temp_f16;
            temp_f14 = temp_v1->pos[2] - (f32) temp_v0->unk4;
            sp18 = temp_f14;
            ...
            fruit->pos[0] = temp_v1->pos[0] + temp_f2_2;
            temp_f14_2 = temp_f14 * temp_f12;
            fruit->pos[1] = temp_v1->pos[1] + temp_f16_2;
            fruit->velocity[0] = temp_f18 - 2.0f;
            fruit->pos[2] = temp_v1->pos[2] + temp_f14_2;
            if (fruit->velocity[0] <= 0.0f) {
                fruit->state = 2;
                fruit->bonkTimer = 30.0f;
                fruit->velocity[0] = 0.0f;
                fruit->velocity[1] = D_802B9618;
                fruit->velocity[2] = 0.0f;
                temp_v0_2 = temp_v1->unk_0BC;
                if ((temp_v0_2 & 0x200) != 0) {
                    func_800C9060((Player *) (((s32) (temp_v1 - gPlayerOne) / 3544) & 0xFF), 0x1900A052);
                } else {
                    temp_f12_2 = D_802B961C;
                    temp_v1->unk_0BC = temp_v0_2 | 0x8000;
                    temp_v1->pos[0] -= temp_f2_2 * 4.0f;
                    temp_v1->pos[2] -= temp_f14_2 * 4.0f;
                    temp_v1->unk_034[0] -= temp_f2_2 * temp_f12_2;
                    temp_v1->unk_034[2] -= temp_f14_2 * temp_f12_2;
                    func_800C9060((Player *) (((s32) (temp_v1 - gPlayerOne) / 3544) & 0xFF), 0x19007018);
                    if (gModeSelection != 0) {
                        D_80162DF8 = 1;
                    }
                }
