...
/* 0C09DC 800BFDDC 0C02FC64 */  jal   seq_channel_layer_process_script
...
.L800BFE40:
glabel L800BFE40
/* 0C0A40 800BFE40 0C02FC42 */  jal   m64_read_u8
...
/* 0C0A88 800BFE88 0C02FAE9 */  jal   sequence_channel_disable
...
glabel L800BFEB4
/* 0C0AB4 800BFEB4 0C02FC53 */  jal   m64_read_compressed_u16
...
glabel L800BFED4
/* 0C0AD4 800BFED4 0C02FC47 */  jal   m64_read_s16
...
glabel L800BFF10
/* 0C0B10 800BFF10 0C02FC42 */  jal   m64_read_u8
...
glabel L800BFFA0
/* 0C0BA0 800BFFA0 0C02FC47 */  jal   m64_read_s16
...
glabel L800BFFF8
/* 0C0BF8 800BFFF8 0C02FC42 */  jal   m64_read_u8
...
glabel L800C00D0
/* 0C0CD0 800C00D0 0C02FC42 */  jal   m64_read_u8
/* 0C0CD4 800C00D4 02202025 */   move  $a0, $s1
/* 0C0CD8 800C00D8 928F0004 */  lbu   $t7, 4($s4)
/* 0C0CDC 800C00DC 3C03803B */  lui   $v1, %hi(gAlBankSets) # $v1, 0x803b
/* 0C0CE0 800C00E0 8C637078 */  lw    $v1, %lo(gAlBankSets)($v1)
...
/* 0C0D10 800C0110 0C02E6A4 */  jal   get_bank_or_seq
...
.L800C0124:
glabel L800C0124
/* 0C0D24 800C0124 0C02FC42 */  jal   m64_read_u8
/* 0C0D28 800C0128 02202025 */   move  $a0, $s1
/* 0C0D2C 800C012C 02402025 */  move  $a0, $s2
/* 0C0D30 800C0130 0C02FF36 */  jal   set_instrument
...
glabel L800C0160
/* 0C0D60 800C0160 0C02FC42 */  jal   m64_read_u8
/* 0C0D64 800C0164 02202025 */   move  $a0, $s1
/* 0C0D68 800C0168 02402025 */  move  $a0, $s2
/* 0C0D6C 800C016C 0C02FF5B */  jal   sequence_channel_set_volume
...
glabel L800C0184
/* 0C0D84 800C0184 0C02FC42 */  jal   m64_read_u8
...
glabel L800C01B4
/* 0C0DB4 800C01B4 0C02FC47 */  jal   m64_read_s16
...
glabel L800C01E8
/* 0C0DE8 800C01E8 0C02FC42 */  jal   m64_read_u8
...
glabel L800C021C
/* 0C0E1C 800C021C 0C02FC42 */  jal   m64_read_u8
...
glabel L800C0238
/* 0C0E38 800C0238 0C02FC42 */  jal   m64_read_u8
...
glabel L800C026C
/* 0C0E6C 800C026C 0C02FC47 */  jal   m64_read_s16
...
glabel L800C02B4
/* 0C0EB4 800C02B4 0C02FC42 */  jal   m64_read_u8
...
glabel L800C0338
/* 0C0F38 800C0338 0C02FC42 */  jal   m64_read_u8
...
glabel L800C034C
/* 0C0F4C 800C034C 0C02FC42 */  jal   m64_read_u8
/* 0C0F50 800C0350 02202025 */   move  $a0, $s1
/* 0C0F54 800C0354 1000FEBA */  b     .L800BFE40
/* 0C0F58 800C0358 A2420004 */   sb    $v0, 4($s2)
glabel L800C035C
/* 0C0F5C 800C035C 0C02FC42 */  jal   m64_read_u8
/* 0C0F60 800C0360 02202025 */   move  $a0, $s1
/* 0C0F64 800C0364 92980004 */  lbu   $t8, 4($s4)
/* 0C0F68 800C0368 3C03803B */  lui   $v1, %hi(gAlBankSets) # $v1, 0x803b
/* 0C0F6C 800C036C 8C637078 */  lw    $v1, %lo(gAlBankSets)($v1)
...
/* 0C0F9C 800C039C 0C02E6A4 */  jal   get_bank_or_seq
...
/* 0C0FBC 800C03BC 0C02FC42 */  jal   m64_read_u8
/* 0C0FC0 800C03C0 02202025 */   move  $a0, $s1
/* 0C0FC4 800C03C4 305000FF */  andi  $s0, $v0, 0xff
/* 0C0FC8 800C03C8 0C02FC47 */  jal   m64_read_s16
...
glabel L800C03EC
/* 0C0FEC 800C03EC 0C02FC42 */  jal   m64_read_u8
...
glabel L800C0468
/* 0C1068 800C0468 0C02FC42 */  jal   m64_read_u8
...
glabel L800C0714
/* 0C1314 800C0714 0C02FC47 */  jal   m64_read_s16
...
/* 0C1330 800C0730 0C02FA84 */  jal   seq_channel_set_layer
...
/* 0C136C 800C076C 0C02FAD5 */  jal   seq_channel_layer_free
...
/* 0C1394 800C0794 0C02FA84 */  jal   seq_channel_set_layer
...
glabel L800C07E4
/* 0C13E4 800C07E4 0C02FC47 */  jal   m64_read_s16
...
/* 0C1404 800C0804 0C02FBA2 */  jal   sequence_channel_enable
...
/* 0C1420 800C0820 0C02FAE9 */  jal   sequence_channel_disable
...
/* 0C1434 800C0834 0C02FC42 */  jal   m64_read_u8
...
/* 0C145C 800C085C 0C02FC42 */  jal   m64_read_u8
...
/* 0C1498 800C0898 0C02FC64 */  jal   seq_channel_layer_process_script
