...
/* 0020E4 800014E4 3C0B800E */   lui   $t3, %hi(gCurrentCourseId) # 0x800e
/* 0020E8 800014E8 24040002 */  li    $a0, 2
/* 0020EC 800014EC 104400AB */  beq   $v0, $a0, .L8000179C
/* 0020F0 800014F0 3C0B800E */   lui   $t3, %hi(gCurrentCourseId) # 0x800e
/* 0020F4 800014F4 24030003 */  li    $v1, 3
/* 0020F8 800014F8 1043017B */  beq   $v0, $v1, .L80001AE8
/* 0020FC 800014FC 3C0C800E */   lui   $t4, %hi(gPlayerCountSelection1) # 0x800e
...
/* 002248 80001648 3C03800E */   lui   $v1, %hi(D_800DC4BC) # 0x800e
...
.L80001768:
/* 002368 80001768 8C63C4BC */  lw    $v1, %lo(D_800DC4BC)($v1) # -0x3b44($v1)
...
.L8000179C:
/* 00239C 8000179C 856BC5A0 */  lh    $t3, %lo(gCurrentCourseId)($t3) # -0x3a60($t3)
...
.L80001940:
/* 002540 80001940 856BC5A0 */  lh    $t3, %lo(gCurrentCourseId)($t3) # -0x3a60($t3)
...
.L80001AE8:
/* 0026E8 80001AE8 8D8CC538 */  lw    $t4, %lo(gPlayerCountSelection1)($t4) # -0x3ac8($t4)
/* 0026EC 80001AEC 3C02800E */  lui   $v0, %hi(gCurrentCourseId) # 0x800e
