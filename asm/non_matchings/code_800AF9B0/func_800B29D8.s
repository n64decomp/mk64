...
/* 0B363C 800B2A3C 3C088019 */  lui   $t0, %hi(gGameMenuSelectionDepth) # $t0, 0x8019
/* 0B3640 800B2A40 2508EDED */  addiu $t0, %lo(gGameMenuSelectionDepth) # addiu $t0, $t0, -0x1213
...
/* 0B36E0 800B2AE0 3C088019 */  lui   $t0, %hi(gGameMenuSelectionDepth) # $t0, 0x8019
/* 0B36E4 800B2AE4 2508EDED */  addiu $t0, %lo(gGameMenuSelectionDepth) # addiu $t0, $t0, -0x1213
...
/* 0B3728 800B2B28 3C088019 */  lui   $t0, %hi(gGameMenuSelectionDepth) # $t0, 0x8019
/* 0B372C 800B2B2C 2508EDED */  addiu $t0, %lo(gGameMenuSelectionDepth) # addiu $t0, $t0, -0x1213
...
/* 0B3988 800B2D88 3C088019 */  lui   $t0, %hi(gGameMenuSelectionDepth) # $t0, 0x8019
/* 0B398C 800B2D8C 2508EDED */  addiu $t0, %lo(gGameMenuSelectionDepth) # addiu $t0, $t0, -0x1213
...
/* 0B39D4 800B2DD4 3C088019 */  lui   $t0, %hi(gGameMenuSelectionDepth) # $t0, 0x8019
/* 0B39D8 800B2DD8 2508EDED */  addiu $t0, %lo(gGameMenuSelectionDepth) # addiu $t0, $t0, -0x1213
...
/* 0B3D74 800B3174 3C088019 */  lui   $t0, %hi(gGameMenuSelectionDepth) # $t0, 0x8019
/* 0B3D78 800B3178 00AB2821 */  addu  $a1, $a1, $t3
/* 0B3D7C 800B317C 30CA4000 */  andi  $t2, $a2, 0x4000
/* 0B3D80 800B3180 2508EDED */  addiu $t0, %lo(gGameMenuSelectionDepth) # addiu $t0, $t0, -0x1213
...
.L800B3240:
/* 0B3E40 800B3240 3C018019 */  lui   $at, %hi(gGameMenuSelectionDepth) # $at, 0x8019
/* 0B3E44 800B3244 3C044900 */  lui   $a0, (0x49008001 >> 16) # lui $a0, 0x4900
/* 0B3E48 800B3248 A02AEDED */  sb    $t2, %lo(gGameMenuSelectionDepth)($at)
...
/* 0B3EFC 800B32FC 3C088019 */  lui   $t0, %hi(gGameMenuSelectionDepth) # $t0, 0x8019
/* 0B3F00 800B3300 2508EDED */  addiu $t0, %lo(gGameMenuSelectionDepth) # addiu $t0, $t0, -0x1213
