...
/* 0A4584 800A3984 3C09800F */  lui   $t1, %hi(gGameTypeRowSelectionForNumPlayers) # 0x800f
/* 0A4588 800A3988 3C0A800F */  lui   $t2, %hi(gGameTypeSubMenuRowSelectionForNumPlayers) # 0x800f
/* 0A458C 800A398C 01224821 */  addu  $t1, $t1, $v0
/* 0A4590 800A3990 812986AB */  lb    $t1, %lo(gGameTypeRowSelectionForNumPlayers)($t1) # -0x7955($t1)
...
/* 0A45A4 800A39A4 814A86AD */  lb    $t2, %lo(gGameTypeSubMenuRowSelectionForNumPlayers)($t2) # -0x7953($t2)
