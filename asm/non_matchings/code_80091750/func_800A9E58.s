...
/* 0AAADC 800A9EDC 3C06800F */  lui   $a2, %hi(gGameTypeRowSelectionForNumPlayers) # 0x800f
/* 0AAAE0 800A9EE0 8C830004 */  lw    $v1, 4($a0)
/* 0AAAE4 800A9EE4 00C23021 */  addu  $a2, $a2, $v0
/* 0AAAE8 800A9EE8 80C686AB */  lb    $a2, %lo(gGameTypeRowSelectionForNumPlayers)($a2) # -0x7955($a2)
...
/* 0AAB00 800A9F00 3C05800F */  lui   $a1, %hi(gGameModeFromNumPlayersAndGameTypeRowSelection) # 0x800f
...
/* 0AAB14 800A9F14 8CA52B70 */   lw    $a1, %lo(gGameModeFromNumPlayersAndGameTypeRowSelection)($a1) # 0x2b70($a1)
...
/* 0AAB98 800A9F98 3C09800F */  lui   $t1, %hi(gGameTypeRowSelectionForNumPlayers) # 0x800f
...
/* 0AABB0 800A9FB0 812986AB */  lb    $t1, %lo(gGameTypeRowSelectionForNumPlayers)($t1) # -0x7955($t1)
...
/* 0AAC14 800AA014 3C09800F */  lui   $t1, %hi(gGameTypeRowSelectionForNumPlayers) # 0x800f
...
/* 0AAC30 800AA030 812986AB */  lb    $t1, %lo(gGameTypeRowSelectionForNumPlayers)($t1) # -0x7955($t1)
...
/* 0AAE10 800AA210 3C0F800F */  lui   $t7, %hi(gGameTypeRowSelectionForNumPlayers) # 0x800f
...
/* 0AAE2C 800AA22C 81EF86AB */  lb    $t7, %lo(gGameTypeRowSelectionForNumPlayers)($t7) # -0x7955($t7)
