...
# Shows decompilation progress output in verbose mode.
    ...
    with open("docs/asm_funcs.svg", "w") as f:
    ...
    with open("docs/nonmatching_funcs.svg", "w") as f:
    ...
    with open("docs/seg_ending_progress.svg", "w") as f:
