...
extern Course_Vtx d_course_big_donut_vertex[0x48D];
extern Course_Vtx d_course_block_fort_vertex[0x440];
extern Course_Vtx d_course_double_deck_vertex[0x22B];
extern Course_Vtx d_course_skyscraper_vertex[0x43E];
extern Course_Vtx d_course_choco_mountain_vertex[0x15B8];
extern Course_Vtx d_course_frappe_snowland_vertex[0x1599];
extern Course_Vtx d_course_mario_raceway_vertex[0x167D];
extern Course_Vtx d_course_toads_turnpike_vertex[0x18D7];
extern Course_Vtx d_course_kalimari_desert_vertex[0x18F9];
extern Course_Vtx d_course_koopa_troopa_beach_vertex[0x24A0];
extern Course_Vtx d_course_luigi_raceway_vertex[0x1730];
extern Course_Vtx d_course_moo_moo_farm_vertex[0x1F24];
extern Course_Vtx d_course_banshee_boardwalk_vertex[0x1351];
extern Course_Vtx d_course_dks_jungle_parkway_vertex[0x162F];
extern Course_Vtx d_course_rainbow_road_vertex[0xC27];
extern Course_Vtx d_course_yoshi_valley_vertex[0xE88];
extern Course_Vtx d_course_bowsers_castle_vertex[0x2537];
extern Course_Vtx d_course_royal_raceway_vertex[0x2072];
extern Course_Vtx d_course_sherbet_land_vertex[0xA76];
extern Course_Vtx d_course_wario_stadium_vertex[0x17B3];
