...
typedef struct {
    ...
    /* 0x12 */ s16 unused2;
} Mk64Texture; // size = 0x14

typedef struct {
    /* 0x00 */ Mk64Texture *mk64Texture; // This should be interpreted as a segmented address
    /* 0x04 */ s32 frame_length;
} Mk64Animation; // size = 0x8

typedef struct {
    /* 0x00 */ Mk64Animation *textureSequence;
